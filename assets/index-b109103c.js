...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gi,depthTest:!1,depthWrite:!1})}function tc(){return new Li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ja(),fragmentShader:`
		...
		`,blending:Gi,depthTest:!1,depthWrite:!1})}function ic(){return new Li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ja(),fragmentShader:`
...
`)}function E0(i,e){let t;switch(e){case qc:t="Linear";break;case ap:t="Reinhard";break;case lp:t="Cineon";break;case cp:t="ACESFilmic";break;case dp:t="AgX";break;case up:t="Neutral";break;case hp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const vr=new N;function y0(){We.getLuminanceCoefficients(vr);const i=vr.x.toFixed(4),e=vr.y.toFixed(4),t=vr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function L0(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Xc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Bf?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Mi&&(e="SHADOWMAP_TYPE_VSM"),e}function P0(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Jn:case Qn:e="ENVMAP_TYPE_CUBE";break;case Gr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function I0(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Qn:e="ENVMAP_MODE_REFRACTION";break}return e}function D0(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Yc:e="ENVMAP_BLENDING_MULTIPLY";break;case rp:e="ENVMAP_BLENDING_MIX";break;case op:e="ENVMAP_BLENDING_ADD";break}return e}function U0(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function N0(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=L0(t),c=P0(t),d=I0(t),u=D0(t),p=U0(t),m=M0(t),v=w0(r),_=s.createProgram();let f,h,b=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(f=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,v].filter(fs).join(`
`),f.length>0&&(f+=`
...
`,Ta=500,Eh=4,yh=300,Mh=500,wh=100,Sh=2e3,Mn=10,Ki="photoSphereViewer",Gs="psv--capture-event",bh=(i=>(i.ROTATE_UP="ROTATE_UP",i.ROTATE_DOWN="ROTATE_DOWN",i.ROTATE_RIGHT="ROTATE_RIGHT",i.ROTATE_LEFT="ROTATE_LEFT",i.ZOOM_IN="ZOOM_IN",i.ZOOM_OUT="ZOOM_OUT",i))(bh||{}),Mt={MENU:"menu",TWO_FINGERS:"twoFingers",CTRL_ZOOM:"ctrlZoom",ERROR:"error",DESCRIPTION:"description"},Et={Enter:"Enter",Control:"Control",Escape:"Escape",Space:" ",PageUp:"PageUp",PageDown:"PageDown",ArrowLeft:"ArrowLeft",ArrowUp:"ArrowUp",ArrowRight:"ArrowRight",ArrowDown:"ArrowDown",Delete:"Delete",Plus:"+",Minus:"-"},si={arrow:dx,close:ux,download:fx,fullscreenIn:px,fullscreenOut:mx,info:gx,menu:vx,zoomIn:_x,zoomOut:xx},Ar={linear:i=>i,inQuad:i=>i*i,outQuad:i=>i*(2-i),inOutQuad:i=>i<.5?2*i*i:-1+(4-2*i)*i,inCubic:i=>i*i*i,outCubic:i=>--i*i*i+1,inOutCubic:i=>i<.5?4*i*i*i:(i-1)*(2*i-2)*(2*i-2)+1,inQuart:i=>i*i*i*i,outQuart:i=>1- --i*i*i*i,inOutQuart:i=>i<.5?8*i*i*i*i:1-8*--i*i*i*i,inQuint:i=>i*i*i*i*i,outQuint:i=>1+--i*i*i*i*i,inOutQuint:i=>i<.5?16*i*i*i*i*i:1+16*--i*i*i*i*i,inSine:i=>1-Math.cos(i*(Math.PI/2)),outSine:i=>Math.sin(i*(Math.PI/2)),inOutSine:i=>.5-.5*Math.cos(Math.PI*i),inExpo:i=>Math.pow(2,10*(i-1)),outExpo:i=>1-Math.pow(2,-10*i),inOutExpo:i=>(i=i*2-1)<0?.5*Math.pow(2,10*i):1-.5*Math.pow(2,-10*i),inCirc:i=>1-Math.sqrt(1-i*i),outCirc:i=>Math.sqrt(1-(i-1)*(i-1)),inOutCirc:i=>(i*=2)<1?.5-.5*Math.sqrt(1-i*i):.5+.5*Math.sqrt(1-(i-=2)*i)},ue={};Qa(ue,{Animation:()=>kr,Dynamic:()=>ps,MultiDynamic:()=>$h,PressHandler:()=>Zr,Slider:()=>Zh,SliderDirection:()=>jh,addClasses:()=>el,angle:()=>Ah,applyEulerInverse:()=>Pa,checkClosedShadowDom:()=>Yh,checkStylesheet:()=>Xh,checkVersion:()=>ol,cleanCssPosition:()=>Gh,clone:()=>qr,createTexture:()=>La,cssPositionIsOrdered:()=>rl,dasherize:()=>Sx,deepEqual:()=>Bh,deepmerge:()=>kh,distance:()=>Th,exitFullscreen:()=>Oh,firstNonNull:()=>ki,getAbortError:()=>Ca,getAngle:()=>Rh,getClosest:()=>Ph,getConfigParser:()=>jr,getElement:()=>Lh,getEventTarget:()=>Ur,getMatchingTarget:()=>Ih,getPosition:()=>Dh,getShortestArc:()=>Ch,getStyleProperty:()=>di,getTouchData:()=>Aa,getXMPValue:()=>Bt,greatArcDistance:()=>yx,hasParent:()=>wx,invertResolvableBoolean:()=>$r,isAbortError:()=>Vh,isEmpty:()=>zh,isExtendedPosition:()=>sl,isFullscreenEnabled:()=>Uh,isNil:()=>yt,isPlainObject:()=>il,keyPressMatch:()=>tl,logWarn:()=>wt,mergePanoData:()=>qh,parseAngle:()=>li,parsePoint:()=>bx,parseSpeed:()=>Wh,removeClasses:()=>Mx,requestFullscreen:()=>Nh,resolveBoolean:()=>nl,speedToDuration:()=>Ra,sum:()=>Ex,throttle:()=>Fh,toggleClass:()=>Yr,wrap:()=>vs});function vs(i,e){let t=i%e;return t<0&&(t+=e),t}function Ex(i){return i.reduce((e,t)=>e+t,0)}function Th(i,e){return Math.sqrt(Math.pow(i.x-e.x,2)+Math.pow(i.y-e.y,2))}function Ah(i,e){return Math.atan2(e.y-i.y,e.x-i.x)}function Ch(i,e){return[0,Math.PI*2,-Math.PI*2].reduce((n,s)=>{const r=e-i+s;return Math.abs(r)<Math.abs(n)?r:n},1/0)}function Rh(i,e){return Math.acos(Math.cos(i.pitch)*Math.cos(e.pitch)*Math.cos(i.yaw-e.yaw)+Math.sin(i.pitch)*Math.sin(e.pitch))}function yx([i,e],[t,n]){i-t>Math.PI?i-=2*Math.PI:i-t<-Math.PI&&(i+=2*Math.PI);const s=(t-i)*Math.cos((e+n)/2),r=n-e;return Math.sqrt(s*s+r*r)}function Lh(i){return typeof i=="string"?i.match(/^[a-z]/i)?document.getElementById(i):document.querySelector(i):i}function Yr(i,e,t){t===void 0?i.classList.toggle(e):t?i.classList.add(e):t||i.classList.remove(e)}function el(i,e){i.classList.add(...e.split(" ").filter(t=>!!t))}function Mx(i,e){i.classList.remove(...e.split(" ").filter(t=>!!t))}function wx(i,e){let t=i;do{if(t===e)return!0;t=t.parentElement}while(t);return!1}function Ph(i,e){if(!(i!=null&&i.matches))return null;let t=i;do{if(t.matches(e))return t;t=t.parentElement}while(t);return null}function Ur(i){return(i==null?void 0:i.composedPath()[0])||null}function Ih(i,e){return i?i.composedPath().find(t=>!(t instanceof HTMLElement)&&!(t instanceof SVGElement)?!1:t.matches(e)):null}function Dh(i){let e=0,t=0,n=i;for(;n;)e+=n.offsetLeft-n.scrollLeft+n.clientLeft,t+=n.offsetTop-n.scrollTop+n.clientTop,n=n.offsetParent;return e-=window.scrollX,t-=window.scrollY,{x:e,y:t}}function di(i,e){return window.getComputedStyle(i).getPropertyValue(e)}function Aa(i){if(i.touches.length<2)return null;const e={x:i.touches[0].clientX,y:i.touches[0].clientY},t={x:i.touches[1].clientX,y:i.touches[1].clientY};return{distance:Th(e,t),angle:Ah(e,t),center:{x:(e.x+t.x)/2,y:(e.y+t.y)/2}}}var Nr;function Uh(i,e=!1){return e?i===Nr:document.fullscreenElement===i}function Nh(i,e=!1){e?(Nr=i,i.classList.add("psv-fullscreen-emulation"),document.dispatchEvent(new Event("fullscreenchange"))):i.requestFullscreen()}function Oh(i=!1){i?(Nr.classList.remove("psv-fullscreen-emulation"),Nr=null,document.dispatchEvent(new Event("fullscreenchange"))):document.exitFullscreen()}function tl(i,e){let t,n=!1,s=!1,r=!1,o=!1;return e==="+"?t=e:e.split("+").forEach(a=>{switch(a){case"Shift":n=!0;break;case"Ctrl":s=!0;break;case"Alt":r=!0;break;case"Meta":o=!0;break;case"Plus":t="+";break;case"Minus":t="-";break;default:t=a;break}}),n===i.shiftKey&&s===i.ctrlKey&&r===i.altKey&&o===i.metaKey&&t===i.key}function Sx(i){return i.replace(/[A-Z](?:(?=[^A-Z])|[A-Z]*(?=[A-Z][^A-Z]|$))/g,(e,t)=>(t>0?"-":"")+e.toLowerCase())}function Fh(i,e){let t=!1;return function(...n){t||(t=!0,setTimeout(()=>{i.apply(this,n),t=!1},e))}}function il(i){if(typeof i!="object"||i===null||Object.prototype.toString.call(i)!=="[object Object]")return!1;if(Object.getPrototypeOf(i)===null)return!0;let e=i;for(;Object.getPrototypeOf(e)!==null;)e=Object.getPrototypeOf(e);return Object.getPrototypeOf(i)===e}function kh(i,e){const t=e;return function n(s,r){return Array.isArray(r)?(!s||!Array.isArray(s)?s=[]:s.length=0,r.forEach((o,a)=>{s[a]=n(null,o)})):typeof r=="object"?((!s||Array.isArray(s))&&(s={}),Object.keys(r).forEach(o=>{o!=="__proto__"&&(typeof r[o]!="object"||!r[o]||!il(r[o])?s[o]=r[o]:r[o]!==t&&(s[o]?n(s[o],r[o]):s[o]=n(null,r[o])))})):s=r,s}(i,e)}function qr(i){return kh(null,i)}function zh(i){return!i||Object.keys(i).length===0&&i.constructor===Object}function yt(i){return i==null}function ki(...i){for(const e of i)if(!yt(e))return e;return null}function Bh(i,e){if(i===e)return!0;if(Ec(i)&&Ec(e)){if(Object.keys(i).length!==Object.keys(e).length)return!1;for(const t of Object.keys(i))if(!Bh(i[t],e[t]))return!1;return!0}else return!1}function Ec(i){return typeof i=="object"&&i!==null}var he=class Hh extends Error{constructor(e,t){var n;super(t&&t instanceof Error?`${e}: ${t.message}`:e),this.name="PSVError",(n=Error.captureStackTrace)==null||n.call(Error,this,Hh)}};function nl(i,e){il(i)?(e(i.initial,!0),i.promise.then(t=>e(t,!1))):e(i,!0)}function $r(i){return{initial:!i.initial,promise:i.promise.then(e=>!e)}}function Ca(){const i=new Error("Loading was aborted.");return i.name="AbortError",i}function Vh(i){return(i==null?void 0:i.name)==="AbortError"}function wt(i){console.warn(`PhotoSphereViewer: ${i}`)}function sl(i){return!i||Array.isArray(i)?!1:[["textureX","textureY"],["yaw","pitch"]].some(([e,t])=>i[e]!==void 0&&i[t]!==void 0)}function Bt(i,e,t=!0){let n=i.match("<GPano:"+e+">(.*)</GPano:"+e+">");if(n!==null){const s=t?parseInt(n[1],10):parseFloat(n[1]);return isNaN(s)?null:s}if(n=i.match("GPano:"+e+'="(.*?)"'),n!==null){const s=t?parseInt(n[1],10):parseFloat(n[1]);return isNaN(s)?null:s}return null}var yc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Or=["left","center","right"],Fr=["top","center","bottom"],Mc=[...Or,...Fr],qt="center";function bx(i){if(!i)return{x:.5,y:.5};if(typeof i=="object")return i;let e=i.toLocaleLowerCase().split(" ").slice(0,2);e.length===1&&(yc[e[0]]?e=[e[0],qt]:e=[e[0],e[0]]);const t=e[1]!=="left"&&e[1]!=="right"&&e[0]!=="top"&&e[0]!=="bottom";e=e.map(s=>yc[s]||s),t||e.reverse();const n=e.join(" ").match(/^([0-9.]+)% ([0-9.]+)%$/);return n?{x:parseFloat(n[1])/100,y:parseFloat(n[2])/100}:{x:.5,y:.5}}function Gh(i,{allowCenter:e,cssOrder:t}={allowCenter:!0,cssOrder:!0}){return i?(typeof i=="string"&&(i=i.split(" ")),i.length===1&&(i[0]===qt?i=[qt,qt]:Or.indexOf(i[0])!==-1?i=[qt,i[0]]:Fr.indexOf(i[0])!==-1&&(i=[i[0],qt])),i.length!==2||Mc.indexOf(i[0])===-1||Mc.indexOf(i[1])===-1?(wt(`Unparsable position ${i}`),null):!e&&i[0]===qt&&i[1]===qt?(wt("Invalid position center center"),null):(t&&!rl(i)&&(i=[i[1],i[0]]),i[1]===qt&&Or.indexOf(i[0])!==-1&&(i=[qt,i[0]]),i[0]===qt&&Fr.indexOf(i[1])!==-1&&(i=[i[1],qt]),i)):null}function rl(i){return Fr.indexOf(i[0])!==-1&&Or.indexOf(i[1])!==-1}function Wh(i){let e;if(typeof i=="string"){const t=i.toString().trim();let n=parseFloat(t.replace(/^(-?[0-9]+(?:\.[0-9]*)?).*$/,"$1"));const s=t.replace(/^-?[0-9]+(?:\.[0-9]*)?(.*)$/,"$1").trim();switch(s.match(/(pm|per minute)$/)&&(n/=60),s){case"dpm":case"degrees per minute":case"dps":case"degrees per second":e=Ve.degToRad(n);break;case"rdpm":case"radians per minute":case"rdps":case"radians per second":e=n;break;case"rpm":case"revolutions per minute":case"rps":case"revolutions per second":e=n*Math.PI*2;break;default:throw new he(`Unknown speed unit "${s}"`)}}else e=i;return e}function Ra(i,e){if(typeof i!="number"){const t=Wh(i);return e/Math.abs(t)*1e3}else return Math.abs(i)}function li(i,e=!1,t=e){let n;if(typeof i=="string"){const s=i.toLowerCase().trim().match(/^(-?[0-9]+(?:\.[0-9]*)?)(.*)$/);if(!s)throw new he(`Unknown angle "${i}"`);const r=parseFloat(s[1]),o=s[2];if(o)switch(o){case"deg":case"degs":n=Ve.degToRad(r);break;case"rad":case"rads":n=r;break;default:throw new he(`Unknown angle unit "${o}"`)}else n=r}else if(typeof i=="number"&&!isNaN(i))n=i;else throw new he(`Unknown angle "${i}"`);return n=vs(e?n+Math.PI:n,Math.PI*2),e?Ve.clamp(n-Math.PI,-Math.PI/(t?2:1),Math.PI/(t?2:1)):n}function La(i,e=!1){const t=new St(i);return t.needsUpdate=!0,t.minFilter=e?Vi:Vt,t.generateMipmaps=e,t.anisotropy=e?2:1,t}var wc=new Ji;function Pa(i,e){wc.setFromEuler(e).invert(),i.applyQuaternion(wc)}function jr(i,e){const t=function(n){const s=qr({...i,...n}),r={};for(let[o,a]of Object.entries(s)){if(e&&o in e)a=e[o](a,{rawConfig:s,defValue:i[o]});else if(!(o in i)){wt(`Unknown option ${o}`);continue}r[o]=a}return r};return t.defaults=i,t.parsers=e||{},t}function Xh(i,e){di(i,`--psv-${e}-loaded`)!=="true"&&console.error(`PhotoSphereViewer: stylesheet "@photo-sphere-viewer/${e}/index.css" is not loaded`)}function ol(i,e,t){e&&e!==t&&console.error(`PhotoSphereViewer: @photo-sphere-viewer/${i} is in version ${e} but @photo-sphere-viewer/core is in version ${t}`)}function Yh(i){do{if(i instanceof ShadowRoot&&i.mode==="closed"){console.error("PhotoSphereViewer: closed shadow DOM detected, the viewer might not work as expected");return}i=i.parentNode}while(i)}function qh(i,e,t,n){const s={isEquirectangular:!0,fullWidth:ki(t==null?void 0:t.fullWidth,n==null?void 0:n.fullWidth),fullHeight:ki(t==null?void 0:t.fullHeight,n==null?void 0:n.fullHeight),croppedWidth:i,croppedHeight:e,croppedX:ki(t==null?void 0:t.croppedX,n==null?void 0:n.croppedX),croppedY:ki(t==null?void 0:t.croppedY,n==null?void 0:n.croppedY),poseHeading:ki(t==null?void 0:t.poseHeading,n==null?void 0:n.poseHeading,0),posePitch:ki(t==null?void 0:t.posePitch,n==null?void 0:n.posePitch,0),poseRoll:ki(t==null?void 0:t.poseRoll,n==null?void 0:n.poseRoll,0),initialHeading:n==null?void 0:n.initialHeading,initialPitch:n==null?void 0:n.initialPitch,initialFov:n==null?void 0:n.initialFov};return!s.fullWidth&&!s.fullHeight&&(s.fullWidth=Math.max(i,e*2),s.fullHeight=Math.round(s.fullWidth/2)),s.fullWidth||(s.fullWidth=s.fullHeight*2),s.fullHeight||(s.fullHeight=Math.round(s.fullWidth/2)),s.croppedX===null&&(s.croppedX=Math.round((s.fullWidth-i)/2)),s.croppedY===null&&(s.croppedY=Math.round((s.fullHeight-e)/2)),Math.abs(s.fullWidth-s.fullHeight*2)>1&&(wt("Invalid panoData, fullWidth should be twice fullHeight"),s.fullHeight=Math.round(s.fullWidth/2)),s.croppedX+s.croppedWidth>s.fullWidth&&(wt("Invalid panoData, croppedX + croppedWidth > fullWidth"),s.croppedX=s.fullWidth-s.croppedWidth),s.croppedY+s.croppedHeight>s.fullHeight&&(wt("Invalid panoData, croppedY + croppedHeight > fullHeight"),s.croppedY=s.fullHeight-s.croppedHeight),s.croppedX<0&&(wt("Invalid panoData, croppedX < 0"),s.croppedX=0),s.croppedY<0&&(wt("Invalid panoData, croppedY < 0"),s.croppedY=0),s}var kr=class{constructor(i){this.easing=Ar.linear,this.callbacks=[],this.resolved=!1,this.cancelled=!1,this.options=i,i?(i.easing&&(this.easing=typeof i.easing=="function"?i.easing:Ar[i.easing]||Ar.linear),this.delayTimeout=setTimeout(()=>{this.delayTimeout=void 0,this.animationFrame=window.requestAnimationFrame(e=>this.__run(e))},i.delay||0)):this.resolved=!0}__run(i){if(this.cancelled)return;this.start||(this.start=i);const e=(i-this.start)/this.options.duration,t={};if(e<1){for(const[n,s]of Object.entries(this.options.properties))if(s){const r=s.start+(s.end-s.start)*this.easing(e);t[n]=r}this.options.onTick(t,e),this.animationFrame=window.requestAnimationFrame(n=>this.__run(n))}else{for(const[n,s]of Object.entries(this.options.properties))s&&(t[n]=s.end);this.options.onTick(t,1),this.__resolve(!0),this.animationFrame=void 0}}__resolve(i){i?this.resolved=!0:this.cancelled=!0,this.callbacks.forEach(e=>e(i)),this.callbacks.length=0}then(i){return this.resolved||this.cancelled?Promise.resolve(this.resolved).then(i):new Promise(e=>{this.callbacks.push(e)}).then(i)}cancel(){!this.cancelled&&!this.resolved&&(this.__resolve(!1),this.delayTimeout&&(window.clearTimeout(this.delayTimeout),this.delayTimeout=void 0),this.animationFrame&&(window.cancelAnimationFrame(this.animationFrame),this.animationFrame=void 0))}},ps=class{constructor(i,e){if(this.fn=i,this.mode=0,this.speed=0,this.speedMult=0,this.currentSpeed=0,this.target=0,this.__current=0,this.min=e.min,this.max=e.max,this.wrap=e.wrap,this.current=e.defaultValue,this.wrap&&this.min!==0)throw new he("invalid config");this.fn&&this.fn(this.current)}get current(){return this.__current}set current(i){this.__current=i}setSpeed(i){this.speed=i}goto(i,e=1){this.mode=2,this.target=this.wrap?vs(i,this.max):Ve.clamp(i,this.min,this.max),this.speedMult=e}step(i,e=1){e===0?this.setValue(this.current+i):(this.mode!==2&&(this.target=this.current),this.goto(this.target+i,e))}roll(i=!1,e=1){this.mode=1,this.target=i?-1/0:1/0,this.speedMult=e}stop(){this.mode=0}setValue(i){return this.target=this.wrap?vs(i,this.max):Ve.clamp(i,this.min,this.max),this.mode=0,this.currentSpeed=0,this.target!==this.current?(this.current=this.target,this.fn&&this.fn(this.current),!0):!1}update(i){if(this.mode===2){this.wrap&&Math.abs(this.target-this.current)>this.max/2&&(this.current=this.current<this.target?this.current+this.max:this.current-this.max);const n=this.currentSpeed*this.currentSpeed/(this.speed*this.speedMult*4);Math.abs(this.target-this.current)<=n&&(this.mode=0)}let e=this.mode===0?0:this.speed*this.speedMult;this.target<this.current&&(e=-e),this.currentSpeed<e?this.currentSpeed=Math.min(e,this.currentSpeed+i/1e3*this.speed*this.speedMult*2):this.currentSpeed>e&&(this.currentSpeed=Math.max(e,this.currentSpeed-i/1e3*this.speed*this.speedMult*2));let t=null;return this.current>this.target&&this.currentSpeed?t=Math.max(this.target,this.current+this.currentSpeed*i/1e3):this.current<this.target&&this.currentSpeed&&(t=Math.min(this.target,this.current+this.currentSpeed*i/1e3)),t!==null&&(t=this.wrap?vs(t,this.max):Ve.clamp(t,this.min,this.max),t!==this.current)?(this.current=t,this.fn&&this.fn(this.current),!0):!1}},$h=class{constructor(i,e){this.fn=i,this.dynamics=e,this.fn&&this.fn(this.current)}get current(){return Object.entries(this.dynamics).reduce((i,[e,t])=>(i[e]=t.current,i),{})}setSpeed(i){for(const e of Object.values(this.dynamics))e.setSpeed(i)}goto(i,e=1){for(const[t,n]of Object.entries(i))this.dynamics[t].goto(n,e)}step(i,e=1){if(e===0)this.setValue(Object.keys(i).reduce((t,n)=>(t[n]=i[n]+this.dynamics[n].current,t),{}));else for(const[t,n]of Object.entries(i))this.dynamics[t].step(n,e)}roll(i,e=1){for(const[t,n]of Object.entries(i))this.dynamics[t].roll(n,e)}stop(){for(const i of Object.values(this.dynamics))i.stop()}setValue(i){let e=!1;for(const[t,n]of Object.entries(i))e=this.dynamics[t].setValue(n)||e;return e&&this.fn&&this.fn(this.current),e}update(i){let e=!1;for(const t of Object.values(this.dynamics))e=t.update(i)||e;return e&&this.fn&&this.fn(this.current),e}},Zr=class{constructor(i=200){this.delay=i,this.time=0,this.delay=i}get pending(){return this.time!==0}down(i){this.timeout&&(clearTimeout(this.timeout),this.timeout=void 0),this.time=new Date().getTime(),this.data=i}up(i){if(!this.time)return;Date.now()-this.time<this.delay?this.timeout=setTimeout(()=>{i(this.data),this.timeout=void 0,this.time=0,this.data=void 0},this.delay):(i(this.data),this.time=0,this.data=void 0)}},jh=(i=>(i.VERTICAL="VERTICAL",i.HORIZONTAL="HORIZONTAL",i))(jh||{}),Zh=class{constructor(i,e,t){this.container=i,this.direction=e,this.listener=t,this.mousedown=!1,this.mouseover=!1,this.container.addEventListener("click",this),this.container.addEventListener("mousedown",this),this.container.addEventListener("mouseenter",this),this.container.addEventListener("mouseleave",this),this.container.addEventListener("touchstart",this),this.container.addEventListener("mousemove",this,!0),this.container.addEventListener("touchmove",this,!0),window.addEventListener("mouseup",this),window.addEventListener("touchend",this)}get isVertical(){return this.direction==="VERTICAL"}get isHorizontal(){return this.direction==="HORIZONTAL"}destroy(){window.removeEventListener("mouseup",this),window.removeEventListener("touchend",this)}handleEvent(i){switch(i.type){case"click":i.stopPropagation();break;case"mousedown":this.__onMouseDown(i);break;case"mouseenter":this.__onMouseEnter(i);break;case"mouseleave":this.__onMouseLeave(i);break;case"touchstart":this.__onTouchStart(i);break;case"mousemove":this.__onMouseMove(i);break;case"touchmove":this.__onTouchMove(i);break;case"mouseup":this.__onMouseUp(i);break;case"touchend":this.__onTouchEnd(i);break}}__onMouseDown(i){this.mousedown=!0,this.__update(i.clientX,i.clientY,!0)}__onMouseEnter(i){this.mouseover=!0,this.__update(i.clientX,i.clientY,!0)}__onTouchStart(i){this.mouseover=!0,this.mousedown=!0;const e=i.changedTouches[0];this.__update(e.clientX,e.clientY,!0)}__onMouseMove(i){(this.mousedown||this.mouseover)&&(i.stopPropagation(),this.__update(i.clientX,i.clientY,!0))}__onTouchMove(i){if(this.mousedown||this.mouseover){i.stopPropagation();const e=i.changedTouches[0];this.__update(e.clientX,e.clientY,!0)}}__onMouseUp(i){this.mousedown&&(this.mousedown=!1,this.__update(i.clientX,i.clientY,!1))}__onMouseLeave(i){this.mouseover&&(this.mouseover=!1,this.__update(i.clientX,i.clientY,!0))}__onTouchEnd(i){if(this.mousedown){this.mouseover=!1,this.mousedown=!1;const e=i.changedTouches[0];this.__update(e.clientX,e.clientY,!1)}}__update(i,e,t){const n=this.container.getBoundingClientRect();let s;this.isVertical?s=Ve.clamp((n.bottom-e)/n.height,0,1):s=Ve.clamp((i-n.left)/n.width,0,1),this.listener({value:s,click:!t,mousedown:this.mousedown,mouseover:this.mouseover,cursor:{clientX:i,clientY:e}})}},ye={};Qa(ye,{BeforeAnimateEvent:()=>al,BeforeRenderEvent:()=>_s,BeforeRotateEvent:()=>sd,ClickEvent:()=>ad,ConfigChangedEvent:()=>Nt,DoubleClickEvent:()=>ud,FullscreenEvent:()=>xs,HideNotificationEvent:()=>Es,HideOverlayEvent:()=>xd,HidePanelEvent:()=>Yi,HideTooltipEvent:()=>Sd,KeypressEvent:()=>qi,LoadProgressEvent:()=>Rd,ObjectEnterEvent:()=>pu,ObjectEvent:()=>Kr,ObjectHoverEvent:()=>xu,ObjectLeaveEvent:()=>Ia,PanoramaErrorEvent:()=>Fd,PanoramaLoadEvent:()=>Id,PanoramaLoadedEvent:()=>Zn,PositionUpdatedEvent:()=>ys,ReadyEvent:()=>ws,RenderEvent:()=>jd,RollUpdatedEvent:()=>Ms,ShowNotificationEvent:()=>Ss,ShowOverlayEvent:()=>eu,ShowPanelEvent:()=>$i,ShowTooltipEvent:()=>ru,SizeUpdatedEvent:()=>bs,StopAllEvent:()=>Ts,TransitionDoneEvent:()=>Bd,ViewerEvent:()=>je,ZoomUpdatedEvent:()=>Ti});var Ws=class extends Event{constructor(i,e=!1){super(i,{cancelable:e})}},Kh=class extends EventTarget{dispatchEvent(i){return super.dispatchEvent(i)}addEventListener(i,e,t){super.addEventListener(i,e,t)}removeEventListener(i,e,t){super.removeEventListener(i,e,t)}},je=class extends Ws{},Jh=class Qh extends je{constructor(e,t){super(Qh.type,!0),this.position=e,this.zoomLevel=t}};Jh.type="before-animate";var al=Jh,ed=class td extends je{constructor(e,t){super(td.type),this.timestamp=e,this.elapsed=t}};ed.type="before-render";var _s=ed,id=class nd extends je{constructor(e){super(nd.type,!0),this.position=e}};id.type="before-rotate";var sd=id,rd=class od extends je{constructor(e){super(od.type),this.data=e}};rd.type="click";var ad=rd,ld=class cd extends je{constructor(e){super(cd.type),this.options=e}containsOptions(...e){return e.some(t=>this.options.includes(t))}};ld.type="config-changed";var Nt=ld,hd=class dd extends je{constructor(e){super(dd.type),this.data=e}};hd.type="dblclick";var ud=hd,fd=class pd extends je{constructor(e){super(pd.type),this.fullscreenEnabled=e}};fd.type="fullscreen";var xs=fd,md=class gd extends je{constructor(e){super(gd.type),this.notificationId=e}};md.type="hide-notification";var Es=md,vd=class _d extends je{constructor(e){super(_d.type),this.overlayId=e}};vd.type="hide-overlay";var xd=vd,Ed=class yd extends je{constructor(e){super(yd.type),this.panelId=e}};Ed.type="hide-panel";var Yi=Ed,Md=class wd extends je{constructor(e){super(wd.type),this.tooltipData=e}};Md.type="hide-tooltip";var Sd=Md,bd=class Td extends je{constructor(e,t){super(Td.type,!0),this.key=e,this.originalEvent=t}matches(e){return tl(this.originalEvent,e)}};bd.type="key-press";var qi=bd,Ad=class Cd extends je{constructor(e){super(Cd.type),this.progress=e}};Ad.type="load-progress";var Rd=Ad,Ld=class Pd extends je{constructor(e){super(Pd.type),this.panorama=e}};Ld.type="panorama-load";var Id=Ld,Dd=class Ud extends je{constructor(e){super(Ud.type),this.data=e}};Dd.type="panorama-loaded";var Zn=Dd,Nd=class Od extends je{constructor(e,t){super(Od.type),this.panorama=e,this.error=t}};Nd.type="panorama-error";var Fd=Nd,kd=class zd extends je{constructor(e){super(zd.type),this.completed=e}};kd.type="transition-done";var Bd=kd,Hd=class Vd extends je{constructor(e){super(Vd.type),this.position=e}};Hd.type="position-updated";var ys=Hd,Gd=class Wd extends je{constructor(e){super(Wd.type),this.roll=e}};Gd.type="roll-updated";var Ms=Gd,Xd=class Yd extends je{constructor(){super(Yd.type)}};Xd.type="ready";var ws=Xd,qd=class $d extends je{constructor(){super($d.type)}};qd.type="render";var jd=qd,Zd=class Kd extends je{constructor(e){super(Kd.type),this.notificationId=e}};Zd.type="show-notification";var Ss=Zd,Jd=class Qd extends je{constructor(e){super(Qd.type),this.overlayId=e}};Jd.type="show-overlay";var eu=Jd,tu=class iu extends je{constructor(e){super(iu.type),this.panelId=e}};tu.type="show-panel";var $i=tu,nu=class su extends je{constructor(e,t){super(su.type),this.tooltip=e,this.tooltipData=t}};nu.type="show-tooltip";var ru=nu,ou=class au extends je{constructor(e){super(au.type),this.size=e}};ou.type="size-updated";var bs=ou,lu=class cu extends je{constructor(){super(cu.type)}};lu.type="stop-all";var Ts=lu,hu=class du extends je{constructor(e){super(du.type),this.zoomLevel=e}};hu.type="zoom-updated";var Ti=hu,Kr=class extends je{constructor(i,e,t,n,s){super(i),this.originalEvent=e,this.object=t,this.viewerPoint=n,this.userDataKey=s}},uu=class fu extends Kr{constructor(e,t,n,s){super(fu.type,e,t,n,s)}};uu.type="enter-object";var pu=uu,mu=class gu extends Kr{constructor(e,t,n,s){super(gu.type,e,t,n,s)}};mu.type="leave-object";var Ia=mu,vu=class _u extends Kr{constructor(e,t,n,s){super(_u.type,e,t,n,s)}};vu.type="hover-object";var xu=vu,ll=class{constructor(i){this.viewer=i}init(){}destroy(){}supportsTransition(i){return!1}supportsPreload(i){return!1}textureCoordsToSphericalCoords(i,e){throw new he("Current adapter does not support texture coordinates.")}sphericalCoordsToTextureCoords(i,e){throw new he("Current adapter does not support texture coordinates.")}};ll.supportsDownload=!1;function Sc(i){if(i){for(const[,e]of[["_",i],...Object.entries(i)])if(e.prototype instanceof ll)return ol(e.id,e.VERSION,"5.14.0"),e}return null}var ds=`${Ki}_touchSupport`,Pt={loaded:!1,pixelRatio:1,isWebGLSupported:!1,maxTextureWidth:0,isTouchEnabled:null,__maxCanvasWidth:null,isIphone:!1,get maxCanvasWidth(){return this.__maxCanvasWidth===null&&(this.__maxCanvasWidth=Cx(this.maxTextureWidth)),this.__maxCanvasWidth},load(){if(!this.loaded){const i=Tx();this.pixelRatio=window.devicePixelRatio||1,this.isWebGLSupported=!!i,this.maxTextureWidth=i?i.getParameter(i.MAX_TEXTURE_SIZE):0,this.isTouchEnabled=Ax(),this.isIphone=/iPhone/i.test(navigator.userAgent),this.loaded=!0}if(!Pt.isWebGLSupported)throw new he("WebGL 2 is not supported.");if(Pt.maxTextureWidth===0)throw new he("Unable to detect system capabilities")}};function Tx(){try{return document.createElement("canvas").getContext("webgl2")}catch{return null}}function Ax(){let i="ontouchstart"in window||navigator.maxTouchPoints>0;ds in localStorage&&(i=localStorage[ds]==="true");const e=new Promise(t=>{const n=()=>{window.removeEventListener("mousedown",s),window.removeEventListener("touchstart",r),clearTimeout(a)},s=()=>{n(),localStorage[ds]=!1,t(!1)},r=()=>{n(),localStorage[ds]=!0,t(!0)},o=()=>{n(),localStorage[ds]=i,t(i)};window.addEventListener("mousedown",s,!1),window.addEventListener("touchstart",r,!1);const a=setTimeout(o,1e4)});return{initial:i,promise:e}}function Cx(i){let e=i,t=!1;const n=document.createElement("canvas"),s=n.getContext("2d");for(n.width=1,n.height=1;e>1024&&!t;){const r=document.createElement("canvas"),o=r.getContext("2d");r.width=e,r.height=e/2;try{o.fillStyle="white",o.fillRect(e-1,e/2-1,1,1),s.drawImage(r,e-1,e/2-1,1,1,0,0,1,1),s.getImageData(0,0,1,1).data[0]>0&&(t=!0)}catch{}r.width=0,r.height=0,t||(e/=2)}if(t)return e;throw new he("Unable to detect system capabilities")}var Rx=jr({resolution:64,useXmpData:!0,blur:!1},{resolution:i=>{if(!i||!Ve.isPowerOfTwo(i))throw new he("EquirectangularAdapter resolution must be power of two.");return i}}),Jr=class Eu extends ll{static withConfig(e){return[Eu,e]}constructor(e,t){super(e),this.config=Rx(t),this.SPHERE_SEGMENTS=this.config.resolution,this.SPHERE_HORIZONTAL_SEGMENTS=this.SPHERE_SEGMENTS/2}supportsTransition(){return!0}supportsPreload(){return!0}textureCoordsToSphericalCoords(e,t){if(yt(e.textureX)||yt(e.textureY))throw new he("Texture position is missing 'textureX' or 'textureY'");const n=(e.textureX+t.croppedX)/t.fullWidth*Math.PI*2,s=(e.textureY+t.croppedY)/t.fullHeight*Math.PI;return{yaw:n>=Math.PI?n-Math.PI:n+Math.PI,pitch:Math.PI/2-s}}sphericalCoordsToTextureCoords(e,t){const n=e.yaw/Math.PI/2*t.fullWidth,s=e.pitch/Math.PI*t.fullHeight;let r=Math.round(e.yaw<Math.PI?n+t.fullWidth/2:n-t.fullWidth/2)-t.croppedX,o=Math.round(t.fullHeight/2-s)-t.croppedY;return(r<0||r>t.croppedWidth||o<0||o>t.croppedHeight)&&(r=o=void 0),{textureX:r,textureY:o}}async loadTexture(e,t=!0,n,s=this.config.useXmpData){if(typeof e!="string"&&(typeof e!="object"||!e.path))return Promise.reject(new he("Invalid panorama url, are you using the right adapter?"));let r;typeof e=="string"?r={path:e,data:n}:r={data:n,...e};const o=await this.viewer.textureLoader.loadFile(r.path,t?u=>this.viewer.textureLoader.dispatchProgress(u):null,r.path),a=s?await this.loadXMP(o):null,l=await this.viewer.textureLoader.blobToImage(o);typeof r.data=="function"&&(r.data=r.data(l,a));const c=qh(l.width,l.height,r.data,a),d=this.createEquirectangularTexture(l);return{panorama:e,texture:d,panoData:c,cacheKey:r.path}}async loadXMP(e){const t=await this.loadBlobAsString(e),n=t.indexOf("<x:xmpmeta");if(n===-1)return null;const s=t.indexOf("</x:xmpmeta>",n);if(s===-1)return null;const r=t.substring(n,s);return r.includes("GPano:")?{fullWidth:Bt(r,"FullPanoWidthPixels"),fullHeight:Bt(r,"FullPanoHeightPixels"),croppedWidth:Bt(r,"CroppedAreaImageWidthPixels"),croppedHeight:Bt(r,"CroppedAreaImageHeightPixels"),croppedX:Bt(r,"CroppedAreaLeftPixels"),croppedY:Bt(r,"CroppedAreaTopPixels"),poseHeading:Bt(r,"PoseHeadingDegrees",!1),posePitch:Bt(r,"PosePitchDegrees",!1),poseRoll:Bt(r,"PoseRollDegrees",!1),initialHeading:Bt(r,"InitialViewHeadingDegrees",!1),initialPitch:Bt(r,"InitialViewPitchDegrees",!1),initialFov:Bt(r,"InitialHorizontalFOVDegrees",!1)}:null}loadBlobAsString(e){return new Promise((t,n)=>{const s=new FileReader;s.onload=()=>t(s.result),s.onerror=n,s.readAsText(e)})}createEquirectangularTexture(e){if(this.config.blur||e.width>Pt.maxTextureWidth){const t=Math.min(1,Pt.maxCanvasWidth/e.width),n=new OffscreenCanvas(Math.floor(e.width*t),Math.floor(e.height*t)),s=n.getContext("2d");return this.config.blur&&(s.filter=`blur(${n.width/2048}px)`),s.drawImage(e,0,0,n.width,n.height),La(n)}return La(e)}createMesh(e){const t=e.croppedX/e.fullWidth*2*Math.PI,n=e.croppedWidth/e.fullWidth*2*Math.PI,s=e.croppedY/e.fullHeight*Math.PI,r=e.croppedHeight/e.fullHeight*Math.PI,o=new Vs(Mn,Math.round(this.SPHERE_SEGMENTS/(2*Math.PI)*n),Math.round(this.SPHERE_HORIZONTAL_SEGMENTS/Math.PI*r),-Math.PI/2+t,n,s,r).scale(-1,1,1),a=new zs({depthTest:!1,depthWrite:!1});return new Gt(o,a)}setTexture(e,t){e.material.map=t.texture}setTextureOpacity(e,t){e.material.opacity=t,e.material.transparent=t<1}disposeTexture({texture:e}){e.dispose()}disposeMesh(e){e.geometry.dispose(),e.material.dispose()}};Jr.id="equirectangular";Jr.VERSION="5.14.0";Jr.supportsDownload=!0;var yu=Jr,Mu=class wu extends yu{static withConfig(e){return[wu,e]}constructor(e,t){super(e,{resolution:(t==null?void 0:t.resolution)??64,useXmpData:!1})}async loadTexture(e,t){const n=await super.loadTexture(e,t,null,!1);return n.panoData=null,n}createMesh(){const e=new Vs(Mn,this.SPHERE_SEGMENTS,this.SPHERE_HORIZONTAL_SEGMENTS).scale(-1,1,1).toNonIndexed(),t=e.getAttribute("uv"),n=e.getAttribute("normal");for(let r=0;r<t.count;r++)for(let o=0;o<3;o++){const a=r*3+o,l=n.getX(a),c=n.getY(a),d=n.getZ(a),u=.947;if(r<t.count/6){const p=l===0&&d===0?1:Math.acos(c)/Math.sqrt(l*l+d*d)*(2/Math.PI);t.setXY(a,l*(u/4)*p+1/4,d*(u/2)*p+1/2)}else{const p=l===0&&d===0?1:Math.acos(-c)/Math.sqrt(l*l+d*d)*(2/Math.PI);t.setXY(a,-l*(u/4)*p+3/4,d*(u/2)*p+1/2)}}e.rotateX(-Math.PI/2),e.rotateY(Math.PI);const s=new zs({depthTest:!1,depthWrite:!1});return new Gt(e,s)}};Mu.id="dual-fisheye";Mu.VERSION="5.14.0";var en=class Su{constructor(e,t){this.parent=e,this.children=[],this.state={visible:!0},this.viewer=e instanceof Su?e.viewer:e,this.container=document.createElement(t.tagName??"div"),this.container.className=t.className||"",this.parent.children.push(this),this.parent.container.appendChild(this.container)}destroy(){this.parent.container.removeChild(this.container);const e=this.parent.children.indexOf(this);e!==-1&&this.parent.children.splice(e,1),this.children.slice().forEach(t=>t.destroy()),this.children.length=0}toggle(e=!this.isVisible()){e?this.show():this.hide()}hide(e){this.container.style.display="none",this.state.visible=!1}show(e){this.container.style.display="",this.state.visible=!0}isVisible(){return this.state.visible}},Lx=jr({id:null,tagName:null,className:null,title:null,hoverScale:!1,collapsable:!1,tabbable:!0,icon:null,iconActive:null}),It=class extends en{constructor(i,e){super(i,{tagName:e.tagName,className:`psv-button ${e.hoverScale?"psv-button--hover-scale":""} ${e.className||""}`}),this.state={visible:!0,enabled:!0,supported:!0,collapsed:!1,active:!1,width:0},this.config=Lx(e),e.id||(this.config.id=this.constructor.id),e.icon&&this.__setIcon(e.icon),this.state.width=this.container.offsetWidth,this.config.title?this.container.title=this.viewer.config.lang[this.config.title]??this.config.title:this.id&&this.id in this.viewer.config.lang&&(this.container.title=this.viewer.config.lang[this.id]),e.tabbable&&(this.container.tabIndex=0),this.container.addEventListener("click",t=>{this.state.enabled&&this.onClick(),t.stopPropagation()}),this.container.addEventListener("keydown",t=>{t.key===Et.Enter&&this.state.enabled&&(this.onClick(),t.stopPropagation())})}get id(){return this.config.id}get title(){return this.container.title}get content(){return this.container.innerHTML}get width(){return this.state.width}get collapsable(){return this.config.collapsable}show(i=!0){this.isVisible()||(this.state.visible=!0,this.state.collapsed||(this.container.style.display=""),i&&this.viewer.navbar.autoSize())}hide(i=!0){this.isVisible()&&(this.state.visible=!1,this.container.style.display="none",i&&this.viewer.navbar.autoSize())}checkSupported(){nl(this.isSupported(),(i,e)=>{this.state&&(this.state.supported=i,e?i||this.hide():this.toggle(i))})}autoSize(){}isSupported(){return!0}toggleActive(i=!this.state.active){i!==this.state.active&&(this.state.active=i,Yr(this.container,"psv-button--active",this.state.active),this.config.iconActive&&this.__setIcon(this.state.active?this.config.iconActive:this.config.icon))}disable(){this.container.classList.add("psv-button--disabled"),this.state.enabled=!1}enable(){this.container.classList.remove("psv-button--disabled"),this.state.enabled=!0}collapse(){this.state.collapsed=!0,this.container.style.display="none"}uncollapse(){this.state.collapsed=!1,this.state.visible&&(this.container.style.display="")}__setIcon(i){this.container.innerHTML=i,el(this.container.querySelector("svg"),"psv-button-svg")}},Px=class extends It{constructor(i,e){var t,n;super(i,{id:e.id??`psvButton-${Math.random().toString(36).substring(2)}`,className:`psv-custom-button ${e.className||""}`,hoverScale:!1,collapsable:e.collapsable!==!1,tabbable:e.tabbable!==!1,title:e.title}),this.customOnClick=e.onClick,e.content&&(typeof e.content=="string"?this.container.innerHTML=e.content:(this.container.classList.add("psv-custom-button--no-padding"),e.content.style.height="100%",(n=(t=e.content).attachViewer)==null||n.call(t,this.viewer),this.container.appendChild(e.content))),this.state.width=this.container.offsetWidth,e.disabled&&this.disable(),e.visible===!1&&this.hide()}onClick(){var i;(i=this.customOnClick)==null||i.call(this,this.viewer)}},Os=class extends It{constructor(i){super(i,{className:"psv-description-button",hoverScale:!0,collapsable:!1,tabbable:!0,icon:si.info}),this.mode=0,this.viewer.addEventListener(Es.type,this),this.viewer.addEventListener(Ss.type,this),this.viewer.addEventListener(Yi.type,this),this.viewer.addEventListener($i.type,this),this.viewer.addEventListener(Nt.type,this)}destroy(){this.viewer.removeEventListener(Es.type,this),this.viewer.removeEventListener(Ss.type,this),this.viewer.removeEventListener(Yi.type,this),this.viewer.removeEventListener($i.type,this),this.viewer.removeEventListener(Nt.type,this),super.destroy()}handleEvent(i){if(i instanceof Nt){i.containsOptions("description")&&this.autoSize(!0);return}if(!this.mode)return;let e=!1;i instanceof Es?e=this.mode===1:i instanceof Ss?e=this.mode===1&&i.notificationId!==Mt.DESCRIPTION:i instanceof Yi?e=this.mode===2:i instanceof $i&&(e=this.mode===2&&i.panelId!==Mt.DESCRIPTION),e&&(this.toggleActive(!1),this.mode=0)}onClick(){this.mode?this.__close():this.__open()}hide(i){super.hide(i),this.mode&&this.__close()}autoSize(i=!1){if(i){const e=this.viewer.navbar.getButton("caption",!1),t=e&&!e.isVisible(),n=!!this.viewer.config.description;t||n?this.show(!1):this.hide(!1)}}__close(){switch(this.mode){case 1:this.viewer.notification.hide(Mt.DESCRIPTION);break;case 2:this.viewer.panel.hide(Mt.DESCRIPTION);break}}__open(){this.toggleActive(!0),this.viewer.config.description?(this.mode=2,this.viewer.panel.show({id:Mt.DESCRIPTION,content:`${this.viewer.config.caption?`<p>${this.viewer.config.caption}</p>`:""}${this.viewer.config.description}`})):(this.mode=1,this.viewer.notification.show({id:Mt.DESCRIPTION,content:this.viewer.config.caption}))}};Os.id="description";var bu=class extends It{constructor(i){super(i,{tagName:"a",className:"psv-download-button",hoverScale:!0,collapsable:!0,tabbable:!0,icon:si.download}),this.viewer.addEventListener(Nt.type,this),this.viewer.addEventListener(Zn.type,this)}destroy(){this.viewer.removeEventListener(Nt.type,this),this.viewer.removeEventListener(Zn.type,this),super.destroy()}handleEvent(i){i instanceof Nt?(i.containsOptions("downloadUrl")&&this.checkSupported(),i.containsOptions("downloadUrl","downloadName")&&this.__update()):i instanceof Zn&&this.__update()}onClick(){}checkSupported(){this.viewer.adapter.constructor.supportsDownload||this.viewer.config.downloadUrl?this.show():this.hide()}__update(){const i=this.container;i.href=this.viewer.config.downloadUrl||this.viewer.config.panorama,i.target="_blank",i.href.startsWith("data:")&&!this.viewer.config.downloadName?i.download="panorama."+i.href.substring(0,i.href.indexOf(";")).split("/").pop():i.download=this.viewer.config.downloadName||i.href.split("/").pop()}};bu.id="download";var Tu=class extends It{constructor(i){super(i,{className:"psv-fullscreen-button",hoverScale:!0,collapsable:!1,tabbable:!0,icon:si.fullscreenIn,iconActive:si.fullscreenOut}),this.viewer.addEventListener(xs.type,this)}destroy(){this.viewer.removeEventListener(xs.type,this),super.destroy()}handleEvent(i){i instanceof xs&&this.toggleActive(i.fullscreenEnabled)}onClick(){this.viewer.toggleFullscreen()}};Tu.id="fullscreen";var Ix="psvButton",Dx=(i,e)=>`
...
`,Cr=class extends It{constructor(i){super(i,{className:"psv-menu-button",hoverScale:!0,collapsable:!1,tabbable:!0,icon:si.menu}),this.viewer.addEventListener($i.type,this),this.viewer.addEventListener(Yi.type,this),super.hide()}destroy(){this.viewer.removeEventListener($i.type,this),this.viewer.removeEventListener(Yi.type,this),super.destroy()}handleEvent(i){i instanceof $i?this.toggleActive(i.panelId===Mt.MENU):i instanceof Yi&&this.toggleActive(!1)}onClick(){this.state.active?this.__hideMenu():this.__showMenu()}hide(i){super.hide(i),this.__hideMenu()}show(i){super.show(i),this.state.active&&this.__showMenu()}__showMenu(){this.viewer.panel.show({id:Mt.MENU,content:Dx(this.viewer.navbar.collapsed,this.viewer.config.lang.menu),noMargin:!0,clickHandler:i=>{const e=i?Ph(i,".psv-panel-menu-item"):void 0,t=e?e.dataset[Ix]:void 0;t&&(this.viewer.navbar.getButton(t).onClick(),this.__hideMenu())}})}__hideMenu(){this.viewer.panel.hide(Mt.MENU)}};Cr.id="menu";function Ux(i){let e=0;switch(i){case 0:e=90;break;case 1:e=-90;break;case 3:e=180;break;default:e=0;break}return si.arrow.replace("rotate(0",`rotate(${e}`)}var Xs=class extends It{constructor(i,e){super(i,{className:"psv-move-button",hoverScale:!0,collapsable:!1,tabbable:!0,icon:Ux(e)}),this.direction=e,this.handler=new Zr,this.container.addEventListener("mousedown",this),this.container.addEventListener("keydown",this),this.container.addEventListener("keyup",this),this.viewer.container.addEventListener("mouseup",this),this.viewer.container.addEventListener("touchend",this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener("mouseup",this),this.viewer.container.removeEventListener("touchend",this),super.destroy()}handleEvent(i){switch(i.type){case"mousedown":this.__onMouseDown();break;case"mouseup":this.__onMouseUp();break;case"touchend":this.__onMouseUp();break;case"keydown":i.key===Et.Enter&&this.__onMouseDown();break;case"keyup":i.key===Et.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return $r(Pt.isTouchEnabled)}__onMouseDown(){if(!this.state.enabled)return;const i={};switch(this.direction){case 0:i.pitch=!1;break;case 1:i.pitch=!0;break;case 3:i.yaw=!1;break;default:i.yaw=!0;break}this.viewer.stopAll(),this.viewer.dynamics.position.roll(i),this.handler.down()}__onMouseUp(){this.state.enabled&&this.handler.up(()=>{this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer()})}};Xs.groupId="move";var Au=class extends Xs{constructor(i){super(i,1)}};Au.id="moveDown";var Cu=class extends Xs{constructor(i){super(i,2)}};Cu.id="moveLeft";var Ru=class extends Xs{constructor(i){super(i,3)}};Ru.id="moveRight";var Lu=class extends Xs{constructor(i){super(i,0)}};Lu.id="moveUp";var cl=class extends It{constructor(i,e,t){super(i,{className:"psv-zoom-button",hoverScale:!0,collapsable:!1,tabbable:!0,icon:e}),this.direction=t,this.handler=new Zr,this.container.addEventListener("mousedown",this),this.container.addEventListener("keydown",this),this.container.addEventListener("keyup",this),this.viewer.container.addEventListener("mouseup",this),this.viewer.container.addEventListener("touchend",this)}destroy(){this.__onMouseUp(),this.viewer.container.removeEventListener("mouseup",this),this.viewer.container.removeEventListener("touchend",this),super.destroy()}handleEvent(i){switch(i.type){case"mousedown":this.__onMouseDown();break;case"mouseup":this.__onMouseUp();break;case"touchend":this.__onMouseUp();break;case"keydown":i.key===Et.Enter&&this.__onMouseDown();break;case"keyup":i.key===Et.Enter&&this.__onMouseUp();break}}onClick(){}isSupported(){return $r(Pt.isTouchEnabled)}__onMouseDown(){this.state.enabled&&(this.viewer.dynamics.zoom.roll(this.direction===1),this.handler.down())}__onMouseUp(){this.state.enabled&&this.handler.up(()=>this.viewer.dynamics.zoom.stop())}};cl.groupId="zoom";var Pu=class extends cl{constructor(i){super(i,si.zoomIn,0)}};Pu.id="zoomIn";var Iu=class extends cl{constructor(i){super(i,si.zoomOut,1)}};Iu.id="zoomOut";var hl=class extends It{constructor(i){super(i,{className:"psv-zoom-range",hoverScale:!1,collapsable:!1,tabbable:!1}),this.zoomRange=document.createElement("div"),this.zoomRange.className="psv-zoom-range-line",this.container.appendChild(this.zoomRange),this.zoomValue=document.createElement("div"),this.zoomValue.className="psv-zoom-range-handle",this.zoomRange.appendChild(this.zoomValue),this.slider=new Zh(this.container,"HORIZONTAL",e=>this.__onSliderUpdate(e)),this.mediaMinWidth=parseInt(di(this.container,"max-width"),10),this.viewer.addEventListener(Ti.type,this),this.viewer.state.ready?this.__moveZoomValue(this.viewer.getZoomLevel()):this.viewer.addEventListener(ws.type,this)}destroy(){this.slider.destroy(),this.viewer.removeEventListener(Ti.type,this),this.viewer.removeEventListener(ws.type,this),super.destroy()}handleEvent(i){i instanceof Ti?this.__moveZoomValue(i.zoomLevel):i instanceof ws&&this.__moveZoomValue(this.viewer.getZoomLevel())}onClick(){}isSupported(){return $r(Pt.isTouchEnabled)}autoSize(){this.state.supported&&(this.viewer.state.size.width<=this.mediaMinWidth&&this.state.visible?this.hide(!1):this.viewer.state.size.width>this.mediaMinWidth&&!this.state.visible&&this.show(!1))}__moveZoomValue(i){this.zoomValue.style.left=i/100*this.zoomRange.offsetWidth-this.zoomValue.offsetWidth/2+"px"}__onSliderUpdate(i){i.mousedown&&this.viewer.zoom(i.value*100)}};hl.id="zoomRange";hl.groupId="zoom";var Du=class extends Kh{constructor(i){super(),this.viewer=i}init(){}destroy(){}},dl=class extends Du{constructor(i,e){super(i),this.config=this.constructor.configParser(e)}setOption(i,e){this.setOptions({[i]:e})}setOptions(i){const e={...this.config,...i},t=this.constructor,n=t.configParser,s=t.readonlyOptions,r=t.id;for(let[o,a]of Object.entries(i)){if(!(o in n.defaults)){wt(`${r}: Unknown option "${o}"`);continue}if(s.includes(o)){wt(`${r}: Option "${o}" cannot be updated`);continue}o in n.parsers&&(a=n.parsers[o](a,{rawConfig:e,defValue:n.defaults[o]})),this.config[o]=a}}};dl.readonlyOptions=[];function Da(i){if(i){for(const[,e]of[["_",i],...Object.entries(i)])if(e.prototype instanceof Du)return ol(e.id,e.VERSION,"5.14.0"),e}return null}var Pi={panorama:null,container:null,adapter:[yu,null],plugins:[],caption:null,description:null,downloadUrl:null,downloadName:null,loadingImg:null,loadingTxt:"",size:null,fisheye:0,minFov:30,maxFov:90,defaultZoomLvl:50,defaultYaw:0,defaultPitch:0,sphereCorrection:null,moveSpeed:1,zoomSpeed:1,moveInertia:.8,mousewheel:!0,mousemove:!0,mousewheelCtrlKey:!1,touchmoveTwoFingers:!1,panoData:null,requestHeaders:null,canvasBackground:"#000",defaultTransition:{speed:1500,rotation:!0,effect:"fade"},rendererParameters:{alpha:!0,antialias:!0},withCredentials:()=>!1,navbar:["zoom","move","download","description","caption","fullscreen"],lang:{zoom:"Zoom",zoomOut:"Zoom out",zoomIn:"Zoom in",moveUp:"Move up",moveDown:"Move down",moveLeft:"Move left",moveRight:"Move right",description:"Description",download:"Download",fullscreen:"Fullscreen",loading:"Loading...",menu:"Menu",close:"Close",twoFingers:"Use two fingers to navigate",ctrlZoom:"Use ctrl + scroll to zoom the image",loadError:"The panorama cannot be loaded",webglError:"Your browser does not seem to support WebGL"},keyboard:"fullscreen",keyboardActions:{[Et.ArrowUp]:"ROTATE_UP",[Et.ArrowDown]:"ROTATE_DOWN",[Et.ArrowRight]:"ROTATE_RIGHT",[Et.ArrowLeft]:"ROTATE_LEFT",[Et.PageUp]:"ZOOM_IN",[Et.PageDown]:"ZOOM_OUT",[Et.Plus]:"ZOOM_IN",[Et.Minus]:"ZOOM_OUT"}},bc={panorama:"Use setPanorama method to change the panorama",panoData:"Use setPanorama method to change the panorama",container:"Cannot change viewer container",adapter:"Cannot change adapter",plugins:"Cannot change plugins"},Ua={container:i=>{if(!i)throw new he("No value given for container.");return i},adapter:(i,{defValue:e})=>{if(i?Array.isArray(i)?i=[Sc(i[0]),i[1]]:i=[Sc(i),null]:i=e,!i[0])throw new he("An undefined value was given for adapter.");if(!i[0].id)throw new he("Adapter has no id.");return i},defaultYaw:i=>li(i),defaultPitch:i=>li(i,!0),defaultZoomLvl:i=>Ve.clamp(i,0,100),minFov:(i,{rawConfig:e})=>(e.maxFov<i&&(wt("maxFov cannot be lower than minFov"),i=e.maxFov),Ve.clamp(i,1,179)),maxFov:(i,{rawConfig:e})=>(i<e.minFov&&(i=e.minFov),Ve.clamp(i,1,179)),moveInertia:(i,{defValue:e})=>i===!0?e:i===!1?0:i,lang:i=>({...Pi.lang,...i}),fisheye:i=>i===!0?1:i===!1?0:i,requestHeaders:i=>i&&typeof i=="object"?()=>i:typeof i=="function"?i:null,withCredentials:i=>typeof i=="boolean"?()=>i:typeof i=="function"?i:()=>!1,defaultTransition:(i,{defValue:e})=>i===null||i.speed===0?null:{...e,...i},rendererParameters:(i,{defValue:e})=>({...i,...e}),plugins:i=>i.map((e,t)=>{if(Array.isArray(e)?e=[Da(e[0]),e[1]]:e=[Da(e),null],!e[0])throw new he(`An undefined value was given for plugin ${t}.`);if(!e[0].id)throw new he(`Plugin ${t} has no id.`);return e}),navbar:i=>i===!1?null:i===!0?qr(Pi.navbar):typeof i=="string"?i.split(/[ ,]/):i},Nx=jr(Pi,Ua),Yn=class extends It{constructor(i){super(i,{className:"psv-caption",hoverScale:!1,collapsable:!1,tabbable:!0}),this.contentWidth=0,this.state.width=0,this.contentElt=document.createElement("div"),this.contentElt.className="psv-caption-content",this.container.appendChild(this.contentElt),this.setCaption(this.viewer.config.caption)}hide(){this.contentElt.style.display="none",this.state.visible=!1}show(){this.contentElt.style.display="",this.state.visible=!0}onClick(){}setCaption(i){this.show(),this.contentElt.innerHTML=i??"",this.contentElt.innerHTML?this.contentWidth=this.contentElt.offsetWidth:this.contentWidth=0,this.autoSize()}autoSize(){this.toggle(this.container.offsetWidth>=this.contentWidth),this.__refreshButton()}__refreshButton(){var i;(i=this.viewer.navbar.getButton(Os.id,!1))==null||i.autoSize(!0)}};Yn.id="caption";var Na={},zr={};function ul(i,e){if(!i.id)throw new he("Button id is required");if(Na[i.id]=i,i.groupId&&(zr[i.groupId]=zr[i.groupId]||[]).push(i),e){const t=Pi.navbar;switch(e){case"start":t.unshift(i.id);break;case"end":t.push(i.id);break;default:{const[n,s]=e.split(":"),r=t.indexOf(n);if(!n||!s||r===-1)throw new he(`Invalid defaultPosition ${e}`);t.splice(r+(s==="right"?1:0),0,i.id)}}}}[Iu,hl,Pu,Os,Yn,bu,Tu,Cu,Ru,Lu,Au].forEach(i=>ul(i));var Ox=class extends en{constructor(i){super(i,{className:`psv-navbar ${Gs}`}),this.collapsed=[],this.state.visible=!1}show(){this.viewer.container.classList.add("psv--has-navbar"),this.container.classList.add("psv-navbar--open"),this.state.visible=!0}hide(){this.viewer.container.classList.remove("psv--has-navbar"),this.container.classList.remove("psv-navbar--open"),this.state.visible=!1}setButtons(i){this.children.slice().forEach(e=>e.destroy()),this.children.length=0,i.indexOf(Yn.id)!==-1&&i.indexOf(Os.id)===-1&&i.splice(i.indexOf(Yn.id),0,Os.id),i.forEach(e=>{typeof e=="object"?new Px(this,e):Na[e]?new Na[e](this):zr[e]?zr[e].forEach(t=>{new t(this)}):wt(`Unknown button ${e}`)}),new Cr(this),this.children.forEach(e=>{e instanceof It&&e.checkSupported()}),this.autoSize()}setCaption(i){this.children.some(e=>e instanceof Yn?(e.setCaption(i),!0):!1)}getButton(i,e=!0){const t=this.children.find(n=>n instanceof It&&n.id===i);return!t&&e&&wt(`button "${i}" not found in the navbar`),t}focusButton(i){var e,t;this.isVisible()&&((t=((e=this.getButton(i,!1))==null?void 0:e.container)||this.container.firstElementChild)==null||t.focus())}autoSize(){var n;this.children.forEach(s=>{s instanceof It&&s.autoSize()});const i=this.container.offsetWidth;let e=0;const t=[];this.children.forEach(s=>{s.isVisible()&&s instanceof It&&(e+=s.width,s.collapsable&&t.push(s))}),e!==0&&(i<e&&t.length>0?(t.forEach(s=>s.collapse()),this.collapsed=t,this.getButton(Cr.id).show(!1)):i>=e&&this.collapsed.length>0&&(this.collapsed.forEach(s=>s.uncollapse()),this.collapsed=[],this.getButton(Cr.id).hide(!1)),(n=this.getButton(Yn.id,!1))==null||n.autoSize())}};Xi.enabled=!1;var Gn={enabled:!0,maxItems:10,ttl:10*60,items:{},purgeInterval:null,init(){Xi.enabled&&(wt("ThreeJS cache should be disabled"),Xi.enabled=!1),!this.purgeInterval&&this.enabled&&(this.purgeInterval=setInterval(()=>this.purge(),60*1e3))},add(i,e,t){this.enabled&&e&&(this.items[e]=this.items[e]??{files:{},lastAccess:null},this.items[e].files[i]=t,this.items[e].lastAccess=Date.now())},get(i,e){if(this.enabled&&e&&this.items[e])return this.items[e].lastAccess=Date.now(),this.items[e].files[i]},remove(i,e){this.enabled&&e&&this.items[e]&&(delete this.items[e].files[i],Object.keys(this.items[e].files).length===0&&delete this.items[e])},purge(){Object.entries(this.items).sort(([,i],[,e])=>e.lastAccess-i.lastAccess).forEach(([i,{lastAccess:e}],t)=>{t>0&&(Date.now()-e>=this.ttl*1e3||t>=this.maxItems)&&delete this.items[i]})}},Fx=class extends en{constructor(i){super(i,{className:"psv-loader-container"}),this.loader=document.createElement("div"),this.loader.className="psv-loader",this.container.appendChild(this.loader),this.size=this.loader.offsetWidth,this.canvas=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.canvas.setAttribute("class","psv-loader-canvas"),this.canvas.setAttribute("viewBox",`0 0 ${this.size} ${this.size}`),this.loader.appendChild(this.canvas),this.textColor=di(this.loader,"color"),this.color=di(this.canvas,"color"),this.border=parseInt(di(this.loader,"--psv-loader-border"),10),this.thickness=parseInt(di(this.loader,"--psv-loader-tickness"),10);const e=this.size/2;this.canvas.innerHTML=`
            <circle cx="${e}" cy="${e}" r="${e}" fill="${this.color}"/>
            <path d="" fill="none" stroke="${this.textColor}" stroke-width="${this.thickness}" stroke-linecap="round"/>
        `,this.viewer.addEventListener(Nt.type,this),this.__updateContent(),this.hide()}destroy(){this.viewer.removeEventListener(Nt.type,this),super.destroy()}handleEvent(i){i instanceof Nt&&i.containsOptions("loadingImg","loadingTxt","lang")&&this.__updateContent()}setProgress(i){this.container.classList.remove("psv-loader--undefined");const e=Ve.clamp(i,0,99.999)/100*Math.PI*2,t=this.size/2,n=t,s=this.thickness/2+this.border,r=(this.size-this.thickness)/2-this.border,o=Math.sin(e)*r+t,a=-Math.cos(e)*r+t,l=i>50?"1":"0";this.canvas.querySelector("path").setAttributeNS(null,"d",`M ${n} ${s} A ${r} ${r} 0 ${l} 1 ${o} ${a}`)}showUndefined(){this.show(),this.setProgress(25),this.container.classList.add("psv-loader--undefined")}__updateContent(){const i=this.loader.querySelector(".psv-loader-image, .psv-loader-text");i&&this.loader.removeChild(i);let e;if(this.viewer.config.loadingImg?(e=document.createElement("img"),e.className="psv-loader-image",e.src=this.viewer.config.loadingImg):this.viewer.config.loadingTxt!==null&&(e=document.createElement("div"),e.className="psv-loader-text",e.innerHTML=this.viewer.config.loadingTxt||this.viewer.config.lang.loading),e){const t=Math.round(Math.sqrt(2*Math.pow(this.size/2-this.thickness/2-this.border,2)));e.style.maxWidth=t+"px",e.style.maxHeight=t+"px",this.loader.appendChild(e)}}},kx=class extends en{constructor(i){super(i,{className:"psv-notification"}),this.state={visible:!1,contentId:null,timeout:null},this.content=document.createElement("div"),this.content.className="psv-notification-content",this.container.appendChild(this.content),this.content.addEventListener("click",()=>this.hide())}isVisible(i){return this.state.visible&&(!i||!this.state.contentId||this.state.contentId===i)}toggle(){throw new he("Notification cannot be toggled")}show(i){this.state.timeout&&(clearTimeout(this.state.timeout),this.state.timeout=null),typeof i=="string"&&(i={content:i}),this.state.contentId=i.id||null,this.content.innerHTML=i.content,this.container.classList.add("psv-notification--visible"),this.state.visible=!0,this.viewer.dispatchEvent(new Ss(this.state.contentId)),i.timeout&&(this.state.timeout=setTimeout(()=>this.hide(this.state.contentId),i.timeout))}hide(i){if(this.isVisible(i)){const e=this.state.contentId;this.container.classList.remove("psv-notification--visible"),this.state.visible=!1,this.state.contentId=null,this.viewer.dispatchEvent(new Es(e))}}},zx=class extends en{constructor(i){super(i,{className:`psv-overlay ${Gs}`}),this.state={visible:!1,contentId:null,dismissible:!0},this.image=document.createElement("div"),this.image.className="psv-overlay-image",this.container.appendChild(this.image),this.title=document.createElement("div"),this.title.className="psv-overlay-title",this.container.appendChild(this.title),this.text=document.createElement("div"),this.text.className="psv-overlay-text",this.container.appendChild(this.text),this.container.addEventListener("click",this),this.viewer.addEventListener(qi.type,this),super.hide()}destroy(){this.viewer.removeEventListener(qi.type,this),super.destroy()}handleEvent(i){i.type==="click"?this.isVisible()&&this.state.dismissible&&(this.hide(),i.stopPropagation()):i instanceof qi&&this.isVisible()&&this.state.dismissible&&i.matches(Et.Escape)&&(this.hide(),i.preventDefault())}isVisible(i){return this.state.visible&&(!i||!this.state.contentId||this.state.contentId===i)}toggle(){throw new he("Overlay cannot be toggled")}show(i){typeof i=="string"&&(i={title:i}),this.state.contentId=i.id||null,this.state.dismissible=i.dismissible!==!1,this.image.innerHTML=i.image||"",this.title.innerHTML=i.title||"",this.text.innerHTML=i.text||"",super.show(),this.viewer.dispatchEvent(new eu(this.state.contentId))}hide(i){if(this.isVisible(i)){const e=this.state.contentId;super.hide(),this.state.contentId=null,this.viewer.dispatchEvent(new xd(e))}}},Bx=200,Uo="psv-panel-content--no-interaction",Hx=class extends en{constructor(i){super(i,{className:`psv-panel ${Gs}`}),this.state={visible:!1,contentId:null,mouseX:0,mouseY:0,mousedown:!1,clickHandler:null,keyHandler:null,width:{}};const e=document.createElement("div");e.className="psv-panel-resizer",this.container.appendChild(e);const t=document.createElement("div");t.className="psv-panel-close-button",t.innerHTML=si.close,t.title=i.config.lang.close,this.container.appendChild(t),this.content=document.createElement("div"),this.content.className="psv-panel-content",this.container.appendChild(this.content),t.addEventListener("click",()=>this.hide()),e.addEventListener("mousedown",this),e.addEventListener("touchstart",this),this.viewer.container.addEventListener("mouseup",this),this.viewer.container.addEventListener("touchend",this),this.viewer.container.addEventListener("mousemove",this),this.viewer.container.addEventListener("touchmove",this),this.viewer.addEventListener(qi.type,this)}destroy(){this.viewer.removeEventListener(qi.type,this),this.viewer.container.removeEventListener("mousemove",this),this.viewer.container.removeEventListener("touchmove",this),this.viewer.container.removeEventListener("mouseup",this),this.viewer.container.removeEventListener("touchend",this),super.destroy()}handleEvent(i){switch(i.type){case"mousedown":this.__onMouseDown(i);break;case"touchstart":this.__onTouchStart(i);break;case"mousemove":this.__onMouseMove(i);break;case"touchmove":this.__onTouchMove(i);break;case"mouseup":this.__onMouseUp(i);break;case"touchend":this.__onTouchEnd(i);break;case qi.type:this.__onKeyPress(i);break}}isVisible(i){return this.state.visible&&(!i||!this.state.contentId||this.state.contentId===i)}toggle(){throw new he("Panel cannot be toggled")}show(i){typeof i=="string"&&(i={content:i});const e=this.isVisible(i.id);this.state.contentId=i.id||null,this.state.visible=!0,this.state.clickHandler&&(this.content.removeEventListener("click",this.state.clickHandler),this.content.removeEventListener("keydown",this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),i.id&&this.state.width[i.id]?this.container.style.width=this.state.width[i.id]:i.width?this.container.style.width=i.width:this.container.style.width=null,this.content.innerHTML=i.content,this.content.scrollTop=0,this.container.classList.add("psv-panel--open"),Yr(this.content,"psv-panel-content--no-margin",i.noMargin===!0),i.clickHandler&&(this.state.clickHandler=t=>{i.clickHandler(Ur(t))},this.state.keyHandler=t=>{t.key===Et.Enter&&i.clickHandler(Ur(t))},this.content.addEventListener("click",this.state.clickHandler),this.content.addEventListener("keydown",this.state.keyHandler),e||setTimeout(()=>{var t;(t=this.content.querySelector("a,button,[tabindex]"))==null||t.focus()},300)),this.viewer.dispatchEvent(new $i(this.state.contentId))}hide(i){if(this.isVisible(i)){const e=this.state.contentId;this.state.visible=!1,this.state.contentId=null,this.content.innerHTML=null,this.container.classList.remove("psv-panel--open"),this.state.clickHandler&&(this.content.removeEventListener("click",this.state.clickHandler),this.content.removeEventListener("keydown",this.state.keyHandler),this.state.clickHandler=null,this.state.keyHandler=null),this.viewer.dispatchEvent(new Yi(e))}}__onMouseDown(i){i.stopPropagation(),this.__startResize(i.clientX,i.clientY)}__onTouchStart(i){if(i.stopPropagation(),i.touches.length===1){const e=i.touches[0];this.__startResize(e.clientX,e.clientY)}}__onMouseUp(i){this.state.mousedown&&(i.stopPropagation(),this.state.mousedown=!1,this.content.classList.remove(Uo))}__onTouchEnd(i){this.state.mousedown&&(i.stopPropagation(),i.touches.length===0&&(this.state.mousedown=!1,this.content.classList.remove(Uo)))}__onMouseMove(i){this.state.mousedown&&(i.stopPropagation(),this.__resize(i.clientX,i.clientY))}__onTouchMove(i){if(this.state.mousedown){const e=i.touches[0];this.__resize(e.clientX,e.clientY)}}__onKeyPress(i){this.isVisible()&&i.matches(Et.Escape)&&(this.hide(),i.preventDefault())}__startResize(i,e){this.state.mouseX=i,this.state.mouseY=e,this.state.mousedown=!0,this.content.classList.add(Uo)}__resize(i,e){const t=i,n=e,s=Math.max(Bx,this.container.offsetWidth-(t-this.state.mouseX))+"px";this.state.contentId&&(this.state.width[this.state.contentId]=s),this.container.style.width=s,this.state.mouseX=t,this.state.mouseY=n}},Vx=class extends en{constructor(i,e){super(i,{className:"psv-tooltip"}),this.state={visible:!0,arrow:0,border:0,state:0,width:0,height:0,pos:"",config:null,data:null,hideTimeout:null},this.content=document.createElement("div"),this.content.className="psv-tooltip-content",this.container.appendChild(this.content),this.arrow=document.createElement("div"),this.arrow.className="psv-tooltip-arrow",this.container.appendChild(this.arrow),this.container.addEventListener("transitionend",this),this.container.addEventListener("touchdown",t=>t.stopPropagation()),this.container.addEventListener("mousedown",t=>t.stopPropagation()),this.container.style.top="-1000px",this.container.style.left="-1000px",this.show(e)}handleEvent(i){i.type==="transitionend"&&this.__onTransitionEnd(i)}destroy(){clearTimeout(this.state.hideTimeout),delete this.state.data,super.destroy()}toggle(){throw new he("Tooltip cannot be toggled")}show(i){if(this.state.state!==0)throw new he("Initialized tooltip cannot be re-initialized");i.className&&el(this.container,i.className),i.style&&Object.assign(this.container.style,i.style),this.state.state=3,this.update(i.content,i),this.state.data=i.data,this.state.state=1,this.viewer.dispatchEvent(new ru(this,this.state.data)),this.__waitImages()}update(i,e){this.content.innerHTML=i;const t=this.container.getBoundingClientRect();this.state.width=t.right-t.left,this.state.height=t.bottom-t.top,this.state.arrow=parseInt(di(this.arrow,"border-top-width"),10),this.state.border=parseInt(di(this.container,"border-top-left-radius"),10),this.move(e??this.state.config),this.__waitImages()}move(i){var a;if(this.state.state!==1&&this.state.state!==3)throw new he("Uninitialized tooltip cannot be moved");i.box=i.box??((a=this.state.config)==null?void 0:a.box)??{width:0,height:0},this.state.config=i;const e=this.container,t=this.arrow,n={posClass:Gh(i.position,{allowCenter:!1,cssOrder:!1})||["top","center"],width:this.state.width,height:this.state.height,top:0,left:0,arrowTop:0,arrowLeft:0};this.__computeTooltipPosition(n,i);let s=null,r=null;if(n.top<0?s="bottom":n.top+n.height>this.viewer.state.size.height&&(s="top"),n.left<0?r="right":n.left+n.width>this.viewer.state.size.width&&(r="left"),r||s){const l=rl(n.posClass);s&&(n.posClass[l?0:1]=s),r&&(n.posClass[l?1:0]=r),this.__computeTooltipPosition(n,i)}e.style.top=n.top+"px",e.style.left=n.left+"px",t.style.top=n.arrowTop+"px",t.style.left=n.arrowLeft+"px";const o=n.posClass.join("-");o!==this.state.pos&&(e.classList.remove(`psv-tooltip--${this.state.pos}`),this.state.pos=o,e.classList.add(`psv-tooltip--${this.state.pos}`))}hide(){this.container.classList.remove("psv-tooltip--visible"),this.state.state=2,this.viewer.dispatchEvent(new Sd(this.state.data));const i=parseFloat(di(this.container,"transition-duration"));this.state.hideTimeout=setTimeout(()=>{this.destroy()},i*2)}__onTransitionEnd(i){if(i.propertyName==="transform")switch(this.state.state){case 1:this.container.classList.add("psv-tooltip--visible"),this.state.state=3;break;case 2:this.state.state=0,this.destroy();break}}__computeTooltipPosition(i,e){const t=this.state.arrow,n=e.top,s=i.height,r=e.left,o=i.width,a=t+this.state.border,l=e.box.width/2+t*2,c=e.box.height/2+t*2;switch(i.posClass.join("-")){case"top-left":i.top=n-c-s,i.left=r+a-o,i.arrowTop=s,i.arrowLeft=o-a-t;break;case"top-center":i.top=n-c-s,i.left=r-o/2,i.arrowTop=s,i.arrowLeft=o/2-t;break;case"top-right":i.top=n-c-s,i.left=r-a,i.arrowTop=s,i.arrowLeft=t;break;case"bottom-left":i.top=n+c,i.left=r+a-o,i.arrowTop=-t*2,i.arrowLeft=o-a-t;break;case"bottom-center":i.top=n+c,i.left=r-o/2,i.arrowTop=-t*2,i.arrowLeft=o/2-t;break;case"bottom-right":i.top=n+c,i.left=r-a,i.arrowTop=-t*2,i.arrowLeft=t;break;case"left-top":i.top=n+a-s,i.left=r-l-o,i.arrowTop=s-a-t,i.arrowLeft=o;break;case"center-left":i.top=n-s/2,i.left=r-l-o,i.arrowTop=s/2-t,i.arrowLeft=o;break;case"left-bottom":i.top=n-a,i.left=r-l-o,i.arrowTop=t,i.arrowLeft=o;break;case"right-top":i.top=n+a-s,i.left=r+l,i.arrowTop=s-a-t,i.arrowLeft=-t*2;break;case"center-right":i.top=n-s/2,i.left=r+l,i.arrowTop=s/2-t,i.arrowLeft=-t*2;break;case"right-bottom":i.top=n-a,i.left=r+l,i.arrowTop=t,i.arrowLeft=-t*2;break}}__waitImages(){const i=this.content.querySelectorAll("img");if(i.length>0){const e=[];i.forEach(t=>{t.complete||e.push(new Promise(n=>{t.onload=n,t.onerror=n}))}),e.length&&Promise.all(e).then(()=>{if(this.state.state===1||this.state.state===3){const t=this.container.getBoundingClientRect();this.state.width=t.right-t.left,this.state.height=t.bottom-t.top,this.move(this.state.config)}})}}},Gx=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70"><path fill="currentColor" d="M50,16.2c-18.6,0-33.8,15.1-33.8,33.8S31.4,83.7,50,83.7S83.8,68.6,83.8,50S68.6,16.2,50,16.2z M50,80.2c-16.7,0-30.2-13.6-30.2-30.2S33.3,19.7,50,19.7S80.3,33.3,80.3,50S66.7,80.2,50,80.2z"/><rect fill="currentColor" x="48" y="31.7" width="4" height="28"/><rect fill="currentColor" x="48" y="63.2" width="4" height="5"/><!--Created by Shastry from the Noun Project--></svg>
`,Ys=class{constructor(i){this.viewer=i,this.config=i.config,this.state=i.state}destroy(){}},Qt=new N,_r=new pi(0,0,0,"ZXY"),Wx=class extends Ys{constructor(i){super(i)}fovToZoomLevel(i){const e=Math.round((i-this.config.minFov)/(this.config.maxFov-this.config.minFov)*100);return Ve.clamp(e-2*(e-50),0,100)}zoomLevelToFov(i){return this.config.maxFov+i/100*(this.config.minFov-this.config.maxFov)}vFovToHFov(i){return Ve.radToDeg(2*Math.atan(Math.tan(Ve.degToRad(i)/2)*this.state.aspect))}hFovToVFov(i){return Ve.radToDeg(2*Math.atan(Math.tan(Ve.degToRad(i)/2)/this.state.aspect))}getAnimationProperties(i,e,t){const n=!yt(e),s=!yt(t),r={};let o=null;if(n){const a=this.viewer.getPosition(),l=Ch(a.yaw,e.yaw);r.yaw={start:a.yaw,end:a.yaw+l},r.pitch={start:a.pitch,end:e.pitch},o=Ra(i,Rh(a,e))}if(s){const a=this.viewer.getZoomLevel(),l=Math.abs(t-a);r.zoom={start:a,end:t},o===null&&(o=Ra(i,Math.PI/4*l/100))}return o===null?typeof i=="number"?o=i:o=Ta:o=Math.max(Ta,o),{duration:o,properties:r}}getTransitionOptions(i){let e;const t=this.config.defaultTransition??Pi.defaultTransition;return i.transition===!1||i.transition===null?e=null:i.transition===!0?e={...t}:typeof i.transition=="object"?e={...t,...i.transition}:e=this.config.defaultTransition,e}textureCoordsToSphericalCoords(i){var t;if(!((t=this.state.textureData)!=null&&t.panoData))throw new he("Current adapter does not support texture coordinates or no texture has been loaded");const e=this.viewer.adapter.textureCoordsToSphericalCoords(i,this.state.textureData.panoData);return!_r.equals(this.viewer.renderer.panoramaPose)||!_r.equals(this.viewer.renderer.sphereCorrection)?(this.sphericalCoordsToVector3(e,Qt),Qt.applyEuler(this.viewer.renderer.panoramaPose),Qt.applyEuler(this.viewer.renderer.sphereCorrection),this.vector3ToSphericalCoords(Qt)):e}sphericalCoordsToTextureCoords(i){var e;if(!((e=this.state.textureData)!=null&&e.panoData))throw new he("Current adapter does not support texture coordinates or no texture has been loaded");return(!_r.equals(this.viewer.renderer.panoramaPose)||!_r.equals(this.viewer.renderer.sphereCorrection))&&(this.sphericalCoordsToVector3(i,Qt),Pa(Qt,this.viewer.renderer.sphereCorrection),Pa(Qt,this.viewer.renderer.panoramaPose),i=this.vector3ToSphericalCoords(Qt)),this.viewer.adapter.sphericalCoordsToTextureCoords(i,this.state.textureData.panoData)}sphericalCoordsToVector3(i,e,t=Mn){return e||(e=new N),e.x=t*-Math.cos(i.pitch)*Math.sin(i.yaw),e.y=t*Math.sin(i.pitch),e.z=t*Math.cos(i.pitch)*Math.cos(i.yaw),e}vector3ToSphericalCoords(i){const e=Math.acos(i.y/Math.sqrt(i.x*i.x+i.y*i.y+i.z*i.z)),t=Math.atan2(i.x,i.z);return{yaw:t<0?-t:Math.PI*2-t,pitch:Math.PI/2-e}}viewerCoordsToVector3(i){const e=this.viewer.renderer.getIntersections(i).filter(t=>t.object.userData[Ki]);return e.length?e[0].point:null}viewerCoordsToSphericalCoords(i){const e=this.viewerCoordsToVector3(i);return e?this.vector3ToSphericalCoords(e):null}vector3ToViewerCoords(i){const e=i.clone();return e.project(this.viewer.renderer.camera),{x:Math.round((e.x+1)/2*this.state.size.width),y:Math.round((1-e.y)/2*this.state.size.height)}}sphericalCoordsToViewerCoords(i){return this.sphericalCoordsToVector3(i,Qt),this.vector3ToViewerCoords(Qt)}isPointVisible(i){let e,t;if(i instanceof N)e=i,t=this.vector3ToViewerCoords(i);else if(sl(i))e=this.sphericalCoordsToVector3(i,Qt),t=this.vector3ToViewerCoords(e);else return!1;return e.dot(this.viewer.state.direction)>0&&t.x>=0&&t.x<=this.viewer.state.size.width&&t.y>=0&&t.y<=this.viewer.state.size.height}cleanPosition(i){if("yaw"in i||"pitch"in i){if(!("yaw"in i)||!("pitch"in i))throw new he("Position is missing 'yaw' or 'pitch'");return{yaw:li(i.yaw),pitch:li(i.pitch,!0)}}else return this.textureCoordsToSphericalCoords(i)}cleanSphereCorrection(i){return{pan:li((i==null?void 0:i.pan)||0),tilt:li((i==null?void 0:i.tilt)||0,!0),roll:li((i==null?void 0:i.roll)||0,!0,!1)}}cleanPanoramaPose(i){return{pan:Ve.degToRad((i==null?void 0:i.poseHeading)||0),tilt:Ve.degToRad((i==null?void 0:i.posePitch)||0),roll:Ve.degToRad((i==null?void 0:i.poseRoll)||0)}}cleanPanoramaOptions(i,e){return e!=null&&e.isEquirectangular&&(yt(i.zoom)&&!yt(e.initialFov)&&(i={...i,zoom:this.fovToZoomLevel(this.hFovToVFov(e.initialFov))}),yt(i.position)&&!yt(e.initialHeading)&&!yt(e.initialPitch)&&(i={...i,position:{yaw:li(e.initialHeading),pitch:li(e.initialPitch,!0)}})),i}},Xx=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="currentColor" d="M33.38 33.2a1.96 1.96 0 0 0 1.5-3.23 10.61 10.61 0 0 1 7.18-17.51c.7-.06 1.31-.49 1.61-1.12a13.02 13.02 0 0 1 11.74-7.43c7.14 0 12.96 5.8 12.96 12.9 0 3.07-1.1 6.05-3.1 8.38-.7.82-.61 2.05.21 2.76.83.7 2.07.6 2.78-.22a16.77 16.77 0 0 0 4.04-10.91C72.3 7.54 64.72 0 55.4 0a16.98 16.98 0 0 0-14.79 8.7 14.6 14.6 0 0 0-12.23 14.36c0 3.46 1.25 6.82 3.5 9.45.4.45.94.69 1.5.69m45.74 43.55a22.13 22.13 0 0 1-5.23 12.4c-4 4.55-9.53 6.86-16.42 6.86-12.6 0-20.1-10.8-20.17-10.91a1.82 1.82 0 0 0-.08-.1c-5.3-6.83-14.55-23.82-17.27-28.87-.05-.1 0-.21.02-.23a6.3 6.3 0 0 1 8.24 1.85l9.38 12.59a1.97 1.97 0 0 0 3.54-1.17V25.34a4 4 0 0 1 1.19-2.87 3.32 3.32 0 0 1 2.4-.95c1.88.05 3.4 1.82 3.4 3.94v24.32a1.96 1.96 0 0 0 3.93 0v-33.1a3.5 3.5 0 0 1 7 0v35.39a1.96 1.96 0 0 0 3.93 0v-.44c.05-2.05 1.6-3.7 3.49-3.7 1.93 0 3.5 1.7 3.5 3.82v5.63c0 .24.04.48.13.71l.1.26a1.97 1.97 0 0 0 3.76-.37c.33-1.78 1.77-3.07 3.43-3.07 1.9 0 3.45 1.67 3.5 3.74l-1.77 18.1zM77.39 51c-1.25 0-2.45.32-3.5.9v-.15c0-4.27-3.33-7.74-7.42-7.74-1.26 0-2.45.33-3.5.9V16.69a7.42 7.42 0 0 0-14.85 0v1.86a7 7 0 0 0-3.28-.94 7.21 7.21 0 0 0-5.26 2.07 7.92 7.92 0 0 0-2.38 5.67v37.9l-5.83-7.82a10.2 10.2 0 0 0-13.35-2.92 4.1 4.1 0 0 0-1.53 5.48C20 64.52 28.74 80.45 34.07 87.34c.72 1.04 9.02 12.59 23.4 12.59 7.96 0 14.66-2.84 19.38-8.2a26.06 26.06 0 0 0 6.18-14.6l1.78-18.2v-.2c0-4.26-3.32-7.73-7.42-7.73z"/><!--Created by AomAm from the Noun Project--></svg>
...
`,Qr=class Uu{constructor(){this.$=Uu.IDLE}is(...e){return e.some(t=>this.$&t)}set(e){this.$=e}add(e){this.$|=e}remove(e){this.$&=~e}};Qr.IDLE=0;Qr.CLICK=1;Qr.MOVING=2;var mt=Qr,qx=class extends Ys{constructor(i){super(i),this.data={startMouseX:0,startMouseY:0,mouseX:0,mouseY:0,pinchDist:0,moveDelta:{yaw:0,pitch:0,zoom:0},accumulatorFactor:0,ctrlKeyDown:!1,dblclickData:null,dblclickTimeout:null,longtouchTimeout:null,twofingersTimeout:null,ctrlZoomTimeout:null},this.step=new mt,this.keyHandler=new Zr,this.resizeObserver=new ResizeObserver(Fh(()=>this.viewer.autoSize(),50)),this.moveThreshold=Eh*Pt.pixelRatio}init(){window.addEventListener("keydown",this,{passive:!1}),window.addEventListener("keyup",this),this.viewer.container.addEventListener("mousedown",this),window.addEventListener("mousemove",this,{passive:!1}),window.addEventListener("mouseup",this),this.viewer.container.addEventListener("touchstart",this,{passive:!1}),window.addEventListener("touchmove",this,{passive:!1}),window.addEventListener("touchend",this,{passive:!1}),this.viewer.container.addEventListener("wheel",this,{passive:!1}),document.addEventListener("fullscreenchange",this),this.resizeObserver.observe(this.viewer.container),this.viewer.addEventListener(_s.type,this),this.viewer.addEventListener(Ts.type,this)}destroy(){window.removeEventListener("keydown",this),window.removeEventListener("keyup",this),this.viewer.container.removeEventListener("mousedown",this),window.removeEventListener("mousemove",this),window.removeEventListener("mouseup",this),this.viewer.container.removeEventListener("touchstart",this),window.removeEventListener("touchmove",this),window.removeEventListener("touchend",this),this.viewer.container.removeEventListener("wheel",this),document.removeEventListener("fullscreenchange",this),this.resizeObserver.disconnect(),this.viewer.removeEventListener(_s.type,this),this.viewer.removeEventListener(Ts.type,this),clearTimeout(this.data.dblclickTimeout),clearTimeout(this.data.longtouchTimeout),clearTimeout(this.data.twofingersTimeout),clearTimeout(this.data.ctrlZoomTimeout),super.destroy()}handleEvent(i){switch(i.type){case"keydown":this.__onKeyDown(i);break;case"keyup":this.__onKeyUp();break;case"mousemove":this.__onMouseMove(i);break;case"mouseup":this.__onMouseUp(i);break;case"touchmove":this.__onTouchMove(i);break;case"touchend":this.__onTouchEnd(i);break;case"fullscreenchange":this.__onFullscreenChange();break;case _s.type:this.__applyMoveDelta();break;case Ts.type:this.__clearMoveDelta();break}if(!Ih(i,"."+Gs))switch(i.type){case"mousedown":this.__onMouseDown(i);break;case"touchstart":this.__onTouchStart(i);break;case"wheel":this.__onMouseWheel(i);break}}__onKeyDown(i){if(this.config.mousewheelCtrlKey&&(this.data.ctrlKeyDown=i.key===Et.Control,this.data.ctrlKeyDown&&(clearTimeout(this.data.ctrlZoomTimeout),this.viewer.overlay.hide(Mt.CTRL_ZOOM))),!!this.viewer.dispatchEvent(new qi(i.key,i))&&!(!this.state.keyboardEnabled||!this.config.keyboardActions||this.keyHandler.pending)){for(const[e,t]of Object.entries(this.config.keyboardActions))if(tl(i,e)){if(typeof t=="function")t(this.viewer,i);else{switch(t!=="ZOOM_IN"&&t!=="ZOOM_OUT"&&this.viewer.stopAll(),t){case"ROTATE_UP":this.viewer.dynamics.position.roll({pitch:!1});break;case"ROTATE_DOWN":this.viewer.dynamics.position.roll({pitch:!0});break;case"ROTATE_RIGHT":this.viewer.dynamics.position.roll({yaw:!1});break;case"ROTATE_LEFT":this.viewer.dynamics.position.roll({yaw:!0});break;case"ZOOM_IN":this.viewer.dynamics.zoom.roll(!1);break;case"ZOOM_OUT":this.viewer.dynamics.zoom.roll(!0);break}this.keyHandler.down(t)}i.preventDefault();return}}}__onKeyUp(){this.data.ctrlKeyDown=!1,this.state.keyboardEnabled&&this.keyHandler.up(i=>{i==="ZOOM_IN"||i==="ZOOM_OUT"?this.viewer.dynamics.zoom.stop():(this.viewer.dynamics.position.stop(),this.viewer.resetIdleTimer())})}__onMouseDown(i){this.step.add(mt.CLICK),this.data.startMouseX=i.clientX,this.data.startMouseY=i.clientY,this.config.mousemove&&i.preventDefault()}__onMouseUp(i){this.step.is(mt.CLICK,mt.MOVING)&&this.__stopMove(i.clientX,i.clientY,i,i.button===2)}__onMouseMove(i){this.config.mousemove&&this.step.is(mt.CLICK,mt.MOVING)&&(i.preventDefault(),this.__doMove(i.clientX,i.clientY)),this.__handleObjectsEvents(i)}__onTouchStart(i){i.touches.length===1?(this.step.add(mt.CLICK),this.data.startMouseX=i.touches[0].clientX,this.data.startMouseY=i.touches[0].clientY,this.data.longtouchTimeout||(this.data.longtouchTimeout=setTimeout(()=>{const e=i.touches[0];this.__stopMove(e.clientX,e.clientY,i,!0),this.data.longtouchTimeout=null},Mh))):i.touches.length===2&&(this.step.set(mt.IDLE),this.__cancelLongTouch(),this.config.mousemove&&(this.__cancelTwoFingersOverlay(),this.__startMoveZoom(i),i.preventDefault()))}__onTouchEnd(i){if(this.__cancelLongTouch(),this.step.is(mt.CLICK,mt.MOVING)){if(i.preventDefault(),this.__cancelTwoFingersOverlay(),i.touches.length===1)this.__stopMove(this.data.mouseX,this.data.mouseY);else if(i.touches.length===0){const e=i.changedTouches[0];this.__stopMove(e.clientX,e.clientY,i)}}}__onTouchMove(i){if(this.__cancelLongTouch(),!!this.config.mousemove)if(i.touches.length===1){if(this.config.touchmoveTwoFingers)this.step.is(mt.CLICK)&&!this.data.twofingersTimeout&&(this.data.twofingersTimeout=setTimeout(()=>{this.viewer.overlay.show({id:Mt.TWO_FINGERS,image:Xx,title:this.config.lang.twoFingers})},wh));else if(this.step.is(mt.CLICK,mt.MOVING)){i.preventDefault();const e=i.touches[0];this.__doMove(e.clientX,e.clientY)}}else this.__doMoveZoom(i),this.__cancelTwoFingersOverlay()}__cancelLongTouch(){this.data.longtouchTimeout&&(clearTimeout(this.data.longtouchTimeout),this.data.longtouchTimeout=null)}__cancelTwoFingersOverlay(){this.config.touchmoveTwoFingers&&(this.data.twofingersTimeout&&(clearTimeout(this.data.twofingersTimeout),this.data.twofingersTimeout=null),this.viewer.overlay.hide(Mt.TWO_FINGERS))}__onMouseWheel(i){if(!this.config.mousewheel||!i.deltaY)return;if(this.config.mousewheelCtrlKey&&!this.data.ctrlKeyDown){this.viewer.overlay.show({id:Mt.CTRL_ZOOM,image:Yx,title:this.config.lang.ctrlZoom}),clearTimeout(this.data.ctrlZoomTimeout),this.data.ctrlZoomTimeout=setTimeout(()=>this.viewer.overlay.hide(Mt.CTRL_ZOOM),Sh);return}i.preventDefault(),i.stopPropagation();const e=i.deltaY/Math.abs(i.deltaY)*5*this.config.zoomSpeed;e!==0&&this.viewer.dynamics.zoom.step(-e,5)}__onFullscreenChange(){const i=this.viewer.isFullscreenEnabled();this.config.keyboard==="fullscreen"&&(i?this.viewer.startKeyboardControl():this.viewer.stopKeyboardControl()),this.viewer.dispatchEvent(new xs(i))}__resetMove(){this.step.set(mt.IDLE),this.data.mouseX=0,this.data.mouseY=0,this.data.startMouseX=0,this.data.startMouseY=0}__startMoveZoom(i){this.viewer.stopAll(),this.__resetMove();const e=Aa(i);this.step.set(mt.MOVING),this.data.accumulatorFactor=this.config.moveInertia,{distance:this.data.pinchDist,center:{x:this.data.mouseX,y:this.data.mouseY}}=e}__stopMove(i,e,t,n=!1){this.step.is(mt.CLICK)&&!this.__moveThresholdReached(i,e)&&this.__doClick(i,e,t,n),this.config.moveInertia&&(this.data.accumulatorFactor=Math.pow(this.config.moveInertia,.5)),this.__resetMove(),this.viewer.resetIdleTimer()}__doClick(i,e,t,n=!1){const s=this.viewer.container.getBoundingClientRect(),r=i-s.left,o=e-s.top,a=this.viewer.renderer.getIntersections({x:r,y:o}),l=a.find(c=>c.object.userData[Ki]);if(l){const c=this.viewer.dataHelper.vector3ToSphericalCoords(l.point),d={rightclick:n,originalEvent:t,target:Ur(t),clientX:i,clientY:e,viewerX:r,viewerY:o,yaw:c.yaw,pitch:c.pitch,objects:a.map(u=>u.object).filter(u=>!u.userData[Ki])};try{const u=this.viewer.dataHelper.sphericalCoordsToTextureCoords(d);Object.assign(d,u)}catch{}this.data.dblclickTimeout?(Math.abs(this.data.dblclickData.clientX-d.clientX)<this.moveThreshold&&Math.abs(this.data.dblclickData.clientY-d.clientY)<this.moveThreshold&&this.viewer.dispatchEvent(new ud(this.data.dblclickData)),clearTimeout(this.data.dblclickTimeout),this.data.dblclickTimeout=null,this.data.dblclickData=null):(this.viewer.dispatchEvent(new ad(d)),this.data.dblclickData=qr(d),this.data.dblclickTimeout=setTimeout(()=>{this.data.dblclickTimeout=null,this.data.dblclickData=null},yh))}}__handleObjectsEvents(i){if(!zh(this.state.objectsObservers)&&i.composedPath().includes(this.viewer.container)){const e=Dh(this.viewer.container),t={x:i.clientX-e.x,y:i.clientY-e.y},n=this.viewer.renderer.getIntersections(t),s=(r,o,a)=>{this.viewer.dispatchEvent(new a(i,r,t,o))};for(const[r,o]of Object.entries(this.state.objectsObservers)){const a=n.find(l=>l.object.userData[r]);a?(o&&a.object!==o&&(s(o,r,Ia),this.state.objectsObservers[r]=null),o?s(a.object,r,xu):(this.state.objectsObservers[r]=a.object,s(a.object,r,pu))):o&&(s(o,r,Ia),this.state.objectsObservers[r]=null)}}}__doMove(i,e){if(this.step.is(mt.CLICK)&&this.__moveThresholdReached(i,e))this.viewer.stopAll(),this.__resetMove(),this.step.set(mt.MOVING),this.data.mouseX=i,this.data.mouseY=e,this.data.accumulatorFactor=this.config.moveInertia;else if(this.step.is(mt.MOVING)){const t=(i-this.data.mouseX)*Math.cos(this.state.roll)-(e-this.data.mouseY)*Math.sin(this.state.roll),n=(e-this.data.mouseY)*Math.cos(this.state.roll)+(i-this.data.mouseX)*Math.sin(this.state.roll),s={yaw:this.config.moveSpeed*(t/this.state.size.width)*Ve.degToRad(this.state.hFov),pitch:this.config.moveSpeed*(n/this.state.size.height)*Ve.degToRad(this.state.vFov)};this.data.moveDelta.yaw+=s.yaw,this.data.moveDelta.pitch+=s.pitch,this.data.mouseX=i,this.data.mouseY=e}}__moveThresholdReached(i,e){return Math.abs(i-this.data.startMouseX)>=this.moveThreshold||Math.abs(e-this.data.startMouseY)>=this.moveThreshold}__doMoveZoom(i){if(this.step.is(mt.MOVING)){i.preventDefault();const e=Aa(i);this.__doMove(e.center.x,e.center.y),this.data.moveDelta.zoom+=this.config.zoomSpeed*((e.distance-this.data.pinchDist)/Pt.pixelRatio),this.data.pinchDist=e.distance}}__applyMoveDelta(){if(Math.abs(this.data.moveDelta.yaw)>0||Math.abs(this.data.moveDelta.pitch)>0){const e=this.viewer.getPosition();this.viewer.rotate({yaw:e.yaw-this.data.moveDelta.yaw*(1-this.config.moveInertia),pitch:e.pitch+this.data.moveDelta.pitch*(1-this.config.moveInertia)}),this.data.moveDelta.yaw*=this.data.accumulatorFactor,this.data.moveDelta.pitch*=this.data.accumulatorFactor,Math.abs(this.data.moveDelta.yaw)<=.001&&(this.data.moveDelta.yaw=0),Math.abs(this.data.moveDelta.pitch)<=.001&&(this.data.moveDelta.pitch=0)}if(Math.abs(this.data.moveDelta.zoom)>0){const e=this.viewer.getZoomLevel();this.viewer.zoom(e+this.data.moveDelta.zoom*(1-this.config.moveInertia)),this.data.moveDelta.zoom*=this.config.moveInertia,Math.abs(this.data.moveDelta.zoom)<=.001&&(this.data.moveDelta.zoom=0)}}__clearMoveDelta(){this.data.moveDelta.yaw=0,this.data.moveDelta.pitch=0,this.data.moveDelta.zoom=0}};We.enabled=!1;var xr=new Ye,Tc=new tt,Ac=new ss,$x=class extends Ys{constructor(i){super(i),this.frustumNeedsUpdate=!0,this.renderer=new cx(this.config.rendererParameters),this.renderer.setPixelRatio(Pt.pixelRatio),this.renderer.outputColorSpace=yn,this.renderer.toneMapping=qc,this.renderer.domElement.className="psv-canvas",this.renderer.domElement.style.background=this.config.canvasBackground,this.scene=new Dr,this.camera=new Ht(50,16/9,.1,2*Mn),this.camera.matrixAutoUpdate=!1;const e=new Gt(new Vs(Mn).scale(-1,1,1),new zs({opacity:0,transparent:!0,depthTest:!1,depthWrite:!1}));e.userData={[Ki]:!0},this.scene.add(e),this.raycaster=new Tm,this.frustum=new Za,this.container=document.createElement("div"),this.container.className="psv-canvas-container",this.container.appendChild(this.renderer.domElement),this.viewer.container.appendChild(this.container),this.container.addEventListener("contextmenu",t=>t.preventDefault()),this.viewer.addEventListener(bs.type,this),this.viewer.addEventListener(Ti.type,this),this.viewer.addEventListener(ys.type,this),this.viewer.addEventListener(Ms.type,this),this.viewer.addEventListener(Nt.type,this),this.hide()}get panoramaPose(){return this.mesh.rotation}get sphereCorrection(){return this.meshContainer.rotation}init(){this.show(),this.renderer.setAnimationLoop(i=>this.__renderLoop(i))}destroy(){this.renderer.setAnimationLoop(null),this.cleanScene(this.scene),this.renderer.dispose(),this.viewer.container.removeChild(this.container),this.viewer.removeEventListener(bs.type,this),this.viewer.removeEventListener(Ti.type,this),this.viewer.removeEventListener(ys.type,this),this.viewer.removeEventListener(Ms.type,this),this.viewer.removeEventListener(Nt.type,this),super.destroy()}handleEvent(i){switch(i.type){case bs.type:this.__onSizeUpdated();break;case Ti.type:this.__onZoomUpdated();break;case ys.type:this.__onPositionUpdated();break;case Ms.type:this.__onPositionUpdated();break;case Nt.type:i.containsOptions("fisheye")&&this.__onPositionUpdated(),i.containsOptions("canvasBackground")&&(this.renderer.domElement.style.background=this.config.canvasBackground);break}}hide(){this.container.style.opacity="0"}show(){this.container.style.opacity="1"}setCustomRenderer(i){i?this.customRenderer=i(this.renderer):this.customRenderer=null,this.viewer.needsUpdate()}__onSizeUpdated(){this.renderer.setSize(this.state.size.width,this.state.size.height),this.camera.aspect=this.state.aspect,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onZoomUpdated(){this.camera.fov=this.state.vFov,this.camera.updateProjectionMatrix(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__onPositionUpdated(){this.camera.position.set(0,0,0),this.camera.lookAt(this.state.direction),this.config.fisheye&&this.camera.position.copy(this.state.direction).multiplyScalar(this.config.fisheye/2).negate(),this.camera.rotateZ(-this.state.roll),this.camera.updateMatrix(),this.camera.updateMatrixWorld(),this.viewer.needsUpdate(),this.frustumNeedsUpdate=!0}__renderLoop(i){const e=this.timestamp?i-this.timestamp:0;this.timestamp=i,this.viewer.dispatchEvent(new _s(i,e)),this.viewer.dynamics.update(e),(this.state.needsUpdate||this.state.continuousUpdateCount>0)&&(this.state.needsUpdate=!1,(this.customRenderer||this.renderer).render(this.scene,this.camera),this.viewer.dispatchEvent(new jd))}setTexture(i){this.meshContainer||(this.meshContainer=new gn,this.scene.add(this.meshContainer)),this.state.textureData&&this.viewer.adapter.disposeTexture(this.state.textureData),this.mesh&&(this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh)),this.mesh=this.viewer.adapter.createMesh(i.panoData),this.viewer.adapter.setTexture(this.mesh,i,!1),this.meshContainer.add(this.mesh),this.state.textureData=i,this.viewer.needsUpdate()}setPanoramaPose(i,e=this.mesh){const t=this.viewer.dataHelper.cleanPanoramaPose(i);e.rotation.set(t.tilt,t.pan,t.roll,"YXZ")}setSphereCorrection(i,e=this.meshContainer){const t=this.viewer.dataHelper.cleanSphereCorrection(i);e.rotation.set(t.tilt,t.pan,t.roll,"YXZ")}transition(i,e,t){const n=t.effect==="fade"||t.rotation,s=!yt(e.position),r=!yt(e.zoom),o=new al(s?this.viewer.dataHelper.cleanPosition(e.position):void 0,e.zoom);this.viewer.dispatchEvent(o);const a=new gn,l=this.viewer.adapter.createMesh(i.panoData);if(this.viewer.adapter.setTexture(l,i,!0),this.viewer.adapter.setTextureOpacity(l,0),this.setPanoramaPose(i.panoData,l),this.setSphereCorrection(e.sphereCorrection,a),s&&!t.rotation){const p=this.viewer.getPosition(),m=new N(0,1,0);a.rotateOnWorldAxis(m,o.position.yaw-p.yaw);const v=new N(0,1,0).cross(this.camera.getWorldDirection(new N)).normalize();a.rotateOnWorldAxis(v,o.position.pitch-p.pitch)}a.add(l),this.scene.add(a),this.renderer.setRenderTarget(new Zi),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null);const{duration:c,properties:d}=this.viewer.dataHelper.getAnimationProperties(t.speed,t.rotation?o.position:null,n?o.zoomLevel:null),u=new kr({properties:{...d,opacity:{start:0,end:1}},duration:c,easing:"inOutCubic",onTick:p=>{switch(t.effect){case"fade":this.viewer.adapter.setTextureOpacity(l,p.opacity);break;case"black":case"white":p.opacity<.5?this.renderer.toneMappingExposure=t.effect==="black"?Ve.mapLinear(p.opacity,0,.5,1,0):Ve.mapLinear(p.opacity,0,.5,1,5):(this.renderer.toneMappingExposure=t.effect==="black"?Ve.mapLinear(p.opacity,.5,1,0,1):Ve.mapLinear(p.opacity,.5,1,5,1),this.mesh.visible=!1,this.viewer.adapter.setTextureOpacity(l,1),r&&!n&&this.viewer.dynamics.zoom.setValue(o.zoomLevel));break}s&&t.rotation&&this.viewer.dynamics.position.setValue({yaw:p.yaw,pitch:p.pitch}),r&&n&&this.viewer.dynamics.zoom.setValue(p.zoom),this.viewer.needsUpdate()}});return u.then(p=>{a.remove(l),this.scene.remove(a),p?(this.viewer.adapter.disposeTexture(this.state.textureData),this.meshContainer.remove(this.mesh),this.viewer.adapter.disposeMesh(this.mesh),this.mesh=l,this.meshContainer.add(l),this.state.textureData=i,this.setPanoramaPose(i.panoData),this.setSphereCorrection(e.sphereCorrection),s&&!t.rotation&&this.viewer.rotate(e.position)):(this.viewer.adapter.disposeTexture(i),this.viewer.adapter.disposeMesh(l))}),u}getIntersections(i){var t;xr.x=2*i.x/this.state.size.width-1,xr.y=-2*i.y/this.state.size.height+1,this.raycaster.setFromCamera(xr,this.camera);const e=this.raycaster.intersectObjects(this.scene.children,!0).filter(n=>n.object.visible).filter(n=>n.object.isMesh&&!!n.object.userData);return(t=this.customRenderer)!=null&&t.getIntersections&&e.push(...this.customRenderer.getIntersections(this.raycaster,xr)),e}isObjectVisible(i){if(!i)return!1;if(this.frustumNeedsUpdate&&(Tc.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse),this.frustum.setFromProjectionMatrix(Tc),this.frustumNeedsUpdate=!1),i.isVector3)return this.frustum.containsPoint(i);if(i.isMesh&&i.geometry){const e=i;return e.geometry.boundingBox||e.geometry.computeBoundingBox(),Ac.copy(e.geometry.boundingBox).applyMatrix4(e.matrixWorld),this.frustum.intersectsBox(Ac)}else return i.isObject3D?this.frustum.intersectsObject(i):!1}addObject(i){this.scene.add(i)}removeObject(i){this.scene.remove(i)}cleanScene(i){const e=t=>{var n;(n=t.map)==null||n.dispose(),t.uniforms&&Object.values(t.uniforms).forEach(s=>{var r,o;(o=(r=s.value)==null?void 0:r.dispose)==null||o.call(r)}),t.dispose()};i.traverse(t=>{var n,s;(n=t.geometry)==null||n.dispose(),t.material&&(Array.isArray(t.material)?t.material.forEach(r=>{e(r)}):e(t.material)),t instanceof Dr||(s=t.dispose)==null||s.call(t),t!==i&&this.cleanScene(t)})}},jx=class extends wm{constructor(){super(...arguments),this._abortController=new AbortController}abort(){return this._abortController.abort(),this._abortController=new AbortController,this}load(i,e,t,n){const s=this._abortController.signal,r=super.load(i,l=>{a(),e(l)},t,l=>{if(a(),s.aborted){const c=new Error;c.name="AbortError",c.message="The operation was aborted.",n(c)}else n(l)});function o(){r.src=""}function a(){s.removeEventListener("abort",o,!1)}return s.addEventListener("abort",o,!1),r}},Zx=class extends Ys{constructor(i){super(i),this.fileLoader=new Mm,this.fileLoader.setResponseType("blob"),this.imageLoader=new jx}destroy(){this.abortLoading(),super.destroy()}abortLoading(){var i,e;(e=(i=this.fileLoader).abort)==null||e.call(i),this.imageLoader.abort()}loadFile(i,e,t){const n=Gn.get(i,t);if(n){if(n instanceof Blob)return e==null||e(100),Promise.resolve(n);Gn.remove(i,t)}this.config.requestHeaders&&this.fileLoader.setRequestHeader(this.config.requestHeaders(i)),this.fileLoader.setWithCredentials(this.config.withCredentials(i));let s=0;return e==null||e(s),this.fileLoader.loadAsync(i,r=>{if(r.lengthComputable){const o=r.loaded/r.total*100;o>s&&(s=o,e==null||e(s))}}).then(r=>(s=100,e==null||e(s),Gn.add(i,t,r),r))}loadImage(i,e,t){const n=Gn.get(i,t);return n?(e==null||e(100),n instanceof Blob?this.blobToImage(n):Promise.resolve(n)):!e&&!this.config.requestHeaders?(this.imageLoader.setWithCredentials(this.config.withCredentials(i)),this.imageLoader.loadAsync(i).then(s=>(Gn.add(i,t,s),s))):this.loadFile(i,e,t).then(s=>this.blobToImage(s))}blobToImage(i){return new Promise((e,t)=>{const n=document.createElement("img");n.onload=()=>{URL.revokeObjectURL(n.src),e(n)},n.onerror=t,n.src=URL.createObjectURL(i)})}preloadPanorama(i){return this.viewer.adapter.supportsPreload(i)?this.viewer.adapter.loadTexture(i,!1):Promise.reject(new he("Current adapter does not support preload"))}dispatchProgress(i){this.viewer.loader.setProgress(i),this.viewer.dispatchEvent(new Rd(Math.round(i)))}},Kx=class extends Ys{constructor(i){super(i),this.zoom=new ps(e=>{this.viewer.state.vFov=this.viewer.dataHelper.zoomLevelToFov(e),this.viewer.state.hFov=this.viewer.dataHelper.vFovToHFov(this.viewer.state.vFov),this.viewer.dispatchEvent(new Ti(e))},{defaultValue:this.viewer.config.defaultZoomLvl,min:0,max:100,wrap:!1}),this.position=new $h(e=>{this.viewer.dataHelper.sphericalCoordsToVector3(e,this.viewer.state.direction),this.viewer.dispatchEvent(new ys(e))},{yaw:new ps(null,{defaultValue:this.config.defaultYaw,min:0,max:2*Math.PI,wrap:!0}),pitch:new ps(null,{defaultValue:this.config.defaultPitch,min:-Math.PI/2,max:Math.PI/2,wrap:!1})}),this.roll=new ps(e=>{this.viewer.state.roll=e,this.viewer.dispatchEvent(new Ms(e))},{defaultValue:0,min:-Math.PI,max:Math.PI,wrap:!1}),this.updateSpeeds()}updateSpeeds(){this.zoom.setSpeed(this.config.zoomSpeed*50),this.position.setSpeed(Ve.degToRad(this.config.moveSpeed*50)),this.roll.setSpeed(Ve.degToRad(this.config.moveSpeed*50))}update(i){this.zoom.update(i),this.position.update(i),this.roll.update(i)}},Jx=class{constructor(){this.ready=!1,this.needsUpdate=!1,this.continuousUpdateCount=0,this.keyboardEnabled=!1,this.direction=new N(0,0,Mn),this.roll=0,this.vFov=60,this.hFov=60,this.aspect=1,this.animation=null,this.transitionAnimation=null,this.loadingPromise=null,this.idleTime=-1,this.objectsObservers={},this.size={width:0,height:0}}},Qx=class extends Kh{constructor(i){var e,t,n;if(super(),this.plugins={},this.children=[],this.parent=Lh(i.container),!this.parent)throw new he('"container" element not found.');this.parent[Ki]=this,this.container=document.createElement("div"),this.container.classList.add("psv-container"),this.parent.appendChild(this.container),Yh(this.parent),Xh(this.container,"core"),this.state=new Jx,this.config=Nx(i),this.__setSize(this.config.size),this.overlay=new zx(this);try{Pt.load()}catch(s){console.error(s),this.showError(this.config.lang.webglError);return}Gn.init(),this.adapter=new this.config.adapter[0](this,this.config.adapter[1]),this.renderer=new $x(this),this.textureLoader=new Zx(this),this.eventsHandler=new qx(this),this.dataHelper=new Wx(this),this.dynamics=new Kx(this),(t=(e=this.adapter).init)==null||t.call(e),this.loader=new Fx(this),this.navbar=new Ox(this),this.panel=new Hx(this),this.notification=new kx(this),this.autoSize(),this.setCursor(null),nl(Pt.isTouchEnabled,s=>{Yr(this.container,"psv--is-touch",s)}),this.config.plugins.forEach(([s,r])=>{this.plugins[s.id]=new s(this,r)});for(const s of Object.values(this.plugins))(n=s.init)==null||n.call(s);this.config.navbar&&this.navbar.setButtons(this.config.navbar),this.state.loadingPromise||(this.config.panorama?this.setPanorama(this.config.panorama,{sphereCorrection:this.config.sphereCorrection,panoData:this.config.panoData}):this.loader.show())}destroy(){var i,e,t,n,s,r;this.stopAll(),this.stopKeyboardControl(),this.exitFullscreen();for(const[o,a]of Object.entries(this.plugins))a.destroy(),delete this.plugins[o];this.children.slice().forEach(o=>o.destroy()),this.children.length=0,(i=this.eventsHandler)==null||i.destroy(),(e=this.renderer)==null||e.destroy(),(t=this.textureLoader)==null||t.destroy(),(n=this.dataHelper)==null||n.destroy(),(s=this.adapter)==null||s.destroy(),(r=this.dynamics)==null||r.destroy(),this.parent.removeChild(this.container),delete this.parent[Ki]}init(){this.eventsHandler.init(),this.renderer.init(),this.config.navbar&&this.navbar.show(),this.config.keyboard==="always"&&this.startKeyboardControl(),this.resetIdleTimer(),this.state.ready=!0,this.dispatchEvent(new ws)}resetIdleTimer(){this.state.idleTime=performance.now()}disableIdleTimer(){this.state.idleTime=-1}getPlugin(i){if(typeof i=="string")return this.plugins[i];{const e=Da(i);return e?this.plugins[e.id]:null}}getPosition(){return this.dataHelper.cleanPosition(this.dynamics.position.current)}getZoomLevel(){return this.dynamics.zoom.current}getSize(){return{...this.state.size}}isFullscreenEnabled(){return Uh(this.parent,Pt.isIphone)}needsUpdate(){this.state.needsUpdate=!0}needsContinuousUpdate(i){i?this.state.continuousUpdateCount++:this.state.continuousUpdateCount>0&&this.state.continuousUpdateCount--}autoSize(){(this.container.clientWidth!==this.state.size.width||this.container.clientHeight!==this.state.size.height)&&(this.state.size.width=Math.round(this.container.clientWidth),this.state.size.height=Math.round(this.container.clientHeight),this.state.aspect=this.state.size.width/this.state.size.height,this.state.hFov=this.dataHelper.vFovToHFov(this.state.vFov),this.dispatchEvent(new bs(this.getSize())),this.navbar.autoSize())}setPanorama(i,e={}){var r;this.textureLoader.abortLoading(),(r=this.state.transitionAnimation)==null||r.cancel();const t=this.dataHelper.getTransitionOptions(e);e.showLoader===void 0&&(e.showLoader=!0),e.caption===void 0&&(e.caption=this.config.caption),e.description===void 0&&(e.description=this.config.description),!e.panoData&&typeof this.config.panoData=="function"&&(e.panoData=this.config.panoData),this.hideError(),this.resetIdleTimer(),this.config.panorama=i,this.config.caption=e.caption,this.config.description=e.description,this.config.sphereCorrection=e.sphereCorrection,(typeof this.config.panoData!="function"||typeof e.panoData=="function")&&(this.config.panoData=e.panoData);const n=o=>{if(Vh(o))return!1;if(this.loader.hide(),this.state.loadingPromise=null,o)throw this.navbar.setCaption(null),this.showError(this.config.lang.loadError),console.error(o),this.dispatchEvent(new Fd(i,o)),o;return this.navbar.setCaption(this.config.caption),!0};this.navbar.setCaption(`<em>${this.config.lang.loading}</em>`),(e.showLoader||!this.state.ready)&&this.loader.show(),this.dispatchEvent(new Id(i));const s=this.adapter.loadTexture(this.config.panorama,!0,e.panoData).then(o=>{if(o.panorama!==this.config.panorama)throw this.adapter.disposeTexture(o),Ca();const a=this.dataHelper.cleanPanoramaOptions(e,o.panoData);return(!yt(a.zoom)||!yt(a.position))&&this.stopAll(),{textureData:o,cleanOptions:a}});return!t||!this.state.ready||!this.adapter.supportsTransition(this.config.panorama)?this.state.loadingPromise=s.then(({textureData:o,cleanOptions:a})=>{this.renderer.show(),this.renderer.setTexture(o),this.renderer.setPanoramaPose(o.panoData),this.renderer.setSphereCorrection(e.sphereCorrection),this.state.ready||this.init(),this.dispatchEvent(new Zn(o)),yt(a.zoom)||this.zoom(a.zoom),yt(a.position)||this.rotate(a.position)}).then(()=>n(),o=>n(o)):this.state.loadingPromise=s.then(({textureData:o,cleanOptions:a})=>(this.loader.hide(),this.dispatchEvent(new Zn(o)),this.state.transitionAnimation=this.renderer.transition(o,a,t),this.state.transitionAnimation)).then(o=>{if(this.state.transitionAnimation=null,this.dispatchEvent(new Bd(o)),!o)throw Ca()}).then(()=>n(),o=>n(o)),this.state.loadingPromise}setOptions(i){const e={...this.config,...i};for(let[t,n]of Object.entries(i)){if(!(t in Pi)){wt(`Unknown option ${t}`);continue}if(t in bc){wt(bc[t]);continue}switch(t in Ua&&(n=Ua[t](n,{rawConfig:e,defValue:Pi[t]})),this.config[t]=n,t){case"mousemove":this.state.cursorOverride||this.setCursor(null);break;case"caption":this.navbar.setCaption(this.config.caption);break;case"size":this.resize(this.config.size);break;case"sphereCorrection":this.renderer.setSphereCorrection(this.config.sphereCorrection);break;case"navbar":case"lang":this.navbar.setButtons(this.config.navbar);break;case"moveSpeed":case"zoomSpeed":this.dynamics.updateSpeeds();break;case"minFov":case"maxFov":this.dynamics.zoom.setValue(this.dataHelper.fovToZoomLevel(this.state.vFov)),this.dispatchEvent(new Ti(this.getZoomLevel()));break;case"keyboard":this.config.keyboard==="always"?this.startKeyboardControl():this.stopKeyboardControl();break}}this.needsUpdate(),this.dispatchEvent(new Nt(Object.keys(i)))}setOption(i,e){this.setOptions({[i]:e})}showError(i){this.overlay.show({id:Mt.ERROR,image:Gx,title:i,dismissible:!1})}hideError(){this.overlay.hide(Mt.ERROR)}rotate(i){const e=new sd(this.dataHelper.cleanPosition(i));this.dispatchEvent(e),!e.defaultPrevented&&this.dynamics.position.setValue(e.position)}zoom(i){this.dynamics.zoom.setValue(i)}zoomIn(i=1){this.dynamics.zoom.step(i)}zoomOut(i=1){this.dynamics.zoom.step(-i)}animate(i){const e=sl(i),t=!yt(i.zoom),n=new al(e?this.dataHelper.cleanPosition(i):void 0,i.zoom);if(this.dispatchEvent(n),n.defaultPrevented)return;this.stopAll();const{duration:s,properties:r}=this.dataHelper.getAnimationProperties(i.speed,n.position,n.zoomLevel);return s?(this.state.animation=new kr({properties:r,duration:s,easing:i.easing||"inOutSine",onTick:o=>{e&&this.dynamics.position.setValue({yaw:o.yaw,pitch:o.pitch}),t&&this.dynamics.zoom.setValue(o.zoom)}}),this.state.animation.then(()=>{this.state.animation=null,this.resetIdleTimer()}),this.state.animation):(e&&this.rotate(n.position),t&&this.zoom(n.zoomLevel),new kr(null))}stopAnimation(){return this.state.animation?(this.state.animation.cancel(),this.state.animation):Promise.resolve()}resize(i){this.__setSize(i),this.autoSize()}__setSize(i){["width","height"].forEach(e=>{i!=null&&i[e]&&(/^[0-9.]+$/.test(i[e])&&(i[e]+="px"),this.parent.style[e]=i[e])})}enterFullscreen(){this.isFullscreenEnabled()||Nh(this.parent,Pt.isIphone)}exitFullscreen(){this.isFullscreenEnabled()&&Oh(Pt.isIphone)}toggleFullscreen(){this.isFullscreenEnabled()?this.exitFullscreen():this.enterFullscreen()}startKeyboardControl(){this.state.keyboardEnabled=!0}stopKeyboardControl(){this.state.keyboardEnabled=!1}createTooltip(i){return new Vx(this,i)}setCursor(i){this.state.cursorOverride=i,i?this.container.style.cursor=i:this.container.style.cursor=this.config.mousemove?"move":"default"}observeObjects(i){this.state.objectsObservers[i]||(this.state.objectsObservers[i]=null)}unobserveObjects(i){delete this.state.objectsObservers[i]}stopAll(){return this.dispatchEvent(new Ts),this.disableIdleTimer(),this.stopAnimation()}};/*!
 * Photo Sphere Viewer / Virtual Tour Plugin 5.14.0
 * @copyright 2015-2025 Damien "Mistic" Sorel
 * @licence MIT (https://opensource.org/licenses/MIT)
 */var eE=Object.defineProperty,tE=(i,e)=>{for(var t in e)eE(i,t,{get:e[t],enumerable:!0})},iE={};tE(iE,{EnterArrowEvent:()=>Bu,LeaveArrowEvent:()=>Gu,NodeChangedEvent:()=>Fu});var Nu=class Ou extends Ws{constructor(e,t){super(Ou.type),this.node=e,this.data=t}};Nu.type="node-changed";var Fu=Nu,ku=class zu extends Ws{constructor(e,t){super(zu.type),this.link=e,this.node=t}};ku.type="enter-arrow";var Bu=ku,Hu=class Vu extends Ws{constructor(e,t){super(Vu.type),this.link=e,this.node=t}};Hu.type="leave-arrow";var Gu=Hu,nE=class extends At{constructor(i=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=i,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new Ye(.5,.5),this.addEventListener("removed",function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(i,e){return super.copy(i,e),this.element=i.element.cloneNode(!0),this.center=i.center,this}},Bn=new N,Cc=new tt,Rc=new tt,Lc=new N,Pc=new N,sE=class{constructor(i={}){const e=this;let t,n,s,r;const o={objects:new WeakMap},a=i.element!==void 0?i.element:document.createElement("div");a.style.overflow="hidden",this.domElement=a,this.getSize=function(){return{width:t,height:n}},this.render=function(m,v){m.matrixWorldAutoUpdate===!0&&m.updateMatrixWorld(),v.parent===null&&v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),Cc.copy(v.matrixWorldInverse),Rc.multiplyMatrices(v.projectionMatrix,Cc),c(m,m,v),p(m)},this.setSize=function(m,v){t=m,n=v,s=t/2,r=n/2,a.style.width=m+"px",a.style.height=v+"px"};function l(m){m.isCSS2DObject&&(m.element.style.display="none");for(let v=0,_=m.children.length;v<_;v++)l(m.children[v])}function c(m,v,_){if(m.visible===!1){l(m);return}if(m.isCSS2DObject){Bn.setFromMatrixPosition(m.matrixWorld),Bn.applyMatrix4(Rc);const f=Bn.z>=-1&&Bn.z<=1&&m.layers.test(_.layers)===!0,h=m.element;h.style.display=f===!0?"":"none",f===!0&&(m.onBeforeRender(e,v,_),h.style.transform="translate("+-100*m.center.x+"%,"+-100*m.center.y+"%)translate("+(Bn.x*s+s)+"px,"+(-Bn.y*r+r)+"px)",h.parentNode!==a&&a.appendChild(h),m.onAfterRender(e,v,_));const b={distanceToCameraSquared:d(_,m)};o.objects.set(m,b)}for(let f=0,h=m.children.length;f<h;f++)c(m.children[f],v,_)}function d(m,v){return Lc.setFromMatrixPosition(m.matrixWorld),Pc.setFromMatrixPosition(v.matrixWorld),Lc.distanceToSquared(Pc)}function u(m){const v=[];return m.traverseVisible(function(_){_.isCSS2DObject&&v.push(_)}),v}function p(m){const v=u(m).sort(function(f,h){if(f.renderOrder!==h.renderOrder)return h.renderOrder-f.renderOrder;const b=o.objects.get(f).distanceToCameraSquared,S=o.objects.get(h).distanceToCameraSquared;return b-S}),_=v.length;for(let f=0,h=v.length;f<h;f++)v[f].element.style.zIndex=_-f}}},Ic=new N,rE=new Ji,Dc=new N,oE=class extends At{constructor(e=document.createElement("div")){super(),this.isCSS3DObject=!0,this.element=e,this.element.style.position="absolute",this.element.style.pointerEvents="auto",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.addEventListener("removed",function(){this.traverse(function(t){t.element instanceof t.element.ownerDocument.defaultView.Element&&t.element.parentNode!==null&&t.element.remove()})})}copy(e,t){return super.copy(e,t),this.element=e.element.cloneNode(!0),this}},oi=new tt,aE=new tt,lE=class{constructor(e={}){const t=this;let n,s,r,o;const a={camera:{style:""},objects:new WeakMap},l=e.element!==void 0?e.element:document.createElement("div");l.style.overflow="hidden",this.domElement=l;const c=document.createElement("div");c.style.transformOrigin="0 0",c.style.pointerEvents="none",l.appendChild(c);const d=document.createElement("div");d.style.transformStyle="preserve-3d",c.appendChild(d),this.getSize=function(){return{width:n,height:s}},this.render=function(f,h){const b=h.projectionMatrix.elements[5]*o;h.view&&h.view.enabled?(c.style.transform=`translate( ${-h.view.offsetX*(n/h.view.width)}px, ${-h.view.offsetY*(s/h.view.height)}px )`,c.style.transform+=`scale( ${h.view.fullWidth/h.view.width}, ${h.view.fullHeight/h.view.height} )`):c.style.transform="",f.matrixWorldAutoUpdate===!0&&f.updateMatrixWorld(),h.parent===null&&h.matrixWorldAutoUpdate===!0&&h.updateMatrixWorld();let S,E;h.isOrthographicCamera&&(S=-(h.right+h.left)/2,E=(h.top+h.bottom)/2);const C=h.view&&h.view.enabled?h.view.height/h.view.fullHeight:1,R=h.isOrthographicCamera?`scale( ${C} )scale(`+b+")translate("+u(S)+"px,"+u(E)+"px)"+p(h.matrixWorldInverse):`scale( ${C} )translateZ(`+b+"px)"+p(h.matrixWorldInverse),U=(h.isPerspectiveCamera?"perspective("+b+"px) ":"")+R+"translate("+r+"px,"+o+"px)";a.camera.style!==U&&(d.style.transform=U,a.camera.style=U),_(f,f,h)},this.setSize=function(f,h){n=f,s=h,r=n/2,o=s/2,l.style.width=f+"px",l.style.height=h+"px",c.style.width=f+"px",c.style.height=h+"px",d.style.width=f+"px",d.style.height=h+"px"};function u(f){return Math.abs(f)<1e-10?0:f}function p(f){const h=f.elements;return"matrix3d("+u(h[0])+","+u(-h[1])+","+u(h[2])+","+u(h[3])+","+u(h[4])+","+u(-h[5])+","+u(h[6])+","+u(h[7])+","+u(h[8])+","+u(-h[9])+","+u(h[10])+","+u(h[11])+","+u(h[12])+","+u(-h[13])+","+u(h[14])+","+u(h[15])+")"}function m(f){const h=f.elements;return"translate(-50%,-50%)"+("matrix3d("+u(h[0])+","+u(h[1])+","+u(h[2])+","+u(h[3])+","+u(-h[4])+","+u(-h[5])+","+u(-h[6])+","+u(-h[7])+","+u(h[8])+","+u(h[9])+","+u(h[10])+","+u(h[11])+","+u(h[12])+","+u(h[13])+","+u(h[14])+","+u(h[15])+")")}function v(f){f.isCSS3DObject&&(f.element.style.display="none");for(let h=0,b=f.children.length;h<b;h++)v(f.children[h])}function _(f,h,b,S){if(f.visible===!1){v(f);return}if(f.isCSS3DObject){const E=f.layers.test(b.layers)===!0,C=f.element;if(C.style.display=E===!0?"":"none",E===!0){f.onBeforeRender(t,h,b);let R;f.isCSS3DSprite?(oi.copy(b.matrixWorldInverse),oi.transpose(),f.rotation2D!==0&&oi.multiply(aE.makeRotationZ(f.rotation2D)),f.matrixWorld.decompose(Ic,rE,Dc),oi.setPosition(Ic),oi.scale(Dc),oi.elements[3]=0,oi.elements[7]=0,oi.elements[11]=0,oi.elements[15]=1,R=m(oi)):R=m(f.matrixWorld);const L=a.objects.get(f);if(L===void 0||L.style!==R){C.style.transform=R;const U={style:R};a.objects.set(f,U)}C.parentNode!==d&&d.appendChild(C),f.onAfterRender(t,h,b)}}for(let E=0,C=f.children.length;E<C;E++)_(f.children[E],h,b)}}},cE=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
...
`,LE=class extends Li{get map(){return this.uniforms.map.value}set map(i){this.uniforms.map.value=i}set alpha(i){this.uniforms.alpha.value=i}get offset(){return this.uniforms.offset.value}get repeat(){return this.uniforms.repeat.value}set chromaKey(i){this.uniforms.keying.value=(i==null?void 0:i.enabled)===!0,i!=null&&i.enabled&&(typeof i.color=="object"&&"r"in i.color?this.uniforms.color.value.set(i.color.r/255,i.color.g/255,i.color.b/255):this.uniforms.color.value.set(i.color??65280),this.uniforms.similarity.value=i.similarity??.2,this.uniforms.smoothness.value=i.smoothness??.2)}constructor(i){super({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:{map:{value:i==null?void 0:i.map},repeat:{value:new Ye(1,1)},offset:{value:new Ye(0,0)},alpha:{value:(i==null?void 0:i.alpha)??1},keying:{value:!1},color:{value:new Ze(65280)},similarity:{value:.2},smoothness:{value:.2},spill:{value:.1}},vertexShader:RE,fragmentShader:CE}),this.chromaKey=i==null?void 0:i.chromaKey}};function PE({src:i,withCredentials:e,muted:t,autoplay:n}){const s=document.createElement("video");return s.crossOrigin=e?"use-credentials":"anonymous",s.loop=!0,s.playsInline=!0,s.autoplay=n,s.muted=t,s.preload="metadata",i instanceof MediaStream?s.srcObject=i:s.src=i,s}function IE(i,e,t){const[n,s]=i,[r,o]=e,a=ue.greatArcDistance(i,e),l=Math.sin((1-t)*a)/Math.sin(a),c=Math.sin(t*a)/Math.sin(a),d=l*Math.cos(s)*Math.cos(n)+c*Math.cos(o)*Math.cos(r),u=l*Math.cos(s)*Math.sin(n)+c*Math.cos(o)*Math.sin(r),p=l*Math.sin(s)+c*Math.sin(o);return[Math.atan2(u,d),Math.atan2(p,Math.sqrt(d*d+u*u))]}function DE(i){const e=[i[0]];let t=0;for(let n=1;n<i.length;n++){const s=i[n-1][0]-i[n][0];s>Math.PI?t+=1:s<-Math.PI&&(t-=1),e.push([i[n][0]+t*2*Math.PI,i[n][1]])}return e}function Tf(i){return i.reduce((e,t)=>e.add(t),new N).normalize()}function UE(i){const e=DE(i);let t=0;const n=[];for(let r=0;r<e.length-1;r++){const o=ue.greatArcDistance(e[r],e[r+1])*Ns.SPHERE_RADIUS;n.push(o),t+=o}let s=0;for(let r=0;r<e.length-1;r++){if(s+n[r]>t/2){const o=(t/2-s)/n[r];return IE(e[r],e[r+1],o)}s+=n[r]}return e[Math.round(e.length/2)]}var Er=new N,kc=new N,Oo=new N,zc=new N,Bc=new N,Hc=new N;function NE(i,e,t){Er.copy(t).normalize(),kc.crossVectors(i,e).normalize(),Oo.crossVectors(kc,i).normalize(),zc.copy(i).multiplyScalar(-Er.dot(Oo)),Bc.copy(Oo).multiplyScalar(Er.dot(i));const n=new N().addVectors(zc,Bc).normalize();return Hc.crossVectors(n,Er),n.applyAxisAngle(Hc,.01).multiplyScalar(Ns.SPHERE_RADIUS)}var OE=class extends bf{get threeElement(){return this.element}get threeMesh(){return this.threeElement.children[0]}get video(){return this.type==="videoLayer"?this.threeMesh.material.map.image:null}constructor(i,e,t){super(i,e,t)}is3d(){return!0}createElement(){const i=new LE({alpha:0}),e=new Hs(1,1),t=new Gt(e,i);t.userData={[at]:this},Object.defineProperty(t,"visible",{enumerable:!0,get:function(){return this.userData[at].config.visible},set:function(n){this.userData[at].config.visible=n}}),this.element=new gn().add(t),this.type==="videoLayer"&&this.viewer.needsContinuousUpdate(!0)}destroy(){delete this.threeMesh.userData[at],this.type==="videoLayer"&&(this.video.pause(),this.viewer.needsContinuousUpdate(!1)),super.destroy()}render(){return this.viewer.renderer.isObjectVisible(this.threeMesh)?this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position):null}update(i){var s,r,o;super.update(i);const e=this.threeMesh,t=e.parent,n=e.material;if(ue.isExtendedPosition(this.config.position)){try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(l){throw new he(`invalid marker ${this.id} position`,l)}if(!this.config.size)throw new he(`missing marker ${this.id} size`);this.state.size=this.config.size,e.scale.set(this.config.size.width/100,this.config.size.height/100,1),e.position.set(e.scale.x*(.5-this.state.anchor.x),e.scale.y*(this.state.anchor.y-.5),0),e.rotation.set(0,0,0),this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position,t.position),t.lookAt(0,t.position.y,0),e.rotateY(-this.config.rotation.yaw),e.rotateX(-this.config.rotation.pitch),e.rotateZ(-this.config.rotation.roll);const a=e.geometry.getAttribute("position");this.state.positions3D=[0,1,3,2].map(l=>{const c=new N;return c.fromBufferAttribute(a,l),e.localToWorld(c)})}else{if(((s=this.config.position)==null?void 0:s.length)!==4)throw new he(`missing marker ${this.id} position`);let a;try{a=this.config.position.map(u=>this.viewer.dataHelper.cleanPosition(u))}catch(u){throw new he(`invalid marker ${this.id} position`,u)}const l=a.map(u=>this.viewer.dataHelper.sphericalCoordsToVector3(u)),c=Tf(l);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(c),this.state.positions3D=l;const d=e.geometry.getAttribute("position");[l[0],l[1],l[3],l[2]].forEach((u,p)=>{d.setX(p,u.x),d.setY(p,u.y),d.setZ(p,u.z)}),d.needsUpdate=!0,this.__setTextureWrap(n)}switch(this.type){case"videoLayer":if(this.definition!==this.config.videoLayer){(r=n.map)==null||r.dispose();const a=PE({src:this.config.videoLayer,withCredentials:this.viewer.config.withCredentials(this.config.videoLayer),muted:!0,autoplay:this.config.autoplay??!0}),l=new gm(a);n.map=l,n.alpha=0,a.addEventListener("loadedmetadata",()=>{this.viewer&&(n.alpha=this.config.opacity,ue.isExtendedPosition(this.config.position)||(e.material.userData[at]={width:a.videoWidth,height:a.videoHeight},this.__setTextureWrap(n)))},{once:!0}),a.autoplay&&a.play(),this.definition=this.config.videoLayer}else n.alpha=this.config.opacity;break;case"imageLayer":if(this.definition!==this.config.imageLayer){(o=n.map)==null||o.dispose();const a=new St;n.map=a,n.alpha=0,this.viewer.textureLoader.loadImage(this.config.imageLayer).then(l=>{this.viewer&&(ue.isExtendedPosition(this.config.position)||(e.material.userData[at]={width:l.width,height:l.height},this.__setTextureWrap(n)),a.image=l,a.anisotropy=4,a.needsUpdate=!0,n.alpha=this.config.opacity,this.viewer.needsUpdate())}),this.definition=this.config.imageLayer}else n.alpha=this.config.opacity;break}n.chromaKey=this.config.chromaKey,e.renderOrder=1e3+this.config.zIndex,e.geometry.boundingBox=null}__setTextureWrap(i){const e=i.userData[at];if(!e||!e.height||!e.width){i.repeat.set(1,1),i.offset.set(0,0);return}const t=this.config.position.map(u=>this.viewer.dataHelper.cleanPosition(u)),n=ue.greatArcDistance([t[0].yaw,t[0].pitch],[t[1].yaw,t[1].pitch]),s=ue.greatArcDistance([t[3].yaw,t[3].pitch],[t[2].yaw,t[2].pitch]),r=ue.greatArcDistance([t[1].yaw,t[1].pitch],[t[2].yaw,t[2].pitch]),o=ue.greatArcDistance([t[0].yaw,t[0].pitch],[t[3].yaw,t[3].pitch]),a=(n+s)/(r+o),l=e.width/e.height;let c=0,d=0;a<l?c=l-a:d=1/l-1/a,i.repeat.set(1-c,1-d),i.offset.set(c/2,d/2)}},FE=class extends pl{constructor(i,e,t){super(i,e,t),this.viewportIntersection=!1}get threeElement(){return this.object}isCss3d(){return!0}createElement(){this.element=document.createElement("div"),this.object=new SE(this.element),this.object.userData={[at]:this},Object.defineProperty(this.object,"visible",{enumerable:!0,get:function(){return this.userData[at].config.visible},set:function(i){this.userData[at].config.visible=i}}),this.afterCreateElement()}destroy(){delete this.object.userData[at],delete this.object,super.destroy()}render({viewerPosition:i,zoomLevel:e}){var s,r;const t=this.domElement;if(this.state.size={width:t.offsetWidth,height:t.offsetHeight},this.state.positions3D[0].dot(this.viewer.state.direction)>0&&this.viewportIntersection){const o=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position);return(r=(s=this.config.elementLayer).updateMarker)==null||r.call(s,{marker:this,position:o,viewerPosition:i,zoomLevel:e,viewerSize:this.viewer.state.size}),o}else return null}update(i){if(super.update(i),!ue.isExtendedPosition(this.config.position))throw new he(`missing marker ${this.id} position`);try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(n){throw new he(`invalid marker ${this.id} position`,n)}this.state.positions3D=[this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position)];const e=this.threeElement,t=this.domElement;t.classList.add("psv-marker--css3d"),t.childNodes.forEach(n=>n.remove()),t.appendChild(this.config.elementLayer),this.config.elementLayer.style.display="block",e.position.copy(this.state.positions3D[0]).multiplyScalar(100),e.lookAt(0,this.state.positions3D[0].y*100,0),e.rotateY(-this.config.rotation.yaw),e.rotateX(-this.config.rotation.pitch),e.rotateZ(-this.config.rotation.roll)}},kE=class extends Vr{constructor(i,e,t){super(i,e,t)}isNormal(){return!0}createElement(){this.element=document.createElement("div"),this.afterCreateElement()}render(i){var t,n;const e=super.render(i);return e&&this.type==="element"&&((n=(t=this.config.element).updateMarker)==null||n.call(t,{marker:this,position:e,viewerPosition:i.viewerPosition,zoomLevel:i.zoomLevel,viewerSize:this.viewer.state.size})),e}update(i){super.update(i);const e=this.domElement;if(this.config.image&&!this.config.size)throw new he(`missing marker ${this.id} size`);switch(this.config.size?(this.needsUpdateSize=!1,this.state.size=this.config.size,e.style.width=this.config.size.width+"px",e.style.height=this.config.size.height+"px"):this.needsUpdateSize=!0,this.type){case"image":this.definition=this.config.image,e.style.backgroundImage=`url("${this.config.image}")`;break;case"html":this.definition=this.config.html,e.innerHTML=this.config.html;break;case"element":this.definition!==this.config.element&&(this.definition=this.config.element,e.childNodes.forEach(t=>t.remove()),e.appendChild(this.config.element),this.config.element.style.display="block");break}}},zE=class extends pl{constructor(i,e,t){super(i,e,t)}createElement(){this.element=document.createElementNS(Hr,"path"),this.element[at]=this}isPoly(){return!0}get isPixels(){return this.type==="polygonPixels"||this.type==="polylinePixels"}get isPolygon(){return this.type==="polygon"||this.type==="polygonPixels"}get isPolyline(){return this.type==="polyline"||this.type==="polylinePixels"}get coords(){return this.definition}render(){const i=this.__getAllPolyPositions();if(i[0].length>(this.isPolygon?2:1)){const t=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position),n=i.filter(s=>s.length>0).map(s=>{let r="M";return r+=s.map(o=>`${o.x-t.x},${o.y-t.y}`).join("L"),this.isPolygon&&(r+="Z"),r}).join(" ");return this.domElement.setAttributeNS(null,"d",n),this.domElement.setAttributeNS(null,"transform",`translate(${t.x} ${t.y})`),t}else return null}update(i){super.update(i);const e=this.domElement;e.classList.add("psv-marker--poly"),this.config.svgStyle?(Object.entries(this.config.svgStyle).forEach(([t,n])=>{e.setAttributeNS(null,ue.dasherize(t),n)}),this.isPolyline&&!this.config.svgStyle.fill&&e.setAttributeNS(null,"fill","none")):this.isPolygon?e.setAttributeNS(null,"fill","rgba(0,0,0,0.5)"):this.isPolyline&&(e.setAttributeNS(null,"fill","none"),e.setAttributeNS(null,"stroke","rgb(0,0,0)"));try{let t=this.config[this.type];if(!Array.isArray(t[0])&&typeof t[0]!="object")for(let n=0;n<t.length;n++)t.splice(n,2,[t[n],t[n+1]]);if(!Array.isArray(t[0][0])&&typeof t[0][0]!="object"&&(t=[t]),this.isPolyline&&t.length>1)throw new he("polylines cannot have holes");this.isPixels?this.definition=t.map(n=>n.map(s=>{let r;return ue.isExtendedPosition(s)?r=this.viewer.dataHelper.cleanPosition(s):r=this.viewer.dataHelper.textureCoordsToSphericalCoords({textureX:s[0],textureY:s[1]}),[r.yaw,r.pitch]})):this.definition=t.map(n=>n.map(s=>{let r;return ue.isExtendedPosition(s)?r=this.viewer.dataHelper.cleanPosition(s):r=this.viewer.dataHelper.cleanPosition({yaw:s[0],pitch:s[1]}),[r.yaw,r.pitch]}))}catch(t){throw new he(`invalid marker ${this.id} position`,t)}if(this.positions3D=this.coords.map(t=>t.map(n=>this.viewer.dataHelper.sphericalCoordsToVector3({yaw:n[0],pitch:n[1]}))),this.isPolygon){const t=Tf(this.positions3D[0]);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(t)}else{const t=UE(this.coords[0]);this.state.position={yaw:t[0],pitch:t[1]}}this.state.positions3D=this.positions3D[0]}__getAllPolyPositions(){return this.positions3D.map(i=>this.__getPolyPositions(i))}__getPolyPositions(i){const e=i.length,t=i.map(s=>({vector:s,visible:s.dot(this.viewer.state.direction)>0})),n=[];return t.forEach((s,r)=>{s.visible||[r===0?t[e-1]:t[r-1],r===e-1?t[0]:t[r+1]].forEach(a=>{a.visible&&n.push({visible:a.vector,invisible:s.vector,index:r})})}),n.reverse().forEach(s=>{t.splice(s.index,0,{vector:NE(s.visible,s.invisible,this.viewer.state.direction),visible:!0})}),t.filter(s=>s.visible).map(s=>this.viewer.dataHelper.vector3ToViewerCoords(s.vector))}},BE=class extends Vr{get svgElement(){return this.domElement.firstElementChild}constructor(i,e,t){super(i,e,t)}isSvg(){return!0}createElement(){const i=this.type==="square"?"rect":this.type,e=document.createElementNS(Hr,i);this.element=document.createElementNS(Hr,"svg"),this.element.appendChild(e),this.afterCreateElement()}update(i){super.update(i);const e=this.svgElement;switch(this.needsUpdateSize=!0,this.type){case"square":this.definition={x:0,y:0,width:this.config.square,height:this.config.square};break;case"rect":Array.isArray(this.config.rect)?this.definition={x:0,y:0,width:this.config.rect[0],height:this.config.rect[1]}:this.definition={x:0,y:0,width:this.config.rect.width,height:this.config.rect.height};break;case"circle":this.definition={cx:this.config.circle,cy:this.config.circle,r:this.config.circle};break;case"ellipse":Array.isArray(this.config.ellipse)?this.definition={cx:this.config.ellipse[0],cy:this.config.ellipse[1],rx:this.config.ellipse[0],ry:this.config.ellipse[1]}:this.definition={cx:this.config.ellipse.rx,cy:this.config.ellipse.ry,rx:this.config.ellipse.rx,ry:this.config.ellipse.ry};break;case"path":this.definition={d:this.config.path};break}Object.entries(this.definition).forEach(([t,n])=>{e.setAttributeNS(null,t,n)}),this.config.svgStyle?Object.entries(this.config.svgStyle).forEach(([t,n])=>{e.setAttributeNS(null,ue.dasherize(t),n)}):e.setAttributeNS(null,"fill","rgba(0,0,0,0.5)")}},HE=ue.getConfigParser({clickEventOnMarker:!1,gotoMarkerSpeed:"8rpm",markers:null,defaultHoverScale:null},{defaultHoverScale(i){return i?(i===!0&&(i=Fa),typeof i=="number"&&(i={amount:i}),{...Fa,...i}):null}});function VE(i){switch(ka(i,!1)){case"image":case"html":case"element":return kE;case"imageLayer":case"videoLayer":return OE;case"elementLayer":return FE;case"polygon":case"polyline":case"polygonPixels":case"polylinePixels":return zE;case"square":case"rect":case"circle":case"ellipse":case"path":return BE;default:throw new he("invalid marker type")}}var $s=class Af extends dl{constructor(e,t){super(e,t),this.markers={},this.state={allVisible:!0,showAllTooltips:!1,currentMarker:null,hoveringMarker:null,needsReRender:!1,lastClientX:null,lastClientY:null},this.container=document.createElement("div"),this.container.className="psv-markers",this.viewer.container.appendChild(this.container),this.container.addEventListener("contextmenu",n=>n.preventDefault()),this.svgContainer=document.createElementNS(Hr,"svg"),this.svgContainer.setAttribute("class","psv-markers-svg-container"),this.container.appendChild(this.svgContainer),this.css3DContainer=new AE(e),this.container.appendChild(this.css3DContainer.element),this.container.addEventListener("mouseenter",this,!0),this.container.addEventListener("mouseleave",this,!0),this.container.addEventListener("mousemove",this,!0)}static withConfig(e){return[Af,e]}init(){super.init(),ue.checkStylesheet(this.viewer.container,"markers-plugin"),this.viewer.addEventListener(ye.ClickEvent.type,this),this.viewer.addEventListener(ye.DoubleClickEvent.type,this),this.viewer.addEventListener(ye.RenderEvent.type,this),this.viewer.addEventListener(ye.ConfigChangedEvent.type,this),this.viewer.addEventListener(ye.ObjectEnterEvent.type,this),this.viewer.addEventListener(ye.ObjectHoverEvent.type,this),this.viewer.addEventListener(ye.ObjectLeaveEvent.type,this),this.viewer.addEventListener(ye.ReadyEvent.type,this,{once:!0})}destroy(){this.clearMarkers(!1),this.viewer.unobserveObjects(at),this.viewer.removeEventListener(ye.ClickEvent.type,this),this.viewer.removeEventListener(ye.DoubleClickEvent.type,this),this.viewer.removeEventListener(ye.RenderEvent.type,this),this.viewer.removeEventListener(ye.ObjectEnterEvent.type,this),this.viewer.removeEventListener(ye.ObjectHoverEvent.type,this),this.viewer.removeEventListener(ye.ObjectLeaveEvent.type,this),this.viewer.removeEventListener(ye.ReadyEvent.type,this),this.css3DContainer.destroy(),this.viewer.container.removeChild(this.container),super.destroy()}handleEvent(e){var t;switch(e.type){case ye.ReadyEvent.type:this.config.markers&&(this.setMarkers(this.config.markers),delete this.config.markers);break;case ye.RenderEvent.type:this.renderMarkers();break;case ye.ClickEvent.type:this.__onClick(e,!1);break;case ye.DoubleClickEvent.type:this.__onClick(e,!0);break;case ye.ObjectEnterEvent.type:case ye.ObjectLeaveEvent.type:case ye.ObjectHoverEvent.type:if(e.userDataKey===at){const n=e.originalEvent,s=e.object.userData[at];switch(e.type){case ye.ObjectEnterEvent.type:(t=s.config.style)!=null&&t.cursor?this.viewer.setCursor(s.config.style.cursor):(s.config.tooltip||s.config.content)&&this.viewer.setCursor("pointer"),this.__onEnterMarker(n,s);break;case ye.ObjectLeaveEvent.type:this.viewer.setCursor(null),this.__onLeaveMarker(s);break;case ye.ObjectHoverEvent.type:this.__onHoverMarker(n,s);break}}break;case"mouseenter":{const n=this.__getTargetMarker(ue.getEventTarget(e));this.__onEnterMarker(e,n);break}case"mouseleave":{const n=this.__getTargetMarker(ue.getEventTarget(e));this.__onLeaveMarker(n);break}case"mousemove":{const n=this.__getTargetMarker(ue.getEventTarget(e),!0);this.__onHoverMarker(e,n);break}}}toggleAllMarkers(){this.state.allVisible?this.hideAllMarkers():this.showAllMarkers()}showAllMarkers(){this.state.allVisible=!0,Object.values(this.markers).forEach(e=>{e.config.visible=!0}),this.renderMarkers(),this.dispatchEvent(new Cs)}hideAllMarkers(){this.state.allVisible=!1,Object.values(this.markers).forEach(e=>{e.config.visible=!1}),this.renderMarkers(),this.dispatchEvent(new As)}toggleAllTooltips(){this.state.showAllTooltips?this.hideAllTooltips():this.showAllTooltips()}showAllTooltips(){this.state.showAllTooltips=!0,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!0,e.showTooltip()})}hideAllTooltips(){this.state.showAllTooltips=!1,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!1,e.hideTooltip()})}getNbMarkers(){return Object.keys(this.markers).length}getMarkers(){return Object.values(this.markers)}addMarker(e,t=!0){if(this.markers[e.id])throw new he(`marker "${e.id}" already exists`);const n=new(VE(e))(this.viewer,this,e);n.isPoly()?this.svgContainer.appendChild(n.domElement):n.isCss3d()?this.css3DContainer.addObject(n):n.is3d()?this.viewer.renderer.addObject(n.threeElement):this.container.appendChild(n.domElement),this.markers[n.id]=n,this.state.showAllTooltips&&(n.state.staticTooltip=!0),t&&this.__afterChangeMarkers()}getMarker(e){const t=typeof e=="object"?e.id:e;if(!this.markers[t])throw new he(`cannot find marker "${t}"`);return this.markers[t]}getCurrentMarker(){return this.state.currentMarker}updateMarker(e,t=!0){var s;const n=this.getMarker(e.id);n.update(e),t&&(this.__afterChangeMarkers(),(n===this.state.hoveringMarker&&((s=n.config.tooltip)==null?void 0:s.trigger)==="hover"||n.state.staticTooltip)&&n.showTooltip(this.state.lastClientX,this.state.lastClientY,!0))}removeMarker(e,t=!0){const n=this.getMarker(e);n.isPoly()?this.svgContainer.removeChild(n.domElement):n.isCss3d()?this.css3DContainer.removeObject(n):n.is3d()?this.viewer.renderer.removeObject(n.threeElement):this.container.removeChild(n.domElement),this.state.hoveringMarker===n&&(this.state.hoveringMarker=null),this.state.currentMarker===n&&(this.state.currentMarker=null),n.destroy(),delete this.markers[n.id],t&&this.__afterChangeMarkers()}removeMarkers(e,t=!0){e.forEach(n=>this.removeMarker(n,!1)),t&&this.__afterChangeMarkers()}setMarkers(e,t=!0){this.clearMarkers(!1),e==null||e.forEach(n=>{this.addMarker(n,!1)}),t&&this.__afterChangeMarkers()}clearMarkers(e=!0){Object.keys(this.markers).forEach(t=>{this.removeMarker(t,!1)}),e&&this.__afterChangeMarkers()}gotoMarker(e,t=this.config.gotoMarkerSpeed){const n=this.getMarker(e);return t?this.viewer.animate({...n.state.position,zoom:n.config.zoomLvl,speed:t}).then(()=>{this.dispatchEvent(new Oa(n))}):(this.viewer.rotate(n.state.position),ue.isNil(n.config.zoomLvl)||this.viewer.zoom(n.config.zoomLvl),this.dispatchEvent(new Oa(n)),Promise.resolve())}hideMarker(e){this.toggleMarker(e,!1)}showMarker(e){this.toggleMarker(e,!0)}showMarkerTooltip(e){const t=this.getMarker(e);t.state.staticTooltip=!0,t.showTooltip()}hideMarkerTooltip(e){const t=this.getMarker(e);t.state.staticTooltip=!1,t.hideTooltip()}toggleMarker(e,t){const n=this.getMarker(e);n.config.visible=ue.isNil(t)?!n.config.visible:t,this.renderMarkers()}showMarkerPanel(e){const t=this.getMarker(e);t.config.content?this.viewer.panel.show({id:us,content:t.config.content}):this.hideMarkerPanel()}hideMarkerPanel(){this.viewer.panel.hide(us)}toggleMarkersList(){this.viewer.panel.isVisible(Wn)?this.hideMarkersList():this.showMarkersList()}showMarkersList(){let e=[];Object.values(this.markers).forEach(n=>{n.config.visible&&!n.config.hideList&&e.push(n)});const t=new wf(e);this.dispatchEvent(t),e=t.markers,this.viewer.panel.show({id:Wn,content:ME(e,this.viewer.config.lang[Fs.id]),noMargin:!0,clickHandler:n=>{const s=ue.getClosest(n,".psv-panel-menu-item"),r=s?s.dataset[at]:void 0;if(r){const o=this.getMarker(r);this.dispatchEvent(new hf(o)),this.gotoMarker(o.id),this.hideMarkersList()}}})}hideMarkersList(){this.viewer.panel.hide(Wn)}renderMarkers(){if(this.state.needsReRender){this.state.needsReRender=!1;return}const e=this.viewer.getZoomLevel(),t=this.viewer.getPosition(),n=this.state.hoveringMarker;Object.values(this.markers).forEach(s=>{let r=s.config.visible,o=!1,a=null;r&&(a=s.render({viewerPosition:t,zoomLevel:e,hoveringMarker:n}),r=!!a),o=s.state.visible!==r,s.state.visible=r,s.state.position2D=a,s.domElement&&ue.toggleClass(s.domElement,"psv-marker--visible",r),r?s.state.staticTooltip?s.showTooltip():s!==this.state.hoveringMarker&&s.hideTooltip():s.hideTooltip(),o&&(this.dispatchEvent(new ju(s,r)),(s.is3d()||s.isCss3d())&&(this.state.needsReRender=!0))}),this.state.needsReRender&&this.viewer.needsUpdate()}__getTargetMarker(e,t=!1){if(e instanceof Node){const n=t?ue.getClosest(e,".psv-marker"):e;return n?n[at]:void 0}else return Array.isArray(e)?e.map(n=>n.userData[at]).filter(n=>!!n).sort((n,s)=>s.config.zIndex-n.config.zIndex)[0]:null}__onEnterMarker(e,t){var n;t&&(this.state.hoveringMarker=t,this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,this.dispatchEvent(new sf(t)),t instanceof Vr&&t.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!0}),!t.state.staticTooltip&&((n=t.config.tooltip)==null?void 0:n.trigger)==="hover"&&t.showTooltip(e.clientX,e.clientY))}__onLeaveMarker(e){var t;e&&(this.dispatchEvent(new ef(e)),e instanceof Vr&&e.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!1}),this.state.hoveringMarker=null,!e.state.staticTooltip&&((t=e.config.tooltip)==null?void 0:t.trigger)==="hover"?e.hideTooltip():e.state.staticTooltip&&e.showTooltip())}__onHoverMarker(e,t){var n;t&&(this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,(t.isPoly()||t.is3d()||t.isCss3d())&&((n=t.config.tooltip)==null?void 0:n.trigger)==="hover"&&t.showTooltip(e.clientX,e.clientY))}__onClick(e,t){var o,a;const n=this.__getTargetMarker(e.data.objects),r=this.__getTargetMarker(e.data.target,!0)||n;this.state.currentMarker&&this.state.currentMarker!==r&&(this.dispatchEvent(new ff(this.state.currentMarker)),this.viewer.panel.hide(us),!this.state.showAllTooltips&&((o=this.state.currentMarker.config.tooltip)==null?void 0:o.trigger)==="click"&&this.hideMarkerTooltip(this.state.currentMarker.id),this.state.currentMarker=null),r&&(this.state.currentMarker=r,this.dispatchEvent(new af(r,t,e.data.rightclick)),this.config.clickEventOnMarker?e.data.marker=r:e.stopImmediatePropagation(),this.markers[r.id]&&!e.data.rightclick&&(((a=r.config.tooltip)==null?void 0:a.trigger)==="click"?r.tooltip?this.hideMarkerTooltip(r.id):this.showMarkerTooltip(r.id):this.showMarkerPanel(r.id)))}__afterChangeMarkers(){this.__refreshUi(),this.__checkObjectsObserver(),this.viewer.needsUpdate(),this.dispatchEvent(new _f(this.getMarkers()))}__refreshUi(){var t,n;const e=Object.values(this.markers).filter(s=>!s.config.hideList).length;e===0?(this.viewer.panel.hide(us),this.viewer.panel.hide(Wn)):this.viewer.panel.isVisible(Wn)?this.showMarkersList():this.viewer.panel.isVisible(us)&&(this.state.currentMarker?this.showMarkerPanel(this.state.currentMarker.id):this.viewer.panel.hide()),(t=this.viewer.navbar.getButton(Fs.id,!1))==null||t.toggle(e>0),(n=this.viewer.navbar.getButton(eo.id,!1))==null||n.toggle(e>0)}__checkObjectsObserver(){Object.values(this.markers).some(t=>t.is3d())?this.viewer.observeObjects(at):this.viewer.unobserveObjects(at)}};$s.id="markers";$s.VERSION="5.14.0";$s.configParser=HE;$s.readonlyOptions=["markers"];var Cf=$s;Pi.lang[Fs.id]="Markers";Pi.lang[eo.id]="Markers list";ul(Fs,"caption:left");ul(eo,"caption:left");const ts=[{id:"vostochniy",name:"Карьер «Восточный»",icon:"courtyard",scenes:[{id:"vostochniy_zoom",panorama:"assets/rooms/vostochniy/vostochniy_zoom.jpg",name:"Карьер «Восточный»",defaultYaw:"2.7029rad",defaultPitch:"-0.1194rad",audio:"assets/audio/vostochniy.mp3",links:[{nodeId:"vostochniy_burovaya",position:{yaw:2.3397,pitch:-.5473}},{nodeId:"doroga-s-samosvalami",position:{yaw:2.1534,pitch:.0603}},{nodeId:"samosval",position:{yaw:3.0775,pitch:-.3529}},{nodeId:"zaboy",position:{yaw:3.4947,pitch:-.3371}}],markers:[{id:"info-1",data:{type:"info",image:"assets/info/vostochniy.png"},position:{yaw:2.878,pitch:.131}}]},{id:"vostochniy_burovaya",panorama:"/assets/rooms/vostochniy/vostochniy_burovaya.jpg",name:"Буровой участок",defaultYaw:"6.1245rad",defaultPitch:"-0.3951rad",audio:"/assets/audio/burovaya.mp3",links:[{nodeId:"samosval",position:{yaw:5.9877,pitch:-.0974}},{nodeId:"zaboy",position:{yaw:.1027,pitch:-.076}},{nodeId:"doroga-s-samosvalami",position:{yaw:4.5532,pitch:.2144}},{nodeId:"vostochniy_zoom",position:{yaw:2.2544,pitch:.3422}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/burovaya.png"},position:{yaw:6.1245,pitch:-.3951}}]},{id:"samosval",panorama:"/assets/rooms/vostochniy/samosval.jpg",name:"Карьерный автосамосвал",audio:"/assets/audio/samosval.mp3",defaultYaw:"6.2729rad",defaultPitch:"0.1892rad",links:[{nodeId:"zaboy",position:{yaw:1.6687,pitch:-.0341}},{nodeId:"vostochniy_burovaya",position:{yaw:3.6131,pitch:.0324}},{nodeId:"doroga-s-samosvalami",position:{yaw:4.3468,pitch:.1736}},{nodeId:"vostochniy_zoom",position:{yaw:2.9022,pitch:.3611}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/samosval.png"},position:{yaw:6.2729,pitch:.1892}}]},{id:"doroga-s-samosvalami",panorama:"/assets/rooms/vostochniy/doroga-s-samosvalami.jpg",name:"Подъёмный участок",defaultYaw:"6.2384rad",defaultPitch:"-0.1465rad",gallery:["/assets/photos/doroga-s-samosvalami/1.png","/assets/photos/doroga-s-samosvalami/2.png","/assets/photos/doroga-s-samosvalami/3.png"],links:[{nodeId:"vostochniy_zoom",position:{yaw:4.4692,pitch:-.0052}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/podjemniy.png"},position:{yaw:6.2384,pitch:-.1465}}]},{id:"zaboy",panorama:"/assets/rooms/vostochniy/zaboy.jpg",name:"Забой",audio:"/assets/audio/zaboy.mp3",defaultYaw:"0.2553rad",defaultPitch:"-0.4055rad",links:[{nodeId:"samosval",position:{yaw:3.273,pitch:-.2589}},{nodeId:"vostochniy_burovaya",position:{yaw:2.3852,pitch:-.0934}},{nodeId:"doroga-s-samosvalami",position:{yaw:3.0363,pitch:.1441}},{nodeId:"vostochniy_zoom",position:{yaw:1.6953,pitch:.1724}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zaboy.png"},position:{yaw:.2553,pitch:-.4055}}]}]},{id:"blagodatniy",name:"Карьер «Благодатный»",icon:"rooms",scenes:[{id:"blagodatniy-1",panorama:"/assets/rooms/blagodatniy/blagodatniy.jpg",name:"Карьер «Благодатный»",defaultYaw:"0.0330rad",defaultPitch:"-0.0111rad",links:[],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/blagodatniy.png"},position:{yaw:.033,pitch:-.0111}}]}]},{id:"centre",name:"Центр управления карьером",icon:"views",scenes:[{id:"centre-1",panorama:"/assets/rooms/centre/centre.jpg",name:"Главный пункт управления",defaultYaw:"0.3068rad",defaultPitch:"0.0753rad",links:[{nodeId:"op-1",position:{yaw:2.1322,pitch:.0368}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/centre.png"},position:{yaw:.3346,pitch:.2202}}]},{id:"op-1",panorama:"/assets/rooms/centre/op-1.jpg",name:"Операторская 1",defaultYaw:"0.0316rad",defaultPitch:"0.0735rad",links:[{nodeId:"op-2",position:{yaw:3.2376,pitch:.0241}},{nodeId:"op-3",position:{yaw:1.6011,pitch:.025}},{nodeId:"centre-1",position:{yaw:.9939,pitch:.0316}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-1.png"},position:{yaw:.0316,pitch:.0735}}]},{id:"op-2",panorama:"/assets/rooms/centre/op-2.jpg",name:"Операторская 2",defaultYaw:"4.5212rad",defaultPitch:"0.1023rad",links:[{nodeId:"op-1",position:{yaw:1.3224,pitch:-.1473}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-2.png"},position:{yaw:4.5212,pitch:.1023}}]},{id:"op-3",panorama:"/assets/rooms/centre/op-3.jpg",name:"Операторская 3",defaultYaw:"2.2494rad",defaultPitch:"0.1907rad",links:[{nodeId:"op-1",position:{yaw:4.6161,pitch:-.0616}},{nodeId:"op-2",position:{yaw:3.9988,pitch:-.0313}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-3.png"},position:{yaw:2.2494,pitch:.1907}}]}]},{id:"living-complex",name:"Вахтовый жилой комплекс",icon:"views",scenes:[{id:"poselok",panorama:"/assets/rooms/living-complex/poselok.jpg",name:"Поселок",gallery:["/assets/photos/poselok/poselok1.png","/assets/photos/poselok/poselok2.png","/assets/photos/poselok/poselok3.png"],audio:"/assets/audio/poselok.mp3",defaultYaw:"0.5631rad",defaultPitch:"-0.1106rad",links:[{nodeId:"ksk",position:{yaw:.0685,pitch:.0514}},{nodeId:"stolovaya-1",position:{yaw:.0051,pitch:-.5787}},{nodeId:"stolovaya-2",position:{yaw:.4315,pitch:-.1068}},{nodeId:"pamyatnik",position:{yaw:1.0536,pitch:-.051}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/poselok.png"},position:{yaw:.6311,pitch:-.412}}]},{id:"ksk",panorama:"/assets/rooms/living-complex/ksk.jpg",name:"Культурно спортивный комплекс",defaultYaw:"6.1887rad",defaultPitch:"-0.1754rad",links:[{nodeId:"sportzal",position:{yaw:5.9055,pitch:-.4681}},{nodeId:"poselok",position:{yaw:4.6868,pitch:.0283}}],markers:[]},{id:"sportzal",panorama:"/assets/rooms/living-complex/sportzal.jpg",name:"Спортзал",audio:"/assets/audio/ksk.mp3",defaultYaw:"6.2702rad",defaultPitch:"-0.3748rad",gallery:["/assets/photos/poselok/zal1.png","/assets/photos/poselok/zal2.png","/assets/photos/poselok/zal3.png"],links:[{nodeId:"ksk",position:{yaw:.6865,pitch:-.1667}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zal.png"},position:{yaw:6.2702,pitch:-.3748}}]},{id:"stolovaya-1",panorama:"/assets/rooms/living-complex/stolovaya-1.jpg",name:"Столовая 1",audio:"/assets/audio/stolovaya.mp3",defaultYaw:"6.1407rad",defaultPitch:"0.0856rad",gallery:["/assets/photos/poselok/stolovaya1.png","/assets/photos/poselok/stolovaya2.png","/assets/photos/poselok/stolovaya3.png"],links:[{nodeId:"poselok",position:{yaw:1.2802,pitch:.0496}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/stolovaya.png"},position:{yaw:6.1385,pitch:.113}}]},{id:"stolovaya-2",panorama:"/assets/rooms/living-complex/stolovaya-2.jpg",name:"Столовая 2",audio:"/assets/audio/stolovaya.mp3",defaultYaw:"5.8891rad",defaultPitch:"0.0966rad",gallery:["/assets/photos/poselok/stolovaya4.png","/assets/photos/poselok/stolovaya5.png","/assets/photos/poselok/stolovaya6.png"],links:[{nodeId:"poselok",position:{yaw:.6396,pitch:-.0234}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/stolovaya.png"},position:{yaw:5.8891,pitch:.0966}}]},{id:"pamyatnik",panorama:"/assets/rooms/living-complex/pamyatnik.jpg",name:"Памятник",defaultYaw:"0.0948rad",defaultPitch:"-0.1752rad",links:[{nodeId:"poselok",position:{yaw:1.5737,pitch:.1201}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/pamyatnik.png"},position:{yaw:.0948,pitch:-.1752}}]}]},{id:"zif",name:"Золотоизвлекательная фабрика",icon:"views",scenes:[{id:"zif-1",panorama:"/assets/rooms/zif/zif.jpg",name:"Отделение рудоподготовки",defaultYaw:"0.6650rad",defaultPitch:"-0.0185rad",gallery:["/assets/photos/zif/zif1.png","/assets/photos/zif/zif2.png","/assets/photos/zif/zif3.png"],links:[{nodeId:"bio",position:{yaw:.088,pitch:-.0273}},{nodeId:"plavilnoe",position:{yaw:1.1942,pitch:.04}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zif.png"},position:{yaw:.665,pitch:-.0185}}]},{id:"bio",panorama:"/assets/rooms/zif/bio.jpg",name:"Участок бактериального окисления",defaultYaw:"6.2023rad",defaultPitch:"-0.1498rad",gallery:["/assets/photos/zif/bio.png","/assets/photos/zif/bio1.png"],links:[{nodeId:"zif-1",position:{yaw:2.3397,pitch:-.5473}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/bio.png"},position:{yaw:6.2023,pitch:-.1498}}]},{id:"plavilnoe",panorama:"/assets/rooms/zif/plavilnoe.jpg",name:"Плавильное отделение",defaultYaw:"0.3497rad",defaultPitch:"-0.0144rad",gallery:["/assets/photos/zif/plavilniy1.png","/assets/photos/zif/plavilniy2.png","/assets/photos/zif/plavilniy3.png"],links:[{nodeId:"zif-1",position:{yaw:1.4957,pitch:.0752}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/plavilniy.png"},position:{yaw:.3497,pitch:-.0144}}]}]},{id:"service",name:"Сервисно-ремонтный комплекс",icon:"views",scenes:[{id:"service-1",panorama:"/assets/rooms/service/ps-ulica.jpg",name:"Питстоп",defaultYaw:"0.0390rad",defaultPitch:"0.0867rad",links:[{nodeId:"moyka-2",position:{yaw:.7219,pitch:.078}},{nodeId:"ps-2",position:{yaw:5.6155,pitch:.0762}},{nodeId:"angar-3",position:{yaw:3.4457,pitch:.0571}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/pitstop.png"},position:{yaw:5.84,pitch:.2618}}]},{id:"ps-2",panorama:"/assets/rooms/service/ps-2.jpg",name:"Станция оперативного обслуживания",gallery:["/assets/photos/pitstop/pitstop1.png","/assets/photos/pitstop/pitstop2.png"],defaultYaw:"0.5171rad",defaultPitch:"0.1980rad",links:[{nodeId:"ps-1",position:{yaw:1.284,pitch:.0456}},{nodeId:"ps-3",position:{yaw:.0423,pitch:.0271}},{nodeId:"service-1",position:{yaw:4.1903,pitch:-.0514}}],markers:[]},{id:"ps-1",panorama:"/assets/rooms/service/ps-1.jpg",name:"Вид сзади",defaultYaw:"0.0610rad",defaultPitch:"0.4295rad",links:[{nodeId:"ps-2",position:{yaw:5.2171,pitch:-.0759}}],markers:[]},{id:"ps-3",panorama:"/assets/rooms/service/ps-3.jpg",name:"Вид сбоку",defaultYaw:"0.0192rad",defaultPitch:"0.4810rad",links:[{nodeId:"ps-2",position:{yaw:1.0522,pitch:-.108}}],markers:[]},{id:"moyka-2",panorama:"/assets/rooms/service/moyka-2.jpg",name:"Моечно-обслуживающий комплекс",defaultYaw:"0.6304rad",defaultPitch:"0.1859rad",links:[{nodeId:"service-1",position:{yaw:1.3383,pitch:.1347}}],markers:[]},{id:"kabina",panorama:"/assets/rooms/service/kabina.jpg",name:"Кабина",defaultYaw:"5.7024rad",defaultPitch:"0.4925rad",links:[{nodeId:"angar-3",position:{yaw:6.1862,pitch:-.3136}}],markers:[]},{id:"angar-3",panorama:"/assets/rooms/service/angar-3.jpg",name:"Сервисный ангар",defaultYaw:"6.1375rad",defaultPitch:"0.4295rad",links:[{nodeId:"kabina",position:{yaw:5.7188,pitch:.4926}},{nodeId:"service-1",position:{yaw:2.1327,pitch:.1971}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/angar.png"},position:{yaw:6.1375,pitch:.4295}}]}]}],Fo=ts[0];Fo.scenes||Fo.variants&&Fo.variants[0].scenes;const GE=document.querySelector("#viewer"),tn=new Qx({container:GE,touchmoveTwoFingers:!0,mousewheelCtrlKey:!0,defaultYaw:"0deg",defaultZoomLvl:0,navbar:!1,mousewheel:!1,plugins:[[Yu,{positionMode:"manual",renderMode:"2d",arrowStyle:{element:i=>{var n;const e=document.createElement("div");e.className="transition-marker";const t=(n=window.__currentSceneConfigs)==null?void 0:n.find(s=>s.id===i.nodeId);return e.textContent=(t==null?void 0:t.name)||i.nodeId,e}},transitionOptions:i=>{const e=wn.find(t=>t.id===i.id);return e&&(e.defaultYaw||e.defaultPitch)?{rotateTo:{yaw:e.defaultYaw,pitch:e.defaultPitch},speed:"10rpm"}:{}}}],[Cf,{defaultHoverScale:!1}]]}),to=tn.getPlugin(Yu),WE=tn.getPlugin(Cf),vn=document.getElementById("info-panel"),Vc=document.getElementById("info-close");Vc&&vn&&Vc.addEventListener("click",()=>{vn.classList.add("hidden")});WE.addEventListener("select-marker",i=>{if(i.marker.id.startsWith("info-")&&vn){const e=vn.querySelector("#info-image");e&&(i.marker.data&&i.marker.data.image?e.src=i.marker.data.image:e.src=""),vn.classList.remove("hidden")}});window.addEventListener("message",()=>{});tn.addEventListener("ready",()=>{window.parent.postMessage({type:"tourLoaded"},"*")});tn.addEventListener("panorama-loaded",()=>{const i=document.querySelector("#loader-container");i&&i.classList.add("hidden")},{once:!0});tn.addEventListener("load-progress",i=>{const e=document.querySelector("#loader-percentage");e&&(e.textContent=`${i.progress}%`)});tn.addEventListener("panorama-error",i=>{console.error("Viewer Error:",i),alert("Viewer Error: "+(i.error.message||i.error))});tn.addEventListener("position-updated",()=>{});let wn=[];window.__currentSceneConfigs=wn;const ti=document.getElementById("btn-audio"),_n=document.getElementById("btn-video"),xn=document.getElementById("btn-gallery"),Hi=document.getElementById("scene-audio"),Ai=document.getElementById("video-modal"),Ci=document.getElementById("scene-video"),Gc=document.getElementById("video-close"),zi=document.getElementById("gallery-container");ti&&(ti.style.display="none");_n&&(_n.style.display="none");xn&&(xn.style.display="none");let Lr=!1;const XE=i=>{const e=wn.find(t=>t.id===i);Lr=!1,Hi&&(Hi.pause(),Hi.currentTime=0),ti&&ti.classList.remove("active"),Ai&&Ai.classList.add("hidden"),Ci&&(Ci.pause(),Ci.currentTime=0),zi&&zi.classList.add("hidden"),e&&(ti&&(e.audio?(ti.style.display="flex",Hi&&(Hi.src=e.audio)):ti.style.display="none"),_n&&(e.video?_n.style.display="flex":_n.style.display="none"),xn&&(e.gallery&&e.gallery.length>0?xn.style.display="flex":xn.style.display="none"))};to.addEventListener("node-changed",i=>{vn&&vn.classList.add("hidden"),XE(i.node.id)});ti&&Hi&&ti.addEventListener("click",()=>{Lr?(Hi.pause(),ti.classList.remove("active"),Lr=!1):(Hi.play().catch(i=>console.error("Audio play error",i)),ti.classList.add("active"),Lr=!0)});_n&&Ai&&Ci&&_n.addEventListener("click",()=>{const i=wn.find(e=>{var t;return e.id===((t=to.getCurrentNode())==null?void 0:t.id)});i&&i.video&&(Ci.src=i.video,Ai.classList.remove("hidden"),Ci.play().catch(e=>console.error("Video play error",e)))});const Rf=()=>{Ai&&Ci&&(Ai.classList.add("hidden"),Ci.pause(),Ci.currentTime=0)};Gc&&Gc.addEventListener("click",Rf);Ai&&Ai.addEventListener("click",i=>{i.target===Ai&&Rf()});xn&&zi&&xn.addEventListener("click",()=>{if(zi.classList.contains("hidden")){const e=wn.find(t=>{var n;return t.id===((n=to.getCurrentNode())==null?void 0:n.id)});e&&e.gallery&&(zi.innerHTML=e.gallery.map(t=>`
                ...
                `,size:{width:50,height:50},anchor:"center center"}:r)})),n)),Lf()}};Lf();const Wc=ts.find(i=>i.id===ml);Wc&&Pf(Wc.id);
