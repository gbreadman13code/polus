...
`,DE=class extends Li{get map(){return this.uniforms.map.value}set map(i){this.uniforms.map.value=i}set alpha(i){this.uniforms.alpha.value=i}get offset(){return this.uniforms.offset.value}get repeat(){return this.uniforms.repeat.value}set chromaKey(i){this.uniforms.keying.value=(i==null?void 0:i.enabled)===!0,i!=null&&i.enabled&&(typeof i.color=="object"&&"r"in i.color?this.uniforms.color.value.set(i.color.r/255,i.color.g/255,i.color.b/255):this.uniforms.color.value.set(i.color??65280),this.uniforms.similarity.value=i.similarity??.2,this.uniforms.smoothness.value=i.smoothness??.2)}constructor(i){super({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:{map:{value:i==null?void 0:i.map},repeat:{value:new Ye(1,1)},offset:{value:new Ye(0,0)},alpha:{value:(i==null?void 0:i.alpha)??1},keying:{value:!1},color:{value:new Ze(65280)},similarity:{value:.2},smoothness:{value:.2},spill:{value:.1}},vertexShader:IE,fragmentShader:PE}),this.chromaKey=i==null?void 0:i.chromaKey}};function UE({src:i,withCredentials:e,muted:t,autoplay:n}){const s=document.createElement("video");return s.crossOrigin=e?"use-credentials":"anonymous",s.loop=!0,s.playsInline=!0,s.autoplay=n,s.muted=t,s.preload="metadata",i instanceof MediaStream?s.srcObject=i:s.src=i,s}function NE(i,e,t){const[n,s]=i,[r,o]=e,a=ue.greatArcDistance(i,e),l=Math.sin((1-t)*a)/Math.sin(a),c=Math.sin(t*a)/Math.sin(a),d=l*Math.cos(s)*Math.cos(n)+c*Math.cos(o)*Math.cos(r),u=l*Math.cos(s)*Math.sin(n)+c*Math.cos(o)*Math.sin(r),p=l*Math.sin(s)+c*Math.sin(o);return[Math.atan2(u,d),Math.atan2(p,Math.sqrt(d*d+u*u))]}function OE(i){const e=[i[0]];let t=0;for(let n=1;n<i.length;n++){const s=i[n-1][0]-i[n][0];s>Math.PI?t+=1:s<-Math.PI&&(t-=1),e.push([i[n][0]+t*2*Math.PI,i[n][1]])}return e}function Af(i){return i.reduce((e,t)=>e.add(t),new N).normalize()}function FE(i){const e=OE(i);let t=0;const n=[];for(let r=0;r<e.length-1;r++){const o=ue.greatArcDistance(e[r],e[r+1])*Os.SPHERE_RADIUS;n.push(o),t+=o}let s=0;for(let r=0;r<e.length-1;r++){if(s+n[r]>t/2){const o=(t/2-s)/n[r];return NE(e[r],e[r+1],o)}s+=n[r]}return e[Math.round(e.length/2)]}var Mr=new N,zc=new N,ko=new N,Bc=new N,Hc=new N,Vc=new N;function kE(i,e,t){Mr.copy(t).normalize(),zc.crossVectors(i,e).normalize(),ko.crossVectors(zc,i).normalize(),Bc.copy(i).multiplyScalar(-Mr.dot(ko)),Hc.copy(ko).multiplyScalar(Mr.dot(i));const n=new N().addVectors(Bc,Hc).normalize();return Vc.crossVectors(n,Mr),n.applyAxisAngle(Vc,.01).multiplyScalar(Os.SPHERE_RADIUS)}var zE=class extends Tf{get threeElement(){return this.element}get threeMesh(){return this.threeElement.children[0]}get video(){return this.type==="videoLayer"?this.threeMesh.material.map.image:null}constructor(i,e,t){super(i,e,t)}is3d(){return!0}createElement(){const i=new DE({alpha:0}),e=new Vs(1,1),t=new Gt(e,i);t.userData={[at]:this},Object.defineProperty(t,"visible",{enumerable:!0,get:function(){return this.userData[at].config.visible},set:function(n){this.userData[at].config.visible=n}}),this.element=new vn().add(t),this.type==="videoLayer"&&this.viewer.needsContinuousUpdate(!0)}destroy(){delete this.threeMesh.userData[at],this.type==="videoLayer"&&(this.video.pause(),this.viewer.needsContinuousUpdate(!1)),super.destroy()}render(){return this.viewer.renderer.isObjectVisible(this.threeMesh)?this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position):null}update(i){var s,r,o;super.update(i);const e=this.threeMesh,t=e.parent,n=e.material;if(ue.isExtendedPosition(this.config.position)){try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(l){throw new he(`invalid marker ${this.id} position`,l)}if(!this.config.size)throw new he(`missing marker ${this.id} size`);this.state.size=this.config.size,e.scale.set(this.config.size.width/100,this.config.size.height/100,1),e.position.set(e.scale.x*(.5-this.state.anchor.x),e.scale.y*(this.state.anchor.y-.5),0),e.rotation.set(0,0,0),this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position,t.position),t.lookAt(0,t.position.y,0),e.rotateY(-this.config.rotation.yaw),e.rotateX(-this.config.rotation.pitch),e.rotateZ(-this.config.rotation.roll);const a=e.geometry.getAttribute("position");this.state.positions3D=[0,1,3,2].map(l=>{const c=new N;return c.fromBufferAttribute(a,l),e.localToWorld(c)})}else{if(((s=this.config.position)==null?void 0:s.length)!==4)throw new he(`missing marker ${this.id} position`);let a;try{a=this.config.position.map(u=>this.viewer.dataHelper.cleanPosition(u))}catch(u){throw new he(`invalid marker ${this.id} position`,u)}const l=a.map(u=>this.viewer.dataHelper.sphericalCoordsToVector3(u)),c=Af(l);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(c),this.state.positions3D=l;const d=e.geometry.getAttribute("position");[l[0],l[1],l[3],l[2]].forEach((u,p)=>{d.setX(p,u.x),d.setY(p,u.y),d.setZ(p,u.z)}),d.needsUpdate=!0,this.__setTextureWrap(n)}switch(this.type){case"videoLayer":if(this.definition!==this.config.videoLayer){(r=n.map)==null||r.dispose();const a=UE({src:this.config.videoLayer,withCredentials:this.viewer.config.withCredentials(this.config.videoLayer),muted:!0,autoplay:this.config.autoplay??!0}),l=new xm(a);n.map=l,n.alpha=0,a.addEventListener("loadedmetadata",()=>{this.viewer&&(n.alpha=this.config.opacity,ue.isExtendedPosition(this.config.position)||(e.material.userData[at]={width:a.videoWidth,height:a.videoHeight},this.__setTextureWrap(n)))},{once:!0}),a.autoplay&&a.play(),this.definition=this.config.videoLayer}else n.alpha=this.config.opacity;break;case"imageLayer":if(this.definition!==this.config.imageLayer){(o=n.map)==null||o.dispose();const a=new St;n.map=a,n.alpha=0,this.viewer.textureLoader.loadImage(this.config.imageLayer).then(l=>{this.viewer&&(ue.isExtendedPosition(this.config.position)||(e.material.userData[at]={width:l.width,height:l.height},this.__setTextureWrap(n)),a.image=l,a.anisotropy=4,a.needsUpdate=!0,n.alpha=this.config.opacity,this.viewer.needsUpdate())}),this.definition=this.config.imageLayer}else n.alpha=this.config.opacity;break}n.chromaKey=this.config.chromaKey,e.renderOrder=1e3+this.config.zIndex,e.geometry.boundingBox=null}__setTextureWrap(i){const e=i.userData[at];if(!e||!e.height||!e.width){i.repeat.set(1,1),i.offset.set(0,0);return}const t=this.config.position.map(u=>this.viewer.dataHelper.cleanPosition(u)),n=ue.greatArcDistance([t[0].yaw,t[0].pitch],[t[1].yaw,t[1].pitch]),s=ue.greatArcDistance([t[3].yaw,t[3].pitch],[t[2].yaw,t[2].pitch]),r=ue.greatArcDistance([t[1].yaw,t[1].pitch],[t[2].yaw,t[2].pitch]),o=ue.greatArcDistance([t[0].yaw,t[0].pitch],[t[3].yaw,t[3].pitch]),a=(n+s)/(r+o),l=e.width/e.height;let c=0,d=0;a<l?c=l-a:d=1/l-1/a,i.repeat.set(1-c,1-d),i.offset.set(c/2,d/2)}},BE=class extends gl{constructor(i,e,t){super(i,e,t),this.viewportIntersection=!1}get threeElement(){return this.object}isCss3d(){return!0}createElement(){this.element=document.createElement("div"),this.object=new AE(this.element),this.object.userData={[at]:this},Object.defineProperty(this.object,"visible",{enumerable:!0,get:function(){return this.userData[at].config.visible},set:function(i){this.userData[at].config.visible=i}}),this.afterCreateElement()}destroy(){delete this.object.userData[at],delete this.object,super.destroy()}render({viewerPosition:i,zoomLevel:e}){var s,r;const t=this.domElement;if(this.state.size={width:t.offsetWidth,height:t.offsetHeight},this.state.positions3D[0].dot(this.viewer.state.direction)>0&&this.viewportIntersection){const o=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position);return(r=(s=this.config.elementLayer).updateMarker)==null||r.call(s,{marker:this,position:o,viewerPosition:i,zoomLevel:e,viewerSize:this.viewer.state.size}),o}else return null}update(i){if(super.update(i),!ue.isExtendedPosition(this.config.position))throw new he(`missing marker ${this.id} position`);try{this.state.position=this.viewer.dataHelper.cleanPosition(this.config.position)}catch(n){throw new he(`invalid marker ${this.id} position`,n)}this.state.positions3D=[this.viewer.dataHelper.sphericalCoordsToVector3(this.state.position)];const e=this.threeElement,t=this.domElement;t.classList.add("psv-marker--css3d"),t.childNodes.forEach(n=>n.remove()),t.appendChild(this.config.elementLayer),this.config.elementLayer.style.display="block",e.position.copy(this.state.positions3D[0]).multiplyScalar(100),e.lookAt(0,this.state.positions3D[0].y*100,0),e.rotateY(-this.config.rotation.yaw),e.rotateX(-this.config.rotation.pitch),e.rotateZ(-this.config.rotation.roll)}},HE=class extends Wr{constructor(i,e,t){super(i,e,t)}isNormal(){return!0}createElement(){this.element=document.createElement("div"),this.afterCreateElement()}render(i){var t,n;const e=super.render(i);return e&&this.type==="element"&&((n=(t=this.config.element).updateMarker)==null||n.call(t,{marker:this,position:e,viewerPosition:i.viewerPosition,zoomLevel:i.zoomLevel,viewerSize:this.viewer.state.size})),e}update(i){super.update(i);const e=this.domElement;if(this.config.image&&!this.config.size)throw new he(`missing marker ${this.id} size`);switch(this.config.size?(this.needsUpdateSize=!1,this.state.size=this.config.size,e.style.width=this.config.size.width+"px",e.style.height=this.config.size.height+"px"):this.needsUpdateSize=!0,this.type){case"image":this.definition=this.config.image,e.style.backgroundImage=`url("${this.config.image}")`;break;case"html":this.definition=this.config.html,e.innerHTML=this.config.html;break;case"element":this.definition!==this.config.element&&(this.definition=this.config.element,e.childNodes.forEach(t=>t.remove()),e.appendChild(this.config.element),this.config.element.style.display="block");break}}},VE=class extends gl{constructor(i,e,t){super(i,e,t)}createElement(){this.element=document.createElementNS(Gr,"path"),this.element[at]=this}isPoly(){return!0}get isPixels(){return this.type==="polygonPixels"||this.type==="polylinePixels"}get isPolygon(){return this.type==="polygon"||this.type==="polygonPixels"}get isPolyline(){return this.type==="polyline"||this.type==="polylinePixels"}get coords(){return this.definition}render(){const i=this.__getAllPolyPositions();if(i[0].length>(this.isPolygon?2:1)){const t=this.viewer.dataHelper.sphericalCoordsToViewerCoords(this.state.position),n=i.filter(s=>s.length>0).map(s=>{let r="M";return r+=s.map(o=>`${o.x-t.x},${o.y-t.y}`).join("L"),this.isPolygon&&(r+="Z"),r}).join(" ");return this.domElement.setAttributeNS(null,"d",n),this.domElement.setAttributeNS(null,"transform",`translate(${t.x} ${t.y})`),t}else return null}update(i){super.update(i);const e=this.domElement;e.classList.add("psv-marker--poly"),this.config.svgStyle?(Object.entries(this.config.svgStyle).forEach(([t,n])=>{e.setAttributeNS(null,ue.dasherize(t),n)}),this.isPolyline&&!this.config.svgStyle.fill&&e.setAttributeNS(null,"fill","none")):this.isPolygon?e.setAttributeNS(null,"fill","rgba(0,0,0,0.5)"):this.isPolyline&&(e.setAttributeNS(null,"fill","none"),e.setAttributeNS(null,"stroke","rgb(0,0,0)"));try{let t=this.config[this.type];if(!Array.isArray(t[0])&&typeof t[0]!="object")for(let n=0;n<t.length;n++)t.splice(n,2,[t[n],t[n+1]]);if(!Array.isArray(t[0][0])&&typeof t[0][0]!="object"&&(t=[t]),this.isPolyline&&t.length>1)throw new he("polylines cannot have holes");this.isPixels?this.definition=t.map(n=>n.map(s=>{let r;return ue.isExtendedPosition(s)?r=this.viewer.dataHelper.cleanPosition(s):r=this.viewer.dataHelper.textureCoordsToSphericalCoords({textureX:s[0],textureY:s[1]}),[r.yaw,r.pitch]})):this.definition=t.map(n=>n.map(s=>{let r;return ue.isExtendedPosition(s)?r=this.viewer.dataHelper.cleanPosition(s):r=this.viewer.dataHelper.cleanPosition({yaw:s[0],pitch:s[1]}),[r.yaw,r.pitch]}))}catch(t){throw new he(`invalid marker ${this.id} position`,t)}if(this.positions3D=this.coords.map(t=>t.map(n=>this.viewer.dataHelper.sphericalCoordsToVector3({yaw:n[0],pitch:n[1]}))),this.isPolygon){const t=Af(this.positions3D[0]);this.state.position=this.viewer.dataHelper.vector3ToSphericalCoords(t)}else{const t=FE(this.coords[0]);this.state.position={yaw:t[0],pitch:t[1]}}this.state.positions3D=this.positions3D[0]}__getAllPolyPositions(){return this.positions3D.map(i=>this.__getPolyPositions(i))}__getPolyPositions(i){const e=i.length,t=i.map(s=>({vector:s,visible:s.dot(this.viewer.state.direction)>0})),n=[];return t.forEach((s,r)=>{s.visible||[r===0?t[e-1]:t[r-1],r===e-1?t[0]:t[r+1]].forEach(a=>{a.visible&&n.push({visible:a.vector,invisible:s.vector,index:r})})}),n.reverse().forEach(s=>{t.splice(s.index,0,{vector:kE(s.visible,s.invisible,this.viewer.state.direction),visible:!0})}),t.filter(s=>s.visible).map(s=>this.viewer.dataHelper.vector3ToViewerCoords(s.vector))}},GE=class extends Wr{get svgElement(){return this.domElement.firstElementChild}constructor(i,e,t){super(i,e,t)}isSvg(){return!0}createElement(){const i=this.type==="square"?"rect":this.type,e=document.createElementNS(Gr,i);this.element=document.createElementNS(Gr,"svg"),this.element.appendChild(e),this.afterCreateElement()}update(i){super.update(i);const e=this.svgElement;switch(this.needsUpdateSize=!0,this.type){case"square":this.definition={x:0,y:0,width:this.config.square,height:this.config.square};break;case"rect":Array.isArray(this.config.rect)?this.definition={x:0,y:0,width:this.config.rect[0],height:this.config.rect[1]}:this.definition={x:0,y:0,width:this.config.rect.width,height:this.config.rect.height};break;case"circle":this.definition={cx:this.config.circle,cy:this.config.circle,r:this.config.circle};break;case"ellipse":Array.isArray(this.config.ellipse)?this.definition={cx:this.config.ellipse[0],cy:this.config.ellipse[1],rx:this.config.ellipse[0],ry:this.config.ellipse[1]}:this.definition={cx:this.config.ellipse.rx,cy:this.config.ellipse.ry,rx:this.config.ellipse.rx,ry:this.config.ellipse.ry};break;case"path":this.definition={d:this.config.path};break}Object.entries(this.definition).forEach(([t,n])=>{e.setAttributeNS(null,t,n)}),this.config.svgStyle?Object.entries(this.config.svgStyle).forEach(([t,n])=>{e.setAttributeNS(null,ue.dasherize(t),n)}):e.setAttributeNS(null,"fill","rgba(0,0,0,0.5)")}},WE=ue.getConfigParser({clickEventOnMarker:!1,gotoMarkerSpeed:"8rpm",markers:null,defaultHoverScale:null},{defaultHoverScale(i){return i?(i===!0&&(i=za),typeof i=="number"&&(i={amount:i}),{...za,...i}):null}});function XE(i){switch(Ba(i,!1)){case"image":case"html":case"element":return HE;case"imageLayer":case"videoLayer":return zE;case"elementLayer":return BE;case"polygon":case"polyline":case"polygonPixels":case"polylinePixels":return VE;case"square":case"rect":case"circle":case"ellipse":case"path":return GE;default:throw new he("invalid marker type")}}var js=class Cf extends fl{constructor(e,t){super(e,t),this.markers={},this.state={allVisible:!0,showAllTooltips:!1,currentMarker:null,hoveringMarker:null,needsReRender:!1,lastClientX:null,lastClientY:null},this.container=document.createElement("div"),this.container.className="psv-markers",this.viewer.container.appendChild(this.container),this.container.addEventListener("contextmenu",n=>n.preventDefault()),this.svgContainer=document.createElementNS(Gr,"svg"),this.svgContainer.setAttribute("class","psv-markers-svg-container"),this.container.appendChild(this.svgContainer),this.css3DContainer=new LE(e),this.container.appendChild(this.css3DContainer.element),this.container.addEventListener("mouseenter",this,!0),this.container.addEventListener("mouseleave",this,!0),this.container.addEventListener("mousemove",this,!0)}static withConfig(e){return[Cf,e]}init(){super.init(),ue.checkStylesheet(this.viewer.container,"markers-plugin"),this.viewer.addEventListener(ye.ClickEvent.type,this),this.viewer.addEventListener(ye.DoubleClickEvent.type,this),this.viewer.addEventListener(ye.RenderEvent.type,this),this.viewer.addEventListener(ye.ConfigChangedEvent.type,this),this.viewer.addEventListener(ye.ObjectEnterEvent.type,this),this.viewer.addEventListener(ye.ObjectHoverEvent.type,this),this.viewer.addEventListener(ye.ObjectLeaveEvent.type,this),this.viewer.addEventListener(ye.ReadyEvent.type,this,{once:!0})}destroy(){this.clearMarkers(!1),this.viewer.unobserveObjects(at),this.viewer.removeEventListener(ye.ClickEvent.type,this),this.viewer.removeEventListener(ye.DoubleClickEvent.type,this),this.viewer.removeEventListener(ye.RenderEvent.type,this),this.viewer.removeEventListener(ye.ObjectEnterEvent.type,this),this.viewer.removeEventListener(ye.ObjectHoverEvent.type,this),this.viewer.removeEventListener(ye.ObjectLeaveEvent.type,this),this.viewer.removeEventListener(ye.ReadyEvent.type,this),this.css3DContainer.destroy(),this.viewer.container.removeChild(this.container),super.destroy()}handleEvent(e){var t;switch(e.type){case ye.ReadyEvent.type:this.config.markers&&(this.setMarkers(this.config.markers),delete this.config.markers);break;case ye.RenderEvent.type:this.renderMarkers();break;case ye.ClickEvent.type:this.__onClick(e,!1);break;case ye.DoubleClickEvent.type:this.__onClick(e,!0);break;case ye.ObjectEnterEvent.type:case ye.ObjectLeaveEvent.type:case ye.ObjectHoverEvent.type:if(e.userDataKey===at){const n=e.originalEvent,s=e.object.userData[at];switch(e.type){case ye.ObjectEnterEvent.type:(t=s.config.style)!=null&&t.cursor?this.viewer.setCursor(s.config.style.cursor):(s.config.tooltip||s.config.content)&&this.viewer.setCursor("pointer"),this.__onEnterMarker(n,s);break;case ye.ObjectLeaveEvent.type:this.viewer.setCursor(null),this.__onLeaveMarker(s);break;case ye.ObjectHoverEvent.type:this.__onHoverMarker(n,s);break}}break;case"mouseenter":{const n=this.__getTargetMarker(ue.getEventTarget(e));this.__onEnterMarker(e,n);break}case"mouseleave":{const n=this.__getTargetMarker(ue.getEventTarget(e));this.__onLeaveMarker(n);break}case"mousemove":{const n=this.__getTargetMarker(ue.getEventTarget(e),!0);this.__onHoverMarker(e,n);break}}}toggleAllMarkers(){this.state.allVisible?this.hideAllMarkers():this.showAllMarkers()}showAllMarkers(){this.state.allVisible=!0,Object.values(this.markers).forEach(e=>{e.config.visible=!0}),this.renderMarkers(),this.dispatchEvent(new Rs)}hideAllMarkers(){this.state.allVisible=!1,Object.values(this.markers).forEach(e=>{e.config.visible=!1}),this.renderMarkers(),this.dispatchEvent(new Cs)}toggleAllTooltips(){this.state.showAllTooltips?this.hideAllTooltips():this.showAllTooltips()}showAllTooltips(){this.state.showAllTooltips=!0,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!0,e.showTooltip()})}hideAllTooltips(){this.state.showAllTooltips=!1,Object.values(this.markers).forEach(e=>{e.state.staticTooltip=!1,e.hideTooltip()})}getNbMarkers(){return Object.keys(this.markers).length}getMarkers(){return Object.values(this.markers)}addMarker(e,t=!0){if(this.markers[e.id])throw new he(`marker "${e.id}" already exists`);const n=new(XE(e))(this.viewer,this,e);n.isPoly()?this.svgContainer.appendChild(n.domElement):n.isCss3d()?this.css3DContainer.addObject(n):n.is3d()?this.viewer.renderer.addObject(n.threeElement):this.container.appendChild(n.domElement),this.markers[n.id]=n,this.state.showAllTooltips&&(n.state.staticTooltip=!0),t&&this.__afterChangeMarkers()}getMarker(e){const t=typeof e=="object"?e.id:e;if(!this.markers[t])throw new he(`cannot find marker "${t}"`);return this.markers[t]}getCurrentMarker(){return this.state.currentMarker}updateMarker(e,t=!0){var s;const n=this.getMarker(e.id);n.update(e),t&&(this.__afterChangeMarkers(),(n===this.state.hoveringMarker&&((s=n.config.tooltip)==null?void 0:s.trigger)==="hover"||n.state.staticTooltip)&&n.showTooltip(this.state.lastClientX,this.state.lastClientY,!0))}removeMarker(e,t=!0){const n=this.getMarker(e);n.isPoly()?this.svgContainer.removeChild(n.domElement):n.isCss3d()?this.css3DContainer.removeObject(n):n.is3d()?this.viewer.renderer.removeObject(n.threeElement):this.container.removeChild(n.domElement),this.state.hoveringMarker===n&&(this.state.hoveringMarker=null),this.state.currentMarker===n&&(this.state.currentMarker=null),n.destroy(),delete this.markers[n.id],t&&this.__afterChangeMarkers()}removeMarkers(e,t=!0){e.forEach(n=>this.removeMarker(n,!1)),t&&this.__afterChangeMarkers()}setMarkers(e,t=!0){this.clearMarkers(!1),e==null||e.forEach(n=>{this.addMarker(n,!1)}),t&&this.__afterChangeMarkers()}clearMarkers(e=!0){Object.keys(this.markers).forEach(t=>{this.removeMarker(t,!1)}),e&&this.__afterChangeMarkers()}gotoMarker(e,t=this.config.gotoMarkerSpeed){const n=this.getMarker(e);return t?this.viewer.animate({...n.state.position,zoom:n.config.zoomLvl,speed:t}).then(()=>{this.dispatchEvent(new ka(n))}):(this.viewer.rotate(n.state.position),ue.isNil(n.config.zoomLvl)||this.viewer.zoom(n.config.zoomLvl),this.dispatchEvent(new ka(n)),Promise.resolve())}hideMarker(e){this.toggleMarker(e,!1)}showMarker(e){this.toggleMarker(e,!0)}showMarkerTooltip(e){const t=this.getMarker(e);t.state.staticTooltip=!0,t.showTooltip()}hideMarkerTooltip(e){const t=this.getMarker(e);t.state.staticTooltip=!1,t.hideTooltip()}toggleMarker(e,t){const n=this.getMarker(e);n.config.visible=ue.isNil(t)?!n.config.visible:t,this.renderMarkers()}showMarkerPanel(e){const t=this.getMarker(e);t.config.content?this.viewer.panel.show({id:fs,content:t.config.content}):this.hideMarkerPanel()}hideMarkerPanel(){this.viewer.panel.hide(fs)}toggleMarkersList(){this.viewer.panel.isVisible(Yn)?this.hideMarkersList():this.showMarkersList()}showMarkersList(){let e=[];Object.values(this.markers).forEach(n=>{n.config.visible&&!n.config.hideList&&e.push(n)});const t=new Sf(e);this.dispatchEvent(t),e=t.markers,this.viewer.panel.show({id:Yn,content:bE(e,this.viewer.config.lang[ks.id]),noMargin:!0,clickHandler:n=>{const s=ue.getClosest(n,".psv-panel-menu-item"),r=s?s.dataset[at]:void 0;if(r){const o=this.getMarker(r);this.dispatchEvent(new df(o)),this.gotoMarker(o.id),this.hideMarkersList()}}})}hideMarkersList(){this.viewer.panel.hide(Yn)}renderMarkers(){if(this.state.needsReRender){this.state.needsReRender=!1;return}const e=this.viewer.getZoomLevel(),t=this.viewer.getPosition(),n=this.state.hoveringMarker;Object.values(this.markers).forEach(s=>{let r=s.config.visible,o=!1,a=null;r&&(a=s.render({viewerPosition:t,zoomLevel:e,hoveringMarker:n}),r=!!a),o=s.state.visible!==r,s.state.visible=r,s.state.position2D=a,s.domElement&&ue.toggleClass(s.domElement,"psv-marker--visible",r),r?s.state.staticTooltip?s.showTooltip():s!==this.state.hoveringMarker&&s.hideTooltip():s.hideTooltip(),o&&(this.dispatchEvent(new Zu(s,r)),(s.is3d()||s.isCss3d())&&(this.state.needsReRender=!0))}),this.state.needsReRender&&this.viewer.needsUpdate()}__getTargetMarker(e,t=!1){if(e instanceof Node){const n=t?ue.getClosest(e,".psv-marker"):e;return n?n[at]:void 0}else return Array.isArray(e)?e.map(n=>n.userData[at]).filter(n=>!!n).sort((n,s)=>s.config.zIndex-n.config.zIndex)[0]:null}__onEnterMarker(e,t){var n;t&&(this.state.hoveringMarker=t,this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,this.dispatchEvent(new rf(t)),t instanceof Wr&&t.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!0}),!t.state.staticTooltip&&((n=t.config.tooltip)==null?void 0:n.trigger)==="hover"&&t.showTooltip(e.clientX,e.clientY))}__onLeaveMarker(e){var t;e&&(this.dispatchEvent(new tf(e)),e instanceof Wr&&e.applyScale({zoomLevel:this.viewer.getZoomLevel(),viewerPosition:this.viewer.getPosition(),mouseover:!1}),this.state.hoveringMarker=null,!e.state.staticTooltip&&((t=e.config.tooltip)==null?void 0:t.trigger)==="hover"?e.hideTooltip():e.state.staticTooltip&&e.showTooltip())}__onHoverMarker(e,t){var n;t&&(this.state.lastClientX=e.clientX,this.state.lastClientY=e.clientY,(t.isPoly()||t.is3d()||t.isCss3d())&&((n=t.config.tooltip)==null?void 0:n.trigger)==="hover"&&t.showTooltip(e.clientX,e.clientY))}__onClick(e,t){var o,a;const n=this.__getTargetMarker(e.data.objects),r=this.__getTargetMarker(e.data.target,!0)||n;this.state.currentMarker&&this.state.currentMarker!==r&&(this.dispatchEvent(new pf(this.state.currentMarker)),this.viewer.panel.hide(fs),!this.state.showAllTooltips&&((o=this.state.currentMarker.config.tooltip)==null?void 0:o.trigger)==="click"&&this.hideMarkerTooltip(this.state.currentMarker.id),this.state.currentMarker=null),r&&(this.state.currentMarker=r,this.dispatchEvent(new lf(r,t,e.data.rightclick)),this.config.clickEventOnMarker?e.data.marker=r:e.stopImmediatePropagation(),this.markers[r.id]&&!e.data.rightclick&&(((a=r.config.tooltip)==null?void 0:a.trigger)==="click"?r.tooltip?this.hideMarkerTooltip(r.id):this.showMarkerTooltip(r.id):this.showMarkerPanel(r.id)))}__afterChangeMarkers(){this.__refreshUi(),this.__checkObjectsObserver(),this.viewer.needsUpdate(),this.dispatchEvent(new xf(this.getMarkers()))}__refreshUi(){var t,n;const e=Object.values(this.markers).filter(s=>!s.config.hideList).length;e===0?(this.viewer.panel.hide(fs),this.viewer.panel.hide(Yn)):this.viewer.panel.isVisible(Yn)?this.showMarkersList():this.viewer.panel.isVisible(fs)&&(this.state.currentMarker?this.showMarkerPanel(this.state.currentMarker.id):this.viewer.panel.hide()),(t=this.viewer.navbar.getButton(ks.id,!1))==null||t.toggle(e>0),(n=this.viewer.navbar.getButton(no.id,!1))==null||n.toggle(e>0)}__checkObjectsObserver(){Object.values(this.markers).some(t=>t.is3d())?this.viewer.observeObjects(at):this.viewer.unobserveObjects(at)}};js.id="markers";js.VERSION="5.14.0";js.configParser=WE;js.readonlyOptions=["markers"];var Rf=js;Pi.lang[ks.id]="Markers";Pi.lang[no.id]="Markers list";pl(ks,"caption:left");pl(no,"caption:left");const Sn=[{id:"vostochniy",name:"Карьер «Восточный»",icon:"courtyard",scenes:[{id:"vostochniy_zoom",panorama:"/assets/rooms/vostochniy/vostochniy_zoom.jpg",name:"Карьер «Восточный»",defaultYaw:"2.7029rad",defaultPitch:"-0.1194rad",audio:"/assets/audio/vostochniy.mp3",links:[{nodeId:"vostochniy_burovaya",position:{yaw:2.3397,pitch:-.5473}},{nodeId:"doroga-s-samosvalami",position:{yaw:2.1534,pitch:.0603}},{nodeId:"samosval",position:{yaw:3.0775,pitch:-.3529}},{nodeId:"zaboy",position:{yaw:3.4947,pitch:-.3371}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/vostochniy.png"},position:{yaw:2.878,pitch:.131}}]},{id:"vostochniy_burovaya",panorama:"/assets/rooms/vostochniy/vostochniy_burovaya.jpg",name:"Буровой участок",defaultYaw:"6.1245rad",defaultPitch:"-0.3951rad",audio:"/assets/audio/burovaya.mp3",links:[{nodeId:"samosval",position:{yaw:5.9877,pitch:-.0974}},{nodeId:"zaboy",position:{yaw:.1027,pitch:-.076}},{nodeId:"doroga-s-samosvalami",position:{yaw:4.5532,pitch:.2144}},{nodeId:"vostochniy_zoom",position:{yaw:2.2544,pitch:.3422}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/burovaya.png"},position:{yaw:6.1245,pitch:-.3951}}]},{id:"samosval",panorama:"/assets/rooms/vostochniy/samosval.jpg",name:"Карьерный автосамосвал",audio:"/assets/audio/samosval.mp3",defaultYaw:"6.2729rad",defaultPitch:"0.1892rad",links:[{nodeId:"zaboy",position:{yaw:1.6687,pitch:-.0341}},{nodeId:"vostochniy_burovaya",position:{yaw:3.6131,pitch:.0324}},{nodeId:"doroga-s-samosvalami",position:{yaw:4.3468,pitch:.1736}},{nodeId:"vostochniy_zoom",position:{yaw:2.9022,pitch:.3611}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/samosval.png"},position:{yaw:6.2729,pitch:.1892}}]},{id:"doroga-s-samosvalami",panorama:"/assets/rooms/vostochniy/doroga-s-samosvalami.jpg",name:"Подъёмный участок",defaultYaw:"6.2384rad",defaultPitch:"-0.1465rad",gallery:["/assets/photos/doroga-s-samosvalami/1.png","/assets/photos/doroga-s-samosvalami/2.png","/assets/photos/doroga-s-samosvalami/3.png"],links:[{nodeId:"vostochniy_zoom",position:{yaw:4.4692,pitch:-.0052}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/podjemniy.png"},position:{yaw:6.2384,pitch:-.1465}}]},{id:"zaboy",panorama:"/assets/rooms/vostochniy/zaboy.jpg",name:"Забой",audio:"/assets/audio/zaboy.mp3",defaultYaw:"0.2553rad",defaultPitch:"-0.4055rad",links:[{nodeId:"samosval",position:{yaw:3.273,pitch:-.2589}},{nodeId:"vostochniy_burovaya",position:{yaw:2.3852,pitch:-.0934}},{nodeId:"doroga-s-samosvalami",position:{yaw:3.0363,pitch:.1441}},{nodeId:"vostochniy_zoom",position:{yaw:1.6953,pitch:.1724}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zaboy.png"},position:{yaw:.2553,pitch:-.4055}}]}]},{id:"blagodatniy",name:"Карьер «Благодатный»",icon:"rooms",scenes:[{id:"blagodatniy-1",panorama:"/assets/rooms/blagodatniy/blagodatniy.jpg",name:"Карьер «Благодатный»",defaultYaw:"0.0330rad",defaultPitch:"-0.0111rad",links:[],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/blagodatniy.png"},position:{yaw:.033,pitch:-.0111}}]}]},{id:"centre",name:"Центр управления карьером",icon:"views",scenes:[{id:"centre-1",panorama:"/assets/rooms/centre/centre.jpg",name:"Главный пункт управления",defaultYaw:"0.3068rad",defaultPitch:"0.0753rad",links:[{nodeId:"op-1",position:{yaw:2.1322,pitch:.0368}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/centre.png"},position:{yaw:.3346,pitch:.2202}}]},{id:"op-1",panorama:"/assets/rooms/centre/op-1.jpg",name:"Операторская 1",defaultYaw:"0.0316rad",defaultPitch:"0.0735rad",links:[{nodeId:"op-2",position:{yaw:3.2376,pitch:.0241}},{nodeId:"op-3",position:{yaw:1.6011,pitch:.025}},{nodeId:"centre-1",position:{yaw:.9939,pitch:.0316}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-1.png"},position:{yaw:.0316,pitch:.0735}}]},{id:"op-2",panorama:"/assets/rooms/centre/op-2.jpg",name:"Операторская 2",defaultYaw:"4.5212rad",defaultPitch:"0.1023rad",links:[{nodeId:"op-1",position:{yaw:1.3224,pitch:-.1473}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-2.png"},position:{yaw:4.5212,pitch:.1023}}]},{id:"op-3",panorama:"/assets/rooms/centre/op-3.jpg",name:"Операторская 3",defaultYaw:"2.2494rad",defaultPitch:"0.1907rad",links:[{nodeId:"op-1",position:{yaw:4.6161,pitch:-.0616}},{nodeId:"op-2",position:{yaw:3.9988,pitch:-.0313}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/op-3.png"},position:{yaw:2.2494,pitch:.1907}}]}]},{id:"living-complex",name:"Вахтовый жилой комплекс",icon:"views",scenes:[{id:"poselok",panorama:"/assets/rooms/living-complex/poselok.jpg",name:"Поселок",gallery:["/assets/photos/poselok/poselok1.png","/assets/photos/poselok/poselok2.png","/assets/photos/poselok/poselok3.png"],audio:"/assets/audio/poselok.mp3",defaultYaw:"0.5631rad",defaultPitch:"-0.1106rad",links:[{nodeId:"ksk",position:{yaw:.0685,pitch:.0514}},{nodeId:"stolovaya-1",position:{yaw:.0051,pitch:-.5787}},{nodeId:"stolovaya-2",position:{yaw:.4315,pitch:-.1068}},{nodeId:"pamyatnik",position:{yaw:1.0536,pitch:-.051}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/poselok.png"},position:{yaw:.6311,pitch:-.412}}]},{id:"ksk",panorama:"/assets/rooms/living-complex/ksk.jpg",name:"Культурно спортивный комплекс",defaultYaw:"6.1887rad",defaultPitch:"-0.1754rad",links:[{nodeId:"sportzal",position:{yaw:5.9055,pitch:-.4681}},{nodeId:"poselok",position:{yaw:4.6868,pitch:.0283}}],markers:[]},{id:"sportzal",panorama:"/assets/rooms/living-complex/sportzal.jpg",name:"Спортзал",audio:"/assets/audio/ksk.mp3",defaultYaw:"6.2702rad",defaultPitch:"-0.3748rad",gallery:["/assets/photos/poselok/zal1.png","/assets/photos/poselok/zal2.png","/assets/photos/poselok/zal3.png"],links:[{nodeId:"ksk",position:{yaw:.6865,pitch:-.1667}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zal.png"},position:{yaw:6.2702,pitch:-.3748}}]},{id:"stolovaya-1",panorama:"/assets/rooms/living-complex/stolovaya-1.jpg",name:"Столовая 1",audio:"/assets/audio/stolovaya.mp3",defaultYaw:"6.1407rad",defaultPitch:"0.0856rad",gallery:["/assets/photos/poselok/stolovaya1.png","/assets/photos/poselok/stolovaya2.png","/assets/photos/poselok/stolovaya3.png"],links:[{nodeId:"poselok",position:{yaw:1.2802,pitch:.0496}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/stolovaya.png"},position:{yaw:6.1385,pitch:.113}}]},{id:"stolovaya-2",panorama:"/assets/rooms/living-complex/stolovaya-2.jpg",name:"Столовая 2",audio:"/assets/audio/stolovaya.mp3",defaultYaw:"5.8891rad",defaultPitch:"0.0966rad",gallery:["/assets/photos/poselok/stolovaya4.png","/assets/photos/poselok/stolovaya5.png","/assets/photos/poselok/stolovaya6.png"],links:[{nodeId:"poselok",position:{yaw:.6396,pitch:-.0234}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/stolovaya.png"},position:{yaw:5.8891,pitch:.0966}}]},{id:"pamyatnik",panorama:"/assets/rooms/living-complex/pamyatnik.jpg",name:"Памятник",defaultYaw:"0.0948rad",defaultPitch:"-0.1752rad",links:[{nodeId:"poselok",position:{yaw:1.5737,pitch:.1201}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/pamyatnik.png"},position:{yaw:.0948,pitch:-.1752}}]}]},{id:"zif",name:"Золотоизвлекательная фабрика",icon:"views",scenes:[{id:"zif-1",panorama:"/assets/rooms/zif/zif.jpg",name:"Отделение рудоподготовки",defaultYaw:"0.6650rad",defaultPitch:"-0.0185rad",gallery:["/assets/photos/zif/zif1.png","/assets/photos/zif/zif2.png","/assets/photos/zif/zif3.png"],links:[{nodeId:"bio",position:{yaw:.088,pitch:-.0273}},{nodeId:"plavilnoe",position:{yaw:1.1942,pitch:.04}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/zif.png"},position:{yaw:.665,pitch:-.0185}}]},{id:"bio",panorama:"/assets/rooms/zif/bio.jpg",name:"Участок бактериального окисления",defaultYaw:"6.2023rad",defaultPitch:"-0.1498rad",gallery:["/assets/photos/zif/bio.png","/assets/photos/zif/bio1.png"],links:[{nodeId:"zif-1",position:{yaw:2.3397,pitch:-.5473}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/bio.png"},position:{yaw:6.2023,pitch:-.1498}}]},{id:"plavilnoe",panorama:"/assets/rooms/zif/plavilnoe.jpg",name:"Плавильное отделение",defaultYaw:"0.3497rad",defaultPitch:"-0.0144rad",gallery:["/assets/photos/zif/plavilniy1.png","/assets/photos/zif/plavilniy2.png","/assets/photos/zif/plavilniy3.png"],links:[{nodeId:"zif-1",position:{yaw:1.4957,pitch:.0752}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/plavilniy.png"},position:{yaw:.3497,pitch:-.0144}}]}]},{id:"service",name:"Сервисно-ремонтный комплекс",icon:"views",scenes:[{id:"service-1",panorama:"/assets/rooms/service/ps-ulica.jpg",name:"Питстоп",defaultYaw:"0.0390rad",defaultPitch:"0.0867rad",links:[{nodeId:"moyka-2",position:{yaw:.7219,pitch:.078}},{nodeId:"ps-2",position:{yaw:5.6155,pitch:.0762}},{nodeId:"angar-3",position:{yaw:3.4457,pitch:.0571}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/pitstop.png"},position:{yaw:5.84,pitch:.2618}}]},{id:"ps-2",panorama:"/assets/rooms/service/ps-2.jpg",name:"Станция оперативного обслуживания",gallery:["/assets/photos/pitstop/pitstop1.png","/assets/photos/pitstop/pitstop2.png"],defaultYaw:"0.5171rad",defaultPitch:"0.1980rad",links:[{nodeId:"ps-1",position:{yaw:1.284,pitch:.0456}},{nodeId:"ps-3",position:{yaw:.0423,pitch:.0271}},{nodeId:"service-1",position:{yaw:4.1903,pitch:-.0514}}],markers:[]},{id:"ps-1",panorama:"/assets/rooms/service/ps-1.jpg",name:"Вид сзади",defaultYaw:"0.0610rad",defaultPitch:"0.4295rad",links:[{nodeId:"ps-2",position:{yaw:5.2171,pitch:-.0759}}],markers:[]},{id:"ps-3",panorama:"/assets/rooms/service/ps-3.jpg",name:"Вид сбоку",defaultYaw:"0.0192rad",defaultPitch:"0.4810rad",links:[{nodeId:"ps-2",position:{yaw:1.0522,pitch:-.108}}],markers:[]},{id:"moyka-2",panorama:"/assets/rooms/service/moyka-2.jpg",name:"Моечно-обслуживающий комплекс",defaultYaw:"0.6304rad",defaultPitch:"0.1859rad",links:[{nodeId:"service-1",position:{yaw:1.3383,pitch:.1347}}],markers:[]},{id:"kabina",panorama:"/assets/rooms/service/kabina.jpg",name:"Кабина",defaultYaw:"5.7024rad",defaultPitch:"0.4925rad",links:[{nodeId:"angar-3",position:{yaw:6.1862,pitch:-.3136}}],markers:[]},{id:"angar-3",panorama:"/assets/rooms/service/angar-3.jpg",name:"Сервисный ангар",defaultYaw:"6.1375rad",defaultPitch:"0.4295rad",video:"/assets/videos/doroga-s-samosvalami/1.MOV",links:[{nodeId:"kabina",position:{yaw:5.7188,pitch:.4926}},{nodeId:"service-1",position:{yaw:2.1327,pitch:.1971}}],markers:[{id:"info-1",data:{type:"info",image:"/assets/info/angar.png"},position:{yaw:6.1375,pitch:.4295}}]}]}],zo=Sn[0];zo.scenes||zo.variants&&zo.variants[0].scenes;class YE{constructor(e){rn(this,"container");rn(this,"onSceneSelect");rn(this,"currentGroup",null);rn(this,"currentVariant",null);rn(this,"variantButton",null);rn(this,"modalOverlay",null);this.container=e.container,this.onSceneSelect=e.onSceneSelect,this.init()}init(){var e,t;this.variantButton=document.createElement("button"),this.variantButton.className="variant-button hidden",this.variantButton.innerHTML=`
    ...
    `,(e=this.modalOverlay.querySelector(".variant-modal-close"))==null||e.addEventListener("click",()=>this.closeModal()),(t=this.modalOverlay.querySelector(".variant-back-btn"))==null||t.addEventListener("click",()=>this.openVariantModal()),document.body.appendChild(this.modalOverlay)}setLocationGroup(e){if(this.currentGroup=e,e.variants&&e.variants.length>0){const t=e.defaultVariantId||e.variants[0].id,n=e.variants.find(s=>s.id===t)||e.variants[0];this.setVariant(n)}else this.currentVariant=null}setVariant(e){if(this.currentVariant=e,this.variantButton){const t=this.variantButton.querySelector(".variant-name");t&&(t.textContent=e.name)}}openVariantModal(){if(!this.currentGroup||!this.currentGroup.variants||!this.modalOverlay)return;const e=this.modalOverlay.querySelector(".variant-modal-title"),t=this.modalOverlay.querySelector(".variant-back-btn"),n=this.modalOverlay.querySelector(".variant-grid");e&&(e.textContent="ВИДЫ НОМЕРОВ"),t&&t.classList.add("hidden"),n&&(n.innerHTML="",n.className="variant-grid variants-mode",this.currentGroup.variants.forEach(s=>{var o;const r=document.createElement("div");r.className=`variant-card ${((o=this.currentVariant)==null?void 0:o.id)===s.id?"selected":""}`,r.innerHTML=`
        ...
        `,o.addEventListener("click",()=>{this.setVariant(e),this.onSceneSelect(r,e.scenes),this.closeModal()}),s.appendChild(o)}))}closeModal(){var e;(e=this.modalOverlay)==null||e.classList.add("hidden")}}const qE=document.querySelector("#viewer"),bn=new iE({container:qE,touchmoveTwoFingers:!0,mousewheelCtrlKey:!0,defaultYaw:"0deg",defaultZoomLvl:0,navbar:!1,mousewheel:!1,plugins:[[qu,{positionMode:"manual",renderMode:"2d",arrowStyle:{element:i=>{var n;const e=document.createElement("div");e.className="transition-marker";const t=(n=window.__currentSceneConfigs)==null?void 0:n.find(s=>s.id===i.nodeId);return e.textContent=(t==null?void 0:t.name)||i.nodeId,e}},transitionOptions:i=>{const e=Ii.find(t=>t.id===i.id);return e&&(e.defaultYaw||e.defaultPitch)?{rotateTo:{yaw:e.defaultYaw,pitch:e.defaultPitch},speed:"10rpm"}:{}}}],[Rf,{markers:[],defaultHoverScale:!1}]]}),Zs=bn.getPlugin(qu),$E=bn.getPlugin(Rf),_n=document.getElementById("info-panel"),Gc=document.getElementById("info-close");Gc&&_n&&Gc.addEventListener("click",()=>{_n.classList.add("hidden")});$E.addEventListener("select-marker",i=>{if(i.marker.id.startsWith("info-")&&_n){const e=_n.querySelector("#info-image");e&&(i.marker.data&&i.marker.data.image?e.src=i.marker.data.image:e.src=""),_n.classList.remove("hidden")}});window.addEventListener("message",()=>{});bn.addEventListener("ready",()=>{window.parent.postMessage({type:"tourLoaded"},"*");const i=document.querySelector("#loader-container");i&&i.classList.add("hidden")});bn.addEventListener("load-progress",i=>{const e=document.querySelector("#loader-percentage");e&&(e.textContent=`${i.progress}%`)});bn.addEventListener("panorama-error",i=>{console.error("Viewer Error:",i),alert("Viewer Error: "+(i.error.message||i.error))});bn.addEventListener("position-updated",()=>{});let Ii=[];window.__currentSceneConfigs=Ii;const ti=document.getElementById("btn-audio"),xn=document.getElementById("btn-video"),En=document.getElementById("btn-gallery"),Vi=document.getElementById("scene-audio"),Ai=document.getElementById("video-modal"),Ci=document.getElementById("scene-video"),Wc=document.getElementById("video-close"),Bi=document.getElementById("gallery-container");ti&&(ti.style.display="none");xn&&(xn.style.display="none");En&&(En.style.display="none");let Ir=!1;const jE=i=>{const e=Ii.find(t=>t.id===i);Ir=!1,Vi&&(Vi.pause(),Vi.currentTime=0),ti&&ti.classList.remove("active"),Ai&&Ai.classList.add("hidden"),Ci&&(Ci.pause(),Ci.currentTime=0),Bi&&Bi.classList.add("hidden"),e&&(ti&&(e.audio?(ti.style.display="flex",Vi&&(Vi.src=e.audio)):ti.style.display="none"),xn&&(e.video?xn.style.display="flex":xn.style.display="none"),En&&(e.gallery&&e.gallery.length>0?En.style.display="flex":En.style.display="none"))};Zs.addEventListener("node-changed",i=>{_n&&_n.classList.add("hidden"),jE(i.node.id)});ti&&Vi&&ti.addEventListener("click",()=>{Ir?(Vi.pause(),ti.classList.remove("active"),Ir=!1):(Vi.play().catch(i=>console.error("Audio play error",i)),ti.classList.add("active"),Ir=!0)});xn&&Ai&&Ci&&xn.addEventListener("click",()=>{const i=Ii.find(e=>{var t;return e.id===((t=Zs.getCurrentNode())==null?void 0:t.id)});i&&i.video&&(Ci.src=i.video,Ai.classList.remove("hidden"),Ci.play().catch(e=>console.error("Video play error",e)))});const Lf=()=>{Ai&&Ci&&(Ai.classList.add("hidden"),Ci.pause(),Ci.currentTime=0)};Wc&&Wc.addEventListener("click",Lf);Ai&&Ai.addEventListener("click",i=>{i.target===Ai&&Lf()});En&&Bi&&En.addEventListener("click",()=>{if(Bi.classList.contains("hidden")){const e=Ii.find(t=>{var n;return t.id===((n=Zs.getCurrentNode())==null?void 0:n.id)});e&&e.gallery&&(Bi.innerHTML=e.gallery.map(t=>`
                    <div class="gallery-item">
                        <img src="${t}" alt="Gallery Image" loading="lazy" />
                    </div>
                `).join(""),Bi.className=`gallery-container items-${Math.min(e.gallery.length,3)}`,Bi.classList.remove("hidden"))}else Bi.classList.add("hidden")});bn.addEventListener("click",i=>{const e=i.data.rightclick?null:i.data;e&&e.yaw!==void 0&&e.pitch!==void 0&&(console.log(`📍 Click position: { yaw: ${e.yaw.toFixed(4)}, pitch: ${e.pitch.toFixed(4)} }`),console.log(`🎯 Default view config: defaultYaw: '${e.yaw.toFixed(4)}rad', defaultPitch: '${e.pitch.toFixed(4)}rad'`))});const Bo=document.getElementById("location-nav"),ZE=new YE({container:document.getElementById("viewer"),onSceneSelect:(i,e)=>{Ii=e,window.__currentSceneConfigs=Ii,Zs.setNodes(e.map(t=>({id:t.id,panorama:t.panorama,name:t.name,links:t.links,markers:t.markers})),i.id)}});let Xr=Sn.length>0?Sn[0].id:"";const Pf=()=>{if(!Bo)return;Bo.innerHTML="",Sn.forEach(e=>{const t=document.createElement("button");t.className=`location-btn ${e.id===Xr?"active":""}`,t.textContent=e.name,t.addEventListener("click",()=>{If(e.id)}),Bo.appendChild(t)});const i=Sn.find(e=>e.id===Xr);i&&ZE.setLocationGroup(i)},If=i=>{const e=Sn.find(t=>t.id===i);if(e){Xr=i;let t=[],n;if(e.variants&&e.variants.length>0){const s=e.defaultVariantId||e.variants[0].id;t=(e.variants.find(o=>o.id===s)||e.variants[0]).scenes}else e.scenes&&(t=e.scenes);t.length>0&&(n=t[0].id,Ii=t,window.__currentSceneConfigs=Ii,Zs.setNodes(t.map(s=>({id:s.id,panorama:s.panorama,name:s.name,links:s.links,markers:s.markers.map(r=>r.data&&r.data.type==="info"?{...r,html:`
                ...
                `,size:{width:50,height:50},anchor:"center center"}:r)})),n)),Pf()}};Pf();const Xc=Sn.find(i=>i.id===Xr);Xc&&If(Xc.id);
